...
public class GetCaseResponse {
  ...
  public GetCaseResponse _case(@javax.annotation.Nullable ModelCase _case) {
    this._case = _case;
    return this;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetCaseResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in GetCaseResponse is not found in the empty JSON string", GetCaseResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetCaseResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `GetCaseResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
