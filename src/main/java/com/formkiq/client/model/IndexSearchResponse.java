...
public class IndexSearchResponse {
  ...
  public IndexSearchResponse next(@javax.annotation.Nullable String next) {
    this.next = next;
    return this;
  }
  ...
  public IndexSearchResponse previous(@javax.annotation.Nullable String previous) {
  ...
  public IndexSearchResponse values(@javax.annotation.Nullable List<IndexSearch> values) {
    this.values = values;
    return this;
  }
  ...
  public void setValues(@javax.annotation.Nullable List<IndexSearch> values) {
    this.values = values;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("next", "previous", "values"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!IndexSearchResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in IndexSearchResponse is not found in the empty JSON string", IndexSearchResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!IndexSearchResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `IndexSearchResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
