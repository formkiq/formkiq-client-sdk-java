...
public class DocumentGenerateInsertDocument {
  ...
  public DocumentGenerateInsertDocument position(@javax.annotation.Nonnull DocumentGenerateInsertDocumentPosition position) {
  ...
  public void setPosition(@javax.annotation.Nonnull DocumentGenerateInsertDocumentPosition position) {
    this.position = position;
  }
  ...
  public boolean equals(Object o) {
    ...
    DocumentGenerateInsertDocument documentGenerateInsertDocument = (DocumentGenerateInsertDocument) o;
   ...
   * @throws IOException if the JSON Element is invalid with respect to DocumentGenerateInsertDocument
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DocumentGenerateInsertDocument.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in DocumentGenerateInsertDocument is not found in the empty JSON string", DocumentGenerateInsertDocument.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DocumentGenerateInsertDocument.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `DocumentGenerateInsertDocument` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
   ...
   * @throws IOException if the JSON string is invalid with respect to DocumentGenerateInsertDocument
   */
