...
public class DocumentSearch {
  ...
  @javax.annotation.Nullable
  private DocumentSearchFilename filename;

  public static final String SERIALIZED_NAME_FOLDER = "folder";
  @SerializedName(SERIALIZED_NAME_FOLDER)
  @javax.annotation.Nullable
  private DocumentSearchFolder folder;
  ...
  public DocumentSearch text(@javax.annotation.Nullable String text) {
    this.text = text;
    return this;
  }
  ...
  public DocumentSearch meta(@javax.annotation.Nullable DocumentSearchMeta meta) {
    this.meta = meta;
    return this;
  }
  ...
  public void setMeta(@javax.annotation.Nullable DocumentSearchMeta meta) {
    this.meta = meta;
  }


  public DocumentSearch filename(@javax.annotation.Nullable DocumentSearchFilename filename) {
   ...
   */
  @javax.annotation.Nullable
  public DocumentSearchFilename getFilename() {
    return filename;
  }

  public void setFilename(@javax.annotation.Nullable DocumentSearchFilename filename) {
    this.filename = filename;
  }


  public DocumentSearch folder(@javax.annotation.Nullable DocumentSearchFolder folder) {
    this.folder = folder;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public DocumentSearchFolder getFolder() {
    return folder;
  }

  public void setFolder(@javax.annotation.Nullable DocumentSearchFolder folder) {
    this.folder = folder;
  }


  public DocumentSearch attribute(@javax.annotation.Nullable DocumentSearchAttribute attribute) {
  ...
  public void setAttribute(@javax.annotation.Nullable DocumentSearchAttribute attribute) {
    this.attribute = attribute;
  }


  public DocumentSearch attributes(
      @javax.annotation.Nullable List<DocumentSearchAttribute> attributes) {
  ...
  public void setAttributes(@javax.annotation.Nullable List<DocumentSearchAttribute> attributes) {
    this.attributes = attributes;
  }


  public DocumentSearch tag(@javax.annotation.Nullable DocumentSearchTag tag) {
    this.tag = tag;
    return this;
  }
  ...
  public void setTag(@javax.annotation.Nullable DocumentSearchTag tag) {
    this.tag = tag;
  }


  public DocumentSearch tags(@javax.annotation.Nullable List<DocumentSearchTags> tags) {
    this.tags = tags;
    return this;
  }
  ...
  public void setTags(@javax.annotation.Nullable List<DocumentSearchTags> tags) {
    this.tags = tags;
  }


  public DocumentSearch documentIds(@javax.annotation.Nullable List<String> documentIds) {
  ...
  /**
   * List of DocumentIds to filter search results on. Cannot be combined with &#x60;filename&#x60;.
   * 
   * @return documentIds
   */
  @javax.annotation.Nullable
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.text, documentSearch.text)
        ...
        && Objects.equals(this.filename, documentSearch.filename)
        && Objects.equals(this.folder, documentSearch.folder)
  ...
  @Override
  public int hashCode() {
    return Objects.hash(text, meta, filename, folder, attribute, attributes, tag, tags,
        documentIds);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("text", "meta", "filename", "folder",
        "attribute", "attributes", "tag", "tags", "documentIds"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    ...
    if (jsonObj.get("filename") != null && !jsonObj.get("filename").isJsonNull()) {
      DocumentSearchFilename.validateJsonElement(jsonObj.get("filename"));
    }
    // validate the optional field `folder`
    if (jsonObj.get("folder") != null && !jsonObj.get("folder").isJsonNull()) {
      DocumentSearchFolder.validateJsonElement(jsonObj.get("folder"));
    }
