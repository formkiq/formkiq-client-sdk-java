...
public class DocumentSearch {
  ...
  public DocumentSearch attributes(@javax.annotation.Nullable List<DocumentSearchAttribute> attributes) {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("text", "meta", "attribute", "attributes", "tag", "tags", "documentIds"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DocumentSearch.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in DocumentSearch is not found in the empty JSON string", DocumentSearch.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DocumentSearch.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `DocumentSearch` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
