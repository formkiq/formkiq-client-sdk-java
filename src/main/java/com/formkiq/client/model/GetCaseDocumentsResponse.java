...
public class GetCaseDocumentsResponse {
  ...
  public GetCaseDocumentsResponse next(@javax.annotation.Nullable String next) {
    this.next = next;
    return this;
  }
  ...
  public GetCaseDocumentsResponse documents(@javax.annotation.Nullable List<Document> documents) {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetCaseDocumentsResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in GetCaseDocumentsResponse is not found in the empty JSON string", GetCaseDocumentsResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetCaseDocumentsResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `GetCaseDocumentsResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
