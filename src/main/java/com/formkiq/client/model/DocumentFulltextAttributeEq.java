...
public class DocumentFulltextAttributeEq {
  ...
  public DocumentFulltextAttributeEq stringValue(@javax.annotation.Nullable String stringValue) {
  ...
  public DocumentFulltextAttributeEq numberValue(@javax.annotation.Nullable BigDecimal numberValue) {
  ...
  public DocumentFulltextAttributeEq booleanValue(@javax.annotation.Nullable Boolean booleanValue) {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("stringValue", "numberValue", "booleanValue"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DocumentFulltextAttributeEq.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in DocumentFulltextAttributeEq is not found in the empty JSON string", DocumentFulltextAttributeEq.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DocumentFulltextAttributeEq.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `DocumentFulltextAttributeEq` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
