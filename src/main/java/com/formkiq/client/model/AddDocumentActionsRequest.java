...
public class AddDocumentActionsRequest {
  ...
  public AddDocumentActionsRequest actions(@javax.annotation.Nullable List<AddAction> actions) {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("actions"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AddDocumentActionsRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in AddDocumentActionsRequest is not found in the empty JSON string", AddDocumentActionsRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AddDocumentActionsRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `AddDocumentActionsRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
