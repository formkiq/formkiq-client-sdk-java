...
public class GetCaseTaskResponse {
  ...
  public GetCaseTaskResponse task(@javax.annotation.Nullable Task task) {
    this.task = task;
    return this;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetCaseTaskResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in GetCaseTaskResponse is not found in the empty JSON string", GetCaseTaskResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetCaseTaskResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `GetCaseTaskResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
