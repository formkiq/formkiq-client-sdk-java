...
public class AddTagSchemaTags {
   ...
   * @throws IOException if the JSON Element is invalid with respect to AddTagSchemaTags
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!AddTagSchemaTags.openapiRequiredFields.isEmpty()) { // has required fields but JSON
                                                               // element is null
        throw new IllegalArgumentException(String.format(
            "The required field(s) %s in AddTagSchemaTags is not found in the empty JSON string",
            AddTagSchemaTags.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!AddTagSchemaTags.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(String.format(
            "The field `%s` in the JSON string is not defined in the `AddTagSchemaTags` properties. JSON: %s",
