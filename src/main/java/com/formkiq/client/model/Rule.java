...
public class Rule {
  ...
  public Rule ruleId(@javax.annotation.Nullable String ruleId) {
    this.ruleId = ruleId;
    return this;
  }
  ...
  public Rule priority(@javax.annotation.Nullable BigDecimal priority) {
  ...
  public Rule workflowId(@javax.annotation.Nullable String workflowId) {
  ...
  public Rule status(@javax.annotation.Nullable RulesetStatus status) {
    this.status = status;
    return this;
  }
  ...
  public Rule conditions(@javax.annotation.Nullable RuleCondition conditions) {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("ruleId", "priority", "description", "workflowId", "status", "conditions"));
