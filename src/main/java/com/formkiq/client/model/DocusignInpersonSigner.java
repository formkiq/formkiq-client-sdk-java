...
public class DocusignInpersonSigner {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("hostEmail", "hostName", "signerName",
        "signerEmail", "recipientId", "routingOrder", "suppressEmails", "tabs"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields =
        new HashSet<String>(Arrays.asList("hostEmail", "hostName", "signerName"));
  }
