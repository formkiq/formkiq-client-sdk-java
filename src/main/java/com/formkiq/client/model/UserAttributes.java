...
public class UserAttributes {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("address", "birthdate", "familyName",
        "gender", "givenName", "locale", "middleName", "name", "nickname", "phoneNumber", "picture",
        "preferredUsername", "profile", "zoneinfo", "updatedAt", "website"));
