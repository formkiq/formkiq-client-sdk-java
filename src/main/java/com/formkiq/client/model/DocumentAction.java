...
public class DocumentAction {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(status, type, retryCount, maxRetries, queueId, workflowId, workflowStepId, message, userId, insertedDate, startDate, completedDate, parameters, metadata);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("status", "type", "retryCount", "maxRetries", "queueId", "workflowId", "workflowStepId", "message", "userId", "insertedDate", "startDate", "completedDate", "parameters", "metadata"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DocumentAction.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in DocumentAction is not found in the empty JSON string", DocumentAction.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DocumentAction.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `DocumentAction` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if ((jsonObj.get("queueId") != null && !jsonObj.get("queueId").isJsonNull()) && !jsonObj.get("queueId").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `queueId` to be a primitive type in the JSON string but got `%s`", jsonObj.get("queueId").toString()));
      }
      ...
      if ((jsonObj.get("workflowStepId") != null && !jsonObj.get("workflowStepId").isJsonNull()) && !jsonObj.get("workflowStepId").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `workflowStepId` to be a primitive type in the JSON string but got `%s`", jsonObj.get("workflowStepId").toString()));
      }
      ...
      if ((jsonObj.get("completedDate") != null && !jsonObj.get("completedDate").isJsonNull()) && !jsonObj.get("completedDate").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `completedDate` to be a primitive type in the JSON string but got `%s`", jsonObj.get("completedDate").toString()));
      }
  }
