...
public class DocumentAction {
  ...
  public DocumentAction parameters(@javax.annotation.Nullable Map<String, String> parameters) {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(
        Arrays.asList("status", "type", "queueId", "workflowId", "workflowStepId", "message",
            "userId", "insertedDate", "startDate", "completedDate", "parameters", "metadata"));
