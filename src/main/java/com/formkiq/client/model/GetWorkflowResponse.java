...
public class GetWorkflowResponse {
  ...
  public GetWorkflowResponse name(@javax.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public GetWorkflowResponse description(@javax.annotation.Nullable String description) {
  ...
  public GetWorkflowResponse inUse(@javax.annotation.Nullable Boolean inUse) {
    this.inUse = inUse;
    return this;
  }
  ...
  public GetWorkflowResponse status(@javax.annotation.Nullable WorkflowStatus status) {
    this.status = status;
    return this;
  }
  ...
  public GetWorkflowResponse steps(@javax.annotation.Nullable List<WorkflowStep> steps) {
    this.steps = steps;
    return this;
  }
  ...
  public void setSteps(@javax.annotation.Nullable List<WorkflowStep> steps) {
    this.steps = steps;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("name", "description", "inUse", "status", "steps"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetWorkflowResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in GetWorkflowResponse is not found in the empty JSON string", GetWorkflowResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetWorkflowResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `GetWorkflowResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("steps") != null && !jsonObj.get("steps").isJsonNull()) {
        ...
        if (jsonArraysteps != null) {
          ...
          if (!jsonObj.get("steps").isJsonArray()) {
            throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `steps` to be an array in the JSON string but got `%s`", jsonObj.get("steps").toString()));
          }
