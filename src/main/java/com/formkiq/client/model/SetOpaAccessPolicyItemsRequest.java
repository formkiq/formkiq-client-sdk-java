...
public class SetOpaAccessPolicyItemsRequest {
  ...
  public SetOpaAccessPolicyItemsRequest policyItems(@javax.annotation.Nonnull List<OpaPolicyItem> policyItems) {
  ...
  public boolean equals(Object o) {
    ...
    SetOpaAccessPolicyItemsRequest setOpaAccessPolicyItemsRequest = (SetOpaAccessPolicyItemsRequest) o;
   ...
   * @throws IOException if the JSON Element is invalid with respect to SetOpaAccessPolicyItemsRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SetOpaAccessPolicyItemsRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in SetOpaAccessPolicyItemsRequest is not found in the empty JSON string", SetOpaAccessPolicyItemsRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SetOpaAccessPolicyItemsRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `SetOpaAccessPolicyItemsRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
   ...
   * @throws IOException if the JSON string is invalid with respect to SetOpaAccessPolicyItemsRequest
   */
