...
public class AddDocumentActionsResponse {
  ...
  public AddDocumentActionsResponse message(String message) {
  ...
  * @throws IOException if the JSON Object is invalid with respect to AddDocumentActionsResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AddDocumentActionsResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AddDocumentActionsResponse is not found in the empty JSON string", AddDocumentActionsResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!AddDocumentActionsResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AddDocumentActionsResponse` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
