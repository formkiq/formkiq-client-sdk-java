...
public class GetDocumentResponse {
  ...
  public GetDocumentResponse belongsToDocumentId(@javax.annotation.Nullable String belongsToDocumentId) {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(siteId, path, width, height, deepLinkPath, insertedDate, lastModifiedDate, checksum, checksumType, documentId, contentType, userId, contentLength, versionId, documents, belongsToDocumentId, metadata);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("siteId", "path", "width", "height", "deepLinkPath", "insertedDate", "lastModifiedDate", "checksum", "checksumType", "documentId", "contentType", "userId", "contentLength", "versionId", "documents", "belongsToDocumentId", "metadata"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetDocumentResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in GetDocumentResponse is not found in the empty JSON string", GetDocumentResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetDocumentResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `GetDocumentResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
