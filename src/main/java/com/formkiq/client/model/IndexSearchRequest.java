...
public class IndexSearchRequest {
  ...
  public IndexSearchRequest indexType(@javax.annotation.Nullable String indexType) {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("indexType"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!IndexSearchRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in IndexSearchRequest is not found in the empty JSON string", IndexSearchRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!IndexSearchRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `IndexSearchRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
