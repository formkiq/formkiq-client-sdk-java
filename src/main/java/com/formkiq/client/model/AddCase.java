...
public class AddCase {
  ...
  public AddCase tasks(List<AddTask> tasks) {
    this.tasks = tasks;
    return this;
  }

  public AddCase addTasksItem(AddTask tasksItem) {
    if (this.tasks == null) {
   ...
   **/
  @javax.annotation.Nullable
  public List<AddTask> getTasks() {
    return tasks;
  }

  public void setTasks(List<AddTask> tasks) {
    this.tasks = tasks;
  }


  public AddCase nigos(List<AddNigo> nigos) {
    this.nigos = nigos;
    return this;
  }

  public AddCase addNigosItem(AddNigo nigosItem) {
    if (this.nigos == null) {
   ...
   **/
  @javax.annotation.Nullable
  public List<AddNigo> getNigos() {
    return nigos;
  }

  public void setNigos(List<AddNigo> nigos) {
    this.nigos = nigos;
  }
    ...
    if (jsonObj.get("tasks") != null && !jsonObj.get("tasks").isJsonNull()) {
      ...
      if (jsonArraytasks != null) {
        ...
        for (int i = 0; i < jsonArraytasks.size(); i++) {
          AddTask.validateJsonElement(jsonArraytasks.get(i));
        } ;
      }
    }
    if (jsonObj.get("nigos") != null && !jsonObj.get("nigos").isJsonNull()) {
      ...
      if (jsonArraynigos != null) {
        ...
        for (int i = 0; i < jsonArraynigos.size(); i++) {
          AddNigo.validateJsonElement(jsonArraynigos.get(i));
        } ;
      }
    }
  }
