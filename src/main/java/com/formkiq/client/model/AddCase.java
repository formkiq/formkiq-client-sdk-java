...
public class AddCase {
  ...
  public AddCase documentNumberFormat(
      @javax.annotation.Nullable List<StringFormat> documentNumberFormat) {
  ...
  public void setDocumentNumberFormat(
      @javax.annotation.Nullable List<StringFormat> documentNumberFormat) {
    this.documentNumberFormat = documentNumberFormat;
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(name, status, plannedStartDate, startDate, endDate, dueDate, description,
        documentNumberFormat, caseNumberFormat, metadata, documentIds);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(
        Arrays.asList("name", "status", "plannedStartDate", "startDate", "endDate", "dueDate",
            "description", "documentNumberFormat", "caseNumberFormat", "metadata", "documentIds"));
