...
public class AddCase {
  ...
  public AddCase name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public AddCase status(@javax.annotation.Nullable CaseStatus status) {
    this.status = status;
    return this;
  }
  ...
  public AddCase plannedStartDate(@javax.annotation.Nullable String plannedStartDate) {
  ...
  public AddCase startDate(@javax.annotation.Nullable String startDate) {
  ...
  public AddCase endDate(@javax.annotation.Nullable String endDate) {
  ...
  public AddCase dueDate(@javax.annotation.Nullable String dueDate) {
  ...
  public AddCase description(@javax.annotation.Nullable String description) {
  ...
  public AddCase documentNumberFormat(@javax.annotation.Nullable List<StringFormat> documentNumberFormat) {
  ...
  public void setDocumentNumberFormat(@javax.annotation.Nullable List<StringFormat> documentNumberFormat) {
    this.documentNumberFormat = documentNumberFormat;
  }


  public AddCase caseNumberFormat(@javax.annotation.Nullable List<StringFormat> caseNumberFormat) {
  ...
  public void setCaseNumberFormat(@javax.annotation.Nullable List<StringFormat> caseNumberFormat) {
    this.caseNumberFormat = caseNumberFormat;
  }


  public AddCase metadata(@javax.annotation.Nullable Map<String, Object> metadata) {
  ...
  public AddCase documentIds(@javax.annotation.Nullable List<String> documentIds) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, addCase.name) &&
        Objects.equals(this.status, addCase.status) &&
        Objects.equals(this.plannedStartDate, addCase.plannedStartDate) &&
        Objects.equals(this.startDate, addCase.startDate) &&
        Objects.equals(this.endDate, addCase.endDate) &&
        Objects.equals(this.dueDate, addCase.dueDate) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(name, status, plannedStartDate, startDate, endDate, dueDate, description, documentNumberFormat, caseNumberFormat, metadata, documentIds);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("name", "status", "plannedStartDate", "startDate", "endDate", "dueDate", "description", "documentNumberFormat", "caseNumberFormat", "metadata", "documentIds"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AddCase.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in AddCase is not found in the empty JSON string", AddCase.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AddCase.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `AddCase` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("documentNumberFormat") != null && !jsonObj.get("documentNumberFormat").isJsonNull()) {
        ...
        if (jsonArraydocumentNumberFormat != null) {
          ...
          if (!jsonObj.get("documentNumberFormat").isJsonArray()) {
            throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `documentNumberFormat` to be an array in the JSON string but got `%s`", jsonObj.get("documentNumberFormat").toString()));
          }
      ...
      if (jsonObj.get("caseNumberFormat") != null && !jsonObj.get("caseNumberFormat").isJsonNull()) {
        ...
        if (jsonArraycaseNumberFormat != null) {
          ...
          if (!jsonObj.get("caseNumberFormat").isJsonArray()) {
            throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `caseNumberFormat` to be an array in the JSON string but got `%s`", jsonObj.get("caseNumberFormat").toString()));
          }
