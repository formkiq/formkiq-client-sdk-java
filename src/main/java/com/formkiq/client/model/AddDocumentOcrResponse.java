...
public class AddDocumentOcrResponse {
  ...
  public AddDocumentOcrResponse message(@javax.annotation.Nullable String message) {
   ...
   * @throws IOException if the JSON Element is invalid with respect to AddDocumentOcrResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AddDocumentOcrResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in AddDocumentOcrResponse is not found in the empty JSON string", AddDocumentOcrResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AddDocumentOcrResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `AddDocumentOcrResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
