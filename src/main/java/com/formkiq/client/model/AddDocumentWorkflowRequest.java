...
public class AddDocumentWorkflowRequest {
  ...
  public AddDocumentWorkflowRequest workflowId(@javax.annotation.Nonnull String workflowId) {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("workflowId"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AddDocumentWorkflowRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in AddDocumentWorkflowRequest is not found in the empty JSON string", AddDocumentWorkflowRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AddDocumentWorkflowRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `AddDocumentWorkflowRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
