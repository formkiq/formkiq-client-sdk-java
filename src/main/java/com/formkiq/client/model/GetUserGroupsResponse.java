...
public class GetUserGroupsResponse {
  ...
  public GetUserGroupsResponse next(@javax.annotation.Nullable String next) {
    this.next = next;
    return this;
  }
  ...
  public GetUserGroupsResponse groups(@javax.annotation.Nullable List<Group> groups) {
    this.groups = groups;
    return this;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("next", "groups"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetUserGroupsResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in GetUserGroupsResponse is not found in the empty JSON string", GetUserGroupsResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetUserGroupsResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `GetUserGroupsResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
