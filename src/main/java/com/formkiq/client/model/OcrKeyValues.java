...
public class OcrKeyValues {
  ...
  public OcrKeyValues key(@javax.annotation.Nullable String key) {
    this.key = key;
    return this;
  }
  ...
  public OcrKeyValues values(@javax.annotation.Nullable List<String> values) {
    this.values = values;
    return this;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!OcrKeyValues.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in OcrKeyValues is not found in the empty JSON string", OcrKeyValues.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!OcrKeyValues.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `OcrKeyValues` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
