...
public class AddDocusignEnvelopesRequest {
  ...
  public AddDocusignEnvelopesRequest environment(@javax.annotation.Nonnull DocusignEnvironment environment) {
  ...
  public AddDocusignEnvelopesRequest signers(@javax.annotation.Nullable List<DocusignSigner> signers) {
  ...
  public AddDocusignEnvelopesRequest inpersonSigners(@javax.annotation.Nullable List<DocusignInpersonSigner> inpersonSigners) {
    this.inpersonSigners = inpersonSigners;
    return this;
  }

  public AddDocusignEnvelopesRequest addInpersonSignersItem(DocusignInpersonSigner inpersonSignersItem) {
  ...
  public void setInpersonSigners(@javax.annotation.Nullable List<DocusignInpersonSigner> inpersonSigners) {
    this.inpersonSigners = inpersonSigners;
  }


  public AddDocusignEnvelopesRequest notification(@javax.annotation.Nullable DocusignNotification notification) {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("emailSubject", "environment", "signers", "inpersonSigners", "notification"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AddDocusignEnvelopesRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in AddDocusignEnvelopesRequest is not found in the empty JSON string", AddDocusignEnvelopesRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AddDocusignEnvelopesRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `AddDocusignEnvelopesRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("signers") != null && !jsonObj.get("signers").isJsonNull()) {
        ...
        if (jsonArraysigners != null) {
          ...
          if (!jsonObj.get("signers").isJsonArray()) {
            throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `signers` to be an array in the JSON string but got `%s`", jsonObj.get("signers").toString()));
          }
      ...
      if (jsonObj.get("inpersonSigners") != null && !jsonObj.get("inpersonSigners").isJsonNull()) {
        ...
        if (jsonArrayinpersonSigners != null) {
          ...
          if (!jsonObj.get("inpersonSigners").isJsonArray()) {
            throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `inpersonSigners` to be an array in the JSON string but got `%s`", jsonObj.get("inpersonSigners").toString()));
          }
