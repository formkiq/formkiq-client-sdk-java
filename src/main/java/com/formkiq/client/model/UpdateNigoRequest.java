...
public class UpdateNigoRequest {
  ...
  public UpdateNigoRequest nigo(@javax.annotation.Nullable UpdateNigo nigo) {
    this.nigo = nigo;
    return this;
  }
  ...
  public void setNigo(@javax.annotation.Nullable UpdateNigo nigo) {
    this.nigo = nigo;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateNigoRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in UpdateNigoRequest is not found in the empty JSON string", UpdateNigoRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateNigoRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `UpdateNigoRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
