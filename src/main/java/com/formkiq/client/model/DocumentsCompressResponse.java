...
public class DocumentsCompressResponse {
  ...
  public DocumentsCompressResponse downloadUrl(@javax.annotation.Nullable String downloadUrl) {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("downloadUrl"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DocumentsCompressResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in DocumentsCompressResponse is not found in the empty JSON string", DocumentsCompressResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DocumentsCompressResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `DocumentsCompressResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
