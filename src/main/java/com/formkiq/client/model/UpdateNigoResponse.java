...
public class UpdateNigoResponse {
  ...
  public UpdateNigoResponse nigoId(@javax.annotation.Nullable String nigoId) {
    this.nigoId = nigoId;
    return this;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateNigoResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in UpdateNigoResponse is not found in the empty JSON string", UpdateNigoResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateNigoResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `UpdateNigoResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
