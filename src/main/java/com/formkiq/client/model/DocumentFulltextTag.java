...
public class DocumentFulltextTag {
  ...
  public DocumentFulltextTag eq(@javax.annotation.Nullable String eq) {
    this.eq = eq;
    return this;
  }
  ...
  public DocumentFulltextTag eqOr(@javax.annotation.Nullable List<String> eqOr) {
    this.eqOr = eqOr;
    return this;
  }
  ...
  public DocumentFulltextTag key(@javax.annotation.Nonnull String key) {
    this.key = key;
    return this;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DocumentFulltextTag.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in DocumentFulltextTag is not found in the empty JSON string", DocumentFulltextTag.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DocumentFulltextTag.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `DocumentFulltextTag` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
