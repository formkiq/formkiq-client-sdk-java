...
public class OnlyOfficeConfigDocument {
  ...
  public OnlyOfficeConfigDocument url(@javax.annotation.Nullable String url) {
    this.url = url;
    return this;
  }
  ...
  public OnlyOfficeConfigDocument title(@javax.annotation.Nullable String title) {
    this.title = title;
    return this;
  }
  ...
  public OnlyOfficeConfigDocument key(@javax.annotation.Nullable String key) {
    this.key = key;
    return this;
  }
  ...
  public OnlyOfficeConfigDocument fileType(@javax.annotation.Nullable String fileType) {
