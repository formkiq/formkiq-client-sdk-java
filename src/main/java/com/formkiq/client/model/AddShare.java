...
public class AddShare {
  ...
  public AddShare group(@javax.annotation.Nullable String group) {
    this.group = group;
    return this;
  }
  ...
  public AddShare permissions(@javax.annotation.Nullable List<UserSharePermission> permissions) {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("group", "permissions"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AddShare.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in AddShare is not found in the empty JSON string", AddShare.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AddShare.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `AddShare` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
