...
public class AddMapping {
  ...
  public AddMapping name(@javax.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public AddMapping description(@javax.annotation.Nullable String description) {
  ...
  public AddMapping attributes(@javax.annotation.Nullable List<MappingAttribute> attributes) {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AddMapping.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in AddMapping is not found in the empty JSON string", AddMapping.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AddMapping.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `AddMapping` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
