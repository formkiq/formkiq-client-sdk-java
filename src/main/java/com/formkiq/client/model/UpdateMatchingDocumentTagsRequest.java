...
public class UpdateMatchingDocumentTagsRequest {
  ...
  public UpdateMatchingDocumentTagsRequest match(@javax.annotation.Nonnull UpdateMatchingDocumentTagsRequestMatch match) {
    this.match = match;
    return this;
  }
  ...
  public void setMatch(@javax.annotation.Nonnull UpdateMatchingDocumentTagsRequestMatch match) {
    this.match = match;
  }


  public UpdateMatchingDocumentTagsRequest update(@javax.annotation.Nonnull UpdateMatchingDocumentTagsRequestUpdate update) {
    this.update = update;
    return this;
  }
  ...
  public void setUpdate(@javax.annotation.Nonnull UpdateMatchingDocumentTagsRequestUpdate update) {
    this.update = update;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("match", "update"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("match", "update"));
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateMatchingDocumentTagsRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateMatchingDocumentTagsRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in UpdateMatchingDocumentTagsRequest is not found in the empty JSON string", UpdateMatchingDocumentTagsRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateMatchingDocumentTagsRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `UpdateMatchingDocumentTagsRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
