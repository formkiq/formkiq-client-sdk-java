...
public class RuleCondition {
  ...
  public RuleCondition must(@javax.annotation.Nullable List<RuleConditionMust> must) {
    this.must = must;
    return this;
  }
  ...
  public void setMust(@javax.annotation.Nullable List<RuleConditionMust> must) {
    this.must = must;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("must"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RuleCondition.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in RuleCondition is not found in the empty JSON string", RuleCondition.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RuleCondition.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `RuleCondition` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("must") != null && !jsonObj.get("must").isJsonNull()) {
        ...
        if (jsonArraymust != null) {
          ...
          if (!jsonObj.get("must").isJsonArray()) {
            throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `must` to be an array in the JSON string but got `%s`", jsonObj.get("must").toString()));
          }
