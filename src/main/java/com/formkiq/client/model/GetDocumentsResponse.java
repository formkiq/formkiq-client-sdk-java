...
public class GetDocumentsResponse {
  ...
  public GetDocumentsResponse next(@javax.annotation.Nullable String next) {
    this.next = next;
    return this;
  }
  ...
  public GetDocumentsResponse previous(@javax.annotation.Nullable String previous) {
  ...
  public GetDocumentsResponse documents(@javax.annotation.Nullable List<Document> documents) {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetDocumentsResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in GetDocumentsResponse is not found in the empty JSON string", GetDocumentsResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetDocumentsResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `GetDocumentsResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
