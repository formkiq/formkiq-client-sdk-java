...
public class DocumentSearchRequest {
  ...
  public DocumentSearchRequest query(@javax.annotation.Nonnull DocumentSearch query) {
    this.query = query;
    return this;
  }
  ...
  public void setQuery(@javax.annotation.Nonnull DocumentSearch query) {
    this.query = query;
  }


  public DocumentSearchRequest responseFields(@javax.annotation.Nullable SearchResponseFields responseFields) {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DocumentSearchRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in DocumentSearchRequest is not found in the empty JSON string", DocumentSearchRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DocumentSearchRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `DocumentSearchRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
