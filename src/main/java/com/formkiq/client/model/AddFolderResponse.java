...
public class AddFolderResponse {
  ...
  public AddFolderResponse message(@javax.annotation.Nullable String message) {
  ...
  public AddFolderResponse indexKey(@javax.annotation.Nullable String indexKey) {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("message", "indexKey"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AddFolderResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in AddFolderResponse is not found in the empty JSON string", AddFolderResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AddFolderResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `AddFolderResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
