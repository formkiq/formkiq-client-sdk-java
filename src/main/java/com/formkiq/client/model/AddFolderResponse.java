...
public class AddFolderResponse {
  ...
  * @throws IOException if the JSON Object is invalid with respect to AddFolderResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AddFolderResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AddFolderResponse is not found in the empty JSON string", AddFolderResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!AddFolderResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AddFolderResponse` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
