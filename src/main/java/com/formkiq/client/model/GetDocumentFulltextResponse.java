...
public class GetDocumentFulltextResponse {
  ...
  public GetDocumentFulltextResponse lastModifiedDate(@javax.annotation.Nullable String lastModifiedDate) {
  ...
  public GetDocumentFulltextResponse contentLength(@javax.annotation.Nullable Integer contentLength) {
  ...
  public GetDocumentFulltextResponse metadata(@javax.annotation.Nullable Map<String, Object> metadata) {
  ...
  public GetDocumentFulltextResponse attributes(@javax.annotation.Nullable Map<String, FulltextAttribute> attributes) {
    this.attributes = attributes;
    return this;
  }

  public GetDocumentFulltextResponse putAttributesItem(String key, FulltextAttribute attributesItem) {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(siteId, content, contentType, path, width, height, deepLinkPath, insertedDate, lastModifiedDate, documentId, createdBy, contentLength, checksum, checksumType, tags, metadata, attributes);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("siteId", "content", "contentType", "path", "width", "height", "deepLinkPath", "insertedDate", "lastModifiedDate", "documentId", "createdBy", "contentLength", "checksum", "checksumType", "tags", "metadata", "attributes"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetDocumentFulltextResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in GetDocumentFulltextResponse is not found in the empty JSON string", GetDocumentFulltextResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetDocumentFulltextResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `GetDocumentFulltextResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
