...
public class Ruleset {
  ...
  public Ruleset rulesetId(@javax.annotation.Nullable String rulesetId) {
  ...
  public Ruleset description(@javax.annotation.Nullable String description) {
  ...
  public Ruleset priority(@javax.annotation.Nullable BigDecimal priority) {
  ...
  public Ruleset version(@javax.annotation.Nullable BigDecimal version) {
  ...
  public Ruleset insertedDate(@javax.annotation.Nullable String insertedDate) {
  ...
  public Ruleset status(@javax.annotation.Nullable RulesetStatus status) {
    this.status = status;
    return this;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("rulesetId", "description", "priority", "version", "insertedDate", "status"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if ((jsonObj.get("rulesetId") != null && !jsonObj.get("rulesetId").isJsonNull()) && !jsonObj.get("rulesetId").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `rulesetId` to be a primitive type in the JSON string but got `%s`", jsonObj.get("rulesetId").toString()));
      }
