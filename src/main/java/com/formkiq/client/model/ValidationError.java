...
public class ValidationError {
  ...
  public ValidationError key(@javax.annotation.Nullable String key) {
    this.key = key;
    return this;
  }
  ...
  public ValidationError error(@javax.annotation.Nullable String error) {
    this.error = error;
    return this;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("key", "error"));
