...
public class EsignatureDocusignSigner {
  ...
  * @throws IOException if the JSON Object is invalid with respect to EsignatureDocusignSigner
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!EsignatureDocusignSigner.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EsignatureDocusignSigner is not found in the empty JSON string", EsignatureDocusignSigner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!EsignatureDocusignSigner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `EsignatureDocusignSigner` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
