...
public class GetWebhooksResponse {
  ...
  public GetWebhooksResponse webhooks(@javax.annotation.Nullable List<GetWebhookResponse> webhooks) {
  ...
  public void setWebhooks(@javax.annotation.Nullable List<GetWebhookResponse> webhooks) {
    this.webhooks = webhooks;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("next", "webhooks"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetWebhooksResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in GetWebhooksResponse is not found in the empty JSON string", GetWebhooksResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetWebhooksResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `GetWebhooksResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
