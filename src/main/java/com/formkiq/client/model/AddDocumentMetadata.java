...
public class AddDocumentMetadata {
  ...
  public AddDocumentMetadata key(@javax.annotation.Nonnull String key) {
    this.key = key;
    return this;
  }
  ...
  public AddDocumentMetadata value(@javax.annotation.Nullable String value) {
    this.value = value;
    return this;
  }
  ...
  public AddDocumentMetadata values(@javax.annotation.Nullable List<String> values) {
    this.values = values;
    return this;
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to AddDocumentMetadata
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AddDocumentMetadata.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in AddDocumentMetadata is not found in the empty JSON string", AddDocumentMetadata.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AddDocumentMetadata.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `AddDocumentMetadata` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
