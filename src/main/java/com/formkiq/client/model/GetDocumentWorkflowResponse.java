...
public class GetDocumentWorkflowResponse {
  ...
  public GetDocumentWorkflowResponse workflow(@javax.annotation.Nullable DocumentWorkflow workflow) {
  ...
  public void setWorkflow(@javax.annotation.Nullable DocumentWorkflow workflow) {
    this.workflow = workflow;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("workflow"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetDocumentWorkflowResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in GetDocumentWorkflowResponse is not found in the empty JSON string", GetDocumentWorkflowResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetDocumentWorkflowResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `GetDocumentWorkflowResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
