...
public class AddRuleset {
  ...
  public AddRuleset description(@javax.annotation.Nullable String description) {
  ...
  public AddRuleset priority(@javax.annotation.Nullable BigDecimal priority) {
  ...
  public AddRuleset version(@javax.annotation.Nullable BigDecimal version) {
  ...
  public AddRuleset status(@javax.annotation.Nullable RulesetStatus status) {
    this.status = status;
    return this;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AddRuleset.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in AddRuleset is not found in the empty JSON string", AddRuleset.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AddRuleset.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `AddRuleset` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
