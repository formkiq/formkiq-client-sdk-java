...
public class GetDocumentSync {
  ...
  public GetDocumentSync service(@javax.annotation.Nullable DocumentSyncService service) {
  ...
  public GetDocumentSync status(@javax.annotation.Nullable DocumentSyncStatus status) {
    this.status = status;
    return this;
  }
  ...
  public GetDocumentSync type(@javax.annotation.Nullable DocumentSyncType type) {
    this.type = type;
    return this;
  }
  ...
  public GetDocumentSync syncDate(@javax.annotation.Nullable String syncDate) {
  ...
  public GetDocumentSync userId(@javax.annotation.Nullable String userId) {
    this.userId = userId;
    return this;
  }
  ...
  public GetDocumentSync message(@javax.annotation.Nullable String message) {
