...
public class GetDocumentSync {
  ...
  * @throws IOException if the JSON Object is invalid with respect to GetDocumentSync
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!GetDocumentSync.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetDocumentSync is not found in the empty JSON string", GetDocumentSync.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!GetDocumentSync.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetDocumentSync` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
      ...
      if ((jsonObj.get("syncDate") != null && !jsonObj.get("syncDate").isJsonNull()) && !jsonObj.get("syncDate").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `syncDate` to be a primitive type in the JSON string but got `%s`", jsonObj.get("syncDate").toString()));
      }
