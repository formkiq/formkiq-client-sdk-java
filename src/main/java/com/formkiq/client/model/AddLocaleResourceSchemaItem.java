...
public class AddLocaleResourceSchemaItem {
  ...
  public AddLocaleResourceSchemaItem itemType(@javax.annotation.Nonnull LocaleResourceType itemType) {
  ...
  public AddLocaleResourceSchemaItem localizedValue(@javax.annotation.Nonnull String localizedValue) {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("itemType", "attributeKey", "allowedValue", "localizedValue"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("itemType", "attributeKey", "allowedValue", "localizedValue"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AddLocaleResourceSchemaItem.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in AddLocaleResourceSchemaItem is not found in the empty JSON string", AddLocaleResourceSchemaItem.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AddLocaleResourceSchemaItem.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `AddLocaleResourceSchemaItem` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
