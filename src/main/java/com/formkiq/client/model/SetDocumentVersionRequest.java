...
public class SetDocumentVersionRequest {
  ...
  public SetDocumentVersionRequest versionKey(@javax.annotation.Nullable String versionKey) {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("versionKey"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to SetDocumentVersionRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SetDocumentVersionRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in SetDocumentVersionRequest is not found in the empty JSON string", SetDocumentVersionRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SetDocumentVersionRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `SetDocumentVersionRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
