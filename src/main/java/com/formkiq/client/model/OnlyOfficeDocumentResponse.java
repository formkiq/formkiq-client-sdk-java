...
public class OnlyOfficeDocumentResponse {
  ...
  public OnlyOfficeDocumentResponse config(@javax.annotation.Nullable OnlyOfficeConfig config) {
    this.config = config;
    return this;
  }
  ...
  public void setConfig(@javax.annotation.Nullable OnlyOfficeConfig config) {
    this.config = config;
  }
