...
public class GetDocumentAttributesResponse {
  ...
  public GetDocumentAttributesResponse next(@javax.annotation.Nullable String next) {
    this.next = next;
    return this;
  }
  ...
  public GetDocumentAttributesResponse attributes(@javax.annotation.Nullable List<DocumentAttribute> attributes) {
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetDocumentAttributesResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetDocumentAttributesResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in GetDocumentAttributesResponse is not found in the empty JSON string", GetDocumentAttributesResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetDocumentAttributesResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `GetDocumentAttributesResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
