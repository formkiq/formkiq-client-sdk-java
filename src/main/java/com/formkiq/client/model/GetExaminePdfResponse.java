...
public class GetExaminePdfResponse {
  ...
  public GetExaminePdfResponse fileinfo(@javax.annotation.Nullable PdfDocument fileinfo) {
  ...
  public void setFileinfo(@javax.annotation.Nullable PdfDocument fileinfo) {
    this.fileinfo = fileinfo;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("fileinfo"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetExaminePdfResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in GetExaminePdfResponse is not found in the empty JSON string", GetExaminePdfResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetExaminePdfResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `GetExaminePdfResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
