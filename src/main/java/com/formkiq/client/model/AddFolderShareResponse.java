...
public class AddFolderShareResponse {
  ...
  public AddFolderShareResponse message(@javax.annotation.Nullable String message) {
  ...
  public AddFolderShareResponse shareKey(@javax.annotation.Nullable String shareKey) {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("message", "shareKey"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AddFolderShareResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in AddFolderShareResponse is not found in the empty JSON string", AddFolderShareResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AddFolderShareResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `AddFolderShareResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
