...
public class DocumentTag {
  ...
  public DocumentTag insertedDate(@javax.annotation.Nullable String insertedDate) {
  ...
  public DocumentTag documentId(@javax.annotation.Nullable String documentId) {
  ...
  public DocumentTag type(@javax.annotation.Nullable String type) {
    this.type = type;
    return this;
  }
  ...
  public DocumentTag userId(@javax.annotation.Nullable String userId) {
    this.userId = userId;
    return this;
  }
  ...
  public DocumentTag value(@javax.annotation.Nullable String value) {
    this.value = value;
    return this;
  }
  ...
  public DocumentTag values(@javax.annotation.Nullable List<String> values) {
    this.values = values;
    return this;
  }
  ...
  public DocumentTag key(@javax.annotation.Nullable String key) {
    this.key = key;
    return this;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DocumentTag.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in DocumentTag is not found in the empty JSON string", DocumentTag.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DocumentTag.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `DocumentTag` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
