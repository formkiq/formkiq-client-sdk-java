...
public class UpdateTaskRequest {
  ...
  public UpdateTaskRequest task(@javax.annotation.Nullable UpdateTask task) {
    this.task = task;
    return this;
  }
  ...
  public void setTask(@javax.annotation.Nullable UpdateTask task) {
    this.task = task;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateTaskRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in UpdateTaskRequest is not found in the empty JSON string", UpdateTaskRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateTaskRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `UpdateTaskRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
