...
public class DocusignSigningTabs {
  ...
  public DocusignSigningTabs signHereTabs(@javax.annotation.Nullable List<DocusignSignHereTabs> signHereTabs) {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DocusignSigningTabs.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in DocusignSigningTabs is not found in the empty JSON string", DocusignSigningTabs.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DocusignSigningTabs.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `DocusignSigningTabs` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("signHereTabs") != null && !jsonObj.get("signHereTabs").isJsonNull()) {
        ...
        if (jsonArraysignHereTabs != null) {
          ...
          if (!jsonObj.get("signHereTabs").isJsonArray()) {
            throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `signHereTabs` to be an array in the JSON string but got `%s`", jsonObj.get("signHereTabs").toString()));
          }
