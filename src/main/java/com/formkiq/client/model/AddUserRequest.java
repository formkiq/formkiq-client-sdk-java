...
public class AddUserRequest {
  ...
  public AddUserRequest user(@javax.annotation.Nonnull AddUser user) {
    this.user = user;
    return this;
  }
  ...
  public void setUser(@javax.annotation.Nonnull AddUser user) {
    this.user = user;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AddUserRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in AddUserRequest is not found in the empty JSON string", AddUserRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AddUserRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `AddUserRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
