...
public class AddDocumentGenerateRequest {
  ...
  public AddDocumentGenerateRequest insertDocuments(@javax.annotation.Nullable List<DocumentGenerateInsertDocument> insertDocuments) {
    this.insertDocuments = insertDocuments;
    return this;
  }

  public AddDocumentGenerateRequest addInsertDocumentsItem(DocumentGenerateInsertDocument insertDocumentsItem) {
  ...
  public void setInsertDocuments(@javax.annotation.Nullable List<DocumentGenerateInsertDocument> insertDocuments) {
    this.insertDocuments = insertDocuments;
  }


  public AddDocumentGenerateRequest datasources(@javax.annotation.Nullable List<DocumentGenerateDataSource> datasources) {
  ...
  public void setDatasources(@javax.annotation.Nullable List<DocumentGenerateDataSource> datasources) {
    this.datasources = datasources;
  }


  public AddDocumentGenerateRequest outputType(@javax.annotation.Nullable DocumentGenerateOutputType outputType) {
  ...
  public AddDocumentGenerateRequest saveAsDocumentId(@javax.annotation.Nullable String saveAsDocumentId) {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("locale", "insertDocuments", "datasources", "outputType", "saveAsDocumentId", "path"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AddDocumentGenerateRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in AddDocumentGenerateRequest is not found in the empty JSON string", AddDocumentGenerateRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AddDocumentGenerateRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `AddDocumentGenerateRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("insertDocuments") != null && !jsonObj.get("insertDocuments").isJsonNull()) {
        ...
        if (jsonArrayinsertDocuments != null) {
          ...
          if (!jsonObj.get("insertDocuments").isJsonArray()) {
            throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `insertDocuments` to be an array in the JSON string but got `%s`", jsonObj.get("insertDocuments").toString()));
          }
      ...
      if ((jsonObj.get("saveAsDocumentId") != null && !jsonObj.get("saveAsDocumentId").isJsonNull()) && !jsonObj.get("saveAsDocumentId").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `saveAsDocumentId` to be a primitive type in the JSON string but got `%s`", jsonObj.get("saveAsDocumentId").toString()));
      }
