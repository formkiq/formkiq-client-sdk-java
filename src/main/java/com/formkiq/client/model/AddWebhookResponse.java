...
public class AddWebhookResponse {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("webhookId", "siteId"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AddWebhookResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in AddWebhookResponse is not found in the empty JSON string", AddWebhookResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AddWebhookResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `AddWebhookResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
