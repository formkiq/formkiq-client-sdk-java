...
public class DocumentFulltextRequest {
  ...
  public DocumentFulltextRequest query(@javax.annotation.Nonnull DocumentFulltextSearch query) {
    this.query = query;
    return this;
  }
  ...
  public void setQuery(@javax.annotation.Nonnull DocumentFulltextSearch query) {
    this.query = query;
  }


  public DocumentFulltextRequest responseFields(@javax.annotation.Nullable SearchResponseFields responseFields) {
  ...
  public void setResponseFields(@javax.annotation.Nullable SearchResponseFields responseFields) {
    this.responseFields = responseFields;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("query", "responseFields"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DocumentFulltextRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in DocumentFulltextRequest is not found in the empty JSON string", DocumentFulltextRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DocumentFulltextRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `DocumentFulltextRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
