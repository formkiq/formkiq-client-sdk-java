...
public class SetDocumentFulltextRequest {
  ...
  **/
  ...
  public SetDocumentFulltextRequest tags(List<AddDocumentTagRequest> tags) {
    
    this.tags = tags;
    return this;
  }

  public SetDocumentFulltextRequest addTagsItem(AddDocumentTagRequest tagsItem) {
    if (this.tags == null) {
  ...
  * @throws IOException if the JSON Object is invalid with respect to SetDocumentFulltextRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!SetDocumentFulltextRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SetDocumentFulltextRequest is not found in the empty JSON string", SetDocumentFulltextRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!SetDocumentFulltextRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SetDocumentFulltextRequest` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
