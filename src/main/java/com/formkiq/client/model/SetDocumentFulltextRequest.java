...
public class SetDocumentFulltextRequest {
  ...
  public SetDocumentFulltextRequest contentUrls(@javax.annotation.Nullable List<String> contentUrls) {
  ...
  public SetDocumentFulltextRequest checksumType(@javax.annotation.Nullable ChecksumType checksumType) {
  ...
  public SetDocumentFulltextRequest metadata(@javax.annotation.Nullable List<AddDocumentMetadata> metadata) {
  ...
  public SetDocumentFulltextRequest attributes(@javax.annotation.Nullable Map<String, FulltextAttribute> attributes) {
    this.attributes = attributes;
    return this;
  }

  public SetDocumentFulltextRequest putAttributesItem(String key, FulltextAttribute attributesItem) {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SetDocumentFulltextRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in SetDocumentFulltextRequest is not found in the empty JSON string", SetDocumentFulltextRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SetDocumentFulltextRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `SetDocumentFulltextRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
