...
public class AddTask {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(name, description, status, plannedStartDate, startDate, endDate, dueDate, metadata, documentIds);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("name", "description", "status", "plannedStartDate", "startDate", "endDate", "dueDate", "metadata", "documentIds"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AddTask.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in AddTask is not found in the empty JSON string", AddTask.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AddTask.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `AddTask` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
