...
public class GetOpaAccessPolicyItemsResponse {
  ...
  public GetOpaAccessPolicyItemsResponse policyItems(@javax.annotation.Nullable List<OpaPolicyItem> policyItems) {
  ...
  public boolean equals(Object o) {
    ...
    GetOpaAccessPolicyItemsResponse getOpaAccessPolicyItemsResponse = (GetOpaAccessPolicyItemsResponse) o;
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetOpaAccessPolicyItemsResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetOpaAccessPolicyItemsResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in GetOpaAccessPolicyItemsResponse is not found in the empty JSON string", GetOpaAccessPolicyItemsResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetOpaAccessPolicyItemsResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `GetOpaAccessPolicyItemsResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("policyItems") != null && !jsonObj.get("policyItems").isJsonNull()) {
        ...
        if (jsonArraypolicyItems != null) {
          ...
          if (!jsonObj.get("policyItems").isJsonArray()) {
            throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `policyItems` to be an array in the JSON string but got `%s`", jsonObj.get("policyItems").toString()));
          }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetOpaAccessPolicyItemsResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetOpaAccessPolicyItemsResponse' and its subtypes
       }
       ...
       return (TypeAdapter<T>) new TypeAdapter<GetOpaAccessPolicyItemsResponse>() {
           @Override
           public void write(JsonWriter out, GetOpaAccessPolicyItemsResponse value) throws IOException {
   ...
   * @throws IOException if the JSON string is invalid with respect to GetOpaAccessPolicyItemsResponse
   */
