...
public class WorkflowQueue {
  ...
  public WorkflowQueue queueId(@javax.annotation.Nullable String queueId) {
  ...
  public WorkflowQueue approvalGroups(@javax.annotation.Nullable List<String> approvalGroups) {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!WorkflowQueue.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in WorkflowQueue is not found in the empty JSON string", WorkflowQueue.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!WorkflowQueue.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `WorkflowQueue` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
