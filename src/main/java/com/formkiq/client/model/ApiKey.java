...
public class ApiKey {
  ...
  public ApiKey apiKey(@javax.annotation.Nullable String apiKey) {
    this.apiKey = apiKey;
    return this;
  }
  ...
  public ApiKey siteId(@javax.annotation.Nullable String siteId) {
    this.siteId = siteId;
    return this;
  }
  ...
  public ApiKey insertedDate(@javax.annotation.Nullable String insertedDate) {
  ...
  public ApiKey permissions(@javax.annotation.Nullable List<PermissionsEnum> permissions) {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("name", "apiKey", "userId", "siteId", "insertedDate", "permissions"));
