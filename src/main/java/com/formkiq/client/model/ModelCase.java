...
public class ModelCase {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.caseId, _case.caseId) &&
        ...
        Objects.equals(this.userId, _case.userId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(caseId, caseNumber, documentNumber, plannedStartDate, startDate, endDate, dueDate, insertedDate, name, description, metadata, status, userId);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("caseId", "caseNumber", "documentNumber", "plannedStartDate", "startDate", "endDate", "dueDate", "insertedDate", "name", "description", "metadata", "status", "userId"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ModelCase.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in ModelCase is not found in the empty JSON string", ModelCase.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ModelCase.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `ModelCase` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if ((jsonObj.get("caseNumber") != null && !jsonObj.get("caseNumber").isJsonNull()) && !jsonObj.get("caseNumber").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `caseNumber` to be a primitive type in the JSON string but got `%s`", jsonObj.get("caseNumber").toString()));
      }
      if ((jsonObj.get("documentNumber") != null && !jsonObj.get("documentNumber").isJsonNull()) && !jsonObj.get("documentNumber").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `documentNumber` to be a primitive type in the JSON string but got `%s`", jsonObj.get("documentNumber").toString()));
      }
