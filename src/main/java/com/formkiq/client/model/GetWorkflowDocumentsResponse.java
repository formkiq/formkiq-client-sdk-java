...
public class GetWorkflowDocumentsResponse {
  ...
  public GetWorkflowDocumentsResponse next(@javax.annotation.Nullable String next) {
    this.next = next;
    return this;
  }
  ...
  public GetWorkflowDocumentsResponse documents(@javax.annotation.Nullable List<Document> documents) {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetWorkflowDocumentsResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in GetWorkflowDocumentsResponse is not found in the empty JSON string", GetWorkflowDocumentsResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetWorkflowDocumentsResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `GetWorkflowDocumentsResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
