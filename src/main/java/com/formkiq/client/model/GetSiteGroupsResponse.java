...
public class GetSiteGroupsResponse {
  ...
  public GetSiteGroupsResponse groupNames(@javax.annotation.Nullable List<String> groupNames) {
  ...
  public void setGroupNames(@javax.annotation.Nullable List<String> groupNames) {
    this.groupNames = groupNames;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("groupNames"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetSiteGroupsResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in GetSiteGroupsResponse is not found in the empty JSON string", GetSiteGroupsResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetSiteGroupsResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `GetSiteGroupsResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // ensure the optional json data is an array if present
      if (jsonObj.get("groupNames") != null && !jsonObj.get("groupNames").isJsonNull() && !jsonObj.get("groupNames").isJsonArray()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `groupNames` to be an array in the JSON string but got `%s`", jsonObj.get("groupNames").toString()));
      }
  }
