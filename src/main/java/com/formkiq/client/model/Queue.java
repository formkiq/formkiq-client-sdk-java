...
public class Queue {
  ...
  public Queue queueId(@javax.annotation.Nullable String queueId) {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("name", "queueId"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Queue.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in Queue is not found in the empty JSON string", Queue.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Queue.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `Queue` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
