...
public class ResourceItem {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(itemType, localizedValue, interfaceKey, itemKey, attributeKey, allowedValue, classificationId);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("itemType", "localizedValue", "interfaceKey", "itemKey", "attributeKey", "allowedValue", "classificationId"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ResourceItem.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in ResourceItem is not found in the empty JSON string", ResourceItem.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ResourceItem.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `ResourceItem` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if ((jsonObj.get("interfaceKey") != null && !jsonObj.get("interfaceKey").isJsonNull()) && !jsonObj.get("interfaceKey").isJsonPrimitive()) {
