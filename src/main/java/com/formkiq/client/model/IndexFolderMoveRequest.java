...
public class IndexFolderMoveRequest {
  ...
  public IndexFolderMoveRequest source(@javax.annotation.Nullable String source) {
    this.source = source;
    return this;
  }
  ...
  public IndexFolderMoveRequest target(@javax.annotation.Nullable String target) {
    this.target = target;
    return this;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("source", "target"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!IndexFolderMoveRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in IndexFolderMoveRequest is not found in the empty JSON string", IndexFolderMoveRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!IndexFolderMoveRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `IndexFolderMoveRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
