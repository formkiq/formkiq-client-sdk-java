...
public class AddWorkflowStep {
  ...
  public AddWorkflowStep stepId(@javax.annotation.Nullable String stepId) {
    this.stepId = stepId;
    return this;
  }
  ...
  public AddWorkflowStep action(@javax.annotation.Nullable AddAction action) {
    this.action = action;
    return this;
  }
  ...
  public void setAction(@javax.annotation.Nullable AddAction action) {
    this.action = action;
  }


  public AddWorkflowStep queue(@javax.annotation.Nullable AddWorkflowStepQueue queue) {
    this.queue = queue;
    return this;
  }
  ...
  public void setQueue(@javax.annotation.Nullable AddWorkflowStepQueue queue) {
    this.queue = queue;
  }


  public AddWorkflowStep decisions(@javax.annotation.Nullable List<AddWorkflowStepDecision> decisions) {
  ...
  public void setDecisions(@javax.annotation.Nullable List<AddWorkflowStepDecision> decisions) {
    this.decisions = decisions;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AddWorkflowStep.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in AddWorkflowStep is not found in the empty JSON string", AddWorkflowStep.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AddWorkflowStep.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `AddWorkflowStep` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("decisions") != null && !jsonObj.get("decisions").isJsonNull()) {
        ...
        if (jsonArraydecisions != null) {
          ...
          if (!jsonObj.get("decisions").isJsonArray()) {
            throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `decisions` to be an array in the JSON string but got `%s`", jsonObj.get("decisions").toString()));
          }
