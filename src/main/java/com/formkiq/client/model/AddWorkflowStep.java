...
public class AddWorkflowStep {
  ...
  public AddWorkflowStep mappings(@javax.annotation.Nullable List<WorkflowStepMapping> mappings) {
    this.mappings = mappings;
    return this;
  }

  public AddWorkflowStep addMappingsItem(WorkflowStepMapping mappingsItem) {
  ...
  public AddWorkflowStep decision(@javax.annotation.Nullable WorkflowStepDecision decision) {
  ...
  @Deprecated
  public AddWorkflowStep decisions(
      @javax.annotation.Nullable List<AddWorkflowStepDecision> decisions) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.stepId, addWorkflowStep.stepId)
        ...
        && Objects.equals(this.decision, addWorkflowStep.decision)
