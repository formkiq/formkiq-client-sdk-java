...
public class AddActionParameters {
  ...
  public AddActionParameters ocrTextractQueries(@javax.annotation.Nullable List<TextractQuery> ocrTextractQueries) {
  ...
  public void setOcrTextractQueries(@javax.annotation.Nullable List<TextractQuery> ocrTextractQueries) {
    this.ocrTextractQueries = ocrTextractQueries;
  }
  ...
  public AddActionParameters addPdfDetectedCharactersAsText(@javax.annotation.Nullable String addPdfDetectedCharactersAsText) {
  ...
  public void setAddPdfDetectedCharactersAsText(@javax.annotation.Nullable String addPdfDetectedCharactersAsText) {
    this.addPdfDetectedCharactersAsText = addPdfDetectedCharactersAsText;
  }


  public AddActionParameters llmPromptEntityName(@javax.annotation.Nullable String llmPromptEntityName) {
  ...
  public AddActionParameters notificationType(@javax.annotation.Nullable NotificationTypeEnum notificationType) {
  ...
  public AddActionParameters notificationToBcc(@javax.annotation.Nullable String notificationToBcc) {
  ...
  public AddActionParameters notificationSubject(@javax.annotation.Nullable String notificationSubject) {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("ocrTextractQueries", "ocrParseTypes", "ocrEngine", "ocrOutputType", "ocrNumberOfPages", "addPdfDetectedCharactersAsText", "llmPromptEntityName", "url", "characterMax", "engine", "notificationType", "notificationToCc", "notificationToBcc", "notificationSubject", "notificationText", "notificationHtml", "tags", "mappingId", "eventBusName", "width", "height", "path", "outputType"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AddActionParameters.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in AddActionParameters is not found in the empty JSON string", AddActionParameters.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AddActionParameters.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `AddActionParameters` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      if (jsonObj.get("ocrTextractQueries") != null && !jsonObj.get("ocrTextractQueries").isJsonNull()) {
        ...
        if (jsonArrayocrTextractQueries != null) {
          ...
          if (!jsonObj.get("ocrTextractQueries").isJsonArray()) {
            throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `ocrTextractQueries` to be an array in the JSON string but got `%s`", jsonObj.get("ocrTextractQueries").toString()));
          }
      ...
      if ((jsonObj.get("ocrParseTypes") != null && !jsonObj.get("ocrParseTypes").isJsonNull()) && !jsonObj.get("ocrParseTypes").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `ocrParseTypes` to be a primitive type in the JSON string but got `%s`", jsonObj.get("ocrParseTypes").toString()));
      }
      ...
      if ((jsonObj.get("ocrNumberOfPages") != null && !jsonObj.get("ocrNumberOfPages").isJsonNull()) && !jsonObj.get("ocrNumberOfPages").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `ocrNumberOfPages` to be a primitive type in the JSON string but got `%s`", jsonObj.get("ocrNumberOfPages").toString()));
      }
      if ((jsonObj.get("addPdfDetectedCharactersAsText") != null && !jsonObj.get("addPdfDetectedCharactersAsText").isJsonNull()) && !jsonObj.get("addPdfDetectedCharactersAsText").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `addPdfDetectedCharactersAsText` to be a primitive type in the JSON string but got `%s`", jsonObj.get("addPdfDetectedCharactersAsText").toString()));
      }
      if ((jsonObj.get("llmPromptEntityName") != null && !jsonObj.get("llmPromptEntityName").isJsonNull()) && !jsonObj.get("llmPromptEntityName").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `llmPromptEntityName` to be a primitive type in the JSON string but got `%s`", jsonObj.get("llmPromptEntityName").toString()));
      }
      ...
      if ((jsonObj.get("characterMax") != null && !jsonObj.get("characterMax").isJsonNull()) && !jsonObj.get("characterMax").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `characterMax` to be a primitive type in the JSON string but got `%s`", jsonObj.get("characterMax").toString()));
      }
      if ((jsonObj.get("engine") != null && !jsonObj.get("engine").isJsonNull()) && !jsonObj.get("engine").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `engine` to be a primitive type in the JSON string but got `%s`", jsonObj.get("engine").toString()));
      }
      ...
      if ((jsonObj.get("notificationToCc") != null && !jsonObj.get("notificationToCc").isJsonNull()) && !jsonObj.get("notificationToCc").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `notificationToCc` to be a primitive type in the JSON string but got `%s`", jsonObj.get("notificationToCc").toString()));
      }
      if ((jsonObj.get("notificationToBcc") != null && !jsonObj.get("notificationToBcc").isJsonNull()) && !jsonObj.get("notificationToBcc").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `notificationToBcc` to be a primitive type in the JSON string but got `%s`", jsonObj.get("notificationToBcc").toString()));
      }
      if ((jsonObj.get("notificationSubject") != null && !jsonObj.get("notificationSubject").isJsonNull()) && !jsonObj.get("notificationSubject").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `notificationSubject` to be a primitive type in the JSON string but got `%s`", jsonObj.get("notificationSubject").toString()));
      }
      if ((jsonObj.get("notificationText") != null && !jsonObj.get("notificationText").isJsonNull()) && !jsonObj.get("notificationText").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `notificationText` to be a primitive type in the JSON string but got `%s`", jsonObj.get("notificationText").toString()));
      }
      if ((jsonObj.get("notificationHtml") != null && !jsonObj.get("notificationHtml").isJsonNull()) && !jsonObj.get("notificationHtml").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `notificationHtml` to be a primitive type in the JSON string but got `%s`", jsonObj.get("notificationHtml").toString()));
      }
      ...
      if ((jsonObj.get("mappingId") != null && !jsonObj.get("mappingId").isJsonNull()) && !jsonObj.get("mappingId").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `mappingId` to be a primitive type in the JSON string but got `%s`", jsonObj.get("mappingId").toString()));
      }
      if ((jsonObj.get("eventBusName") != null && !jsonObj.get("eventBusName").isJsonNull()) && !jsonObj.get("eventBusName").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `eventBusName` to be a primitive type in the JSON string but got `%s`", jsonObj.get("eventBusName").toString()));
      }
      ...
      if ((jsonObj.get("outputType") != null && !jsonObj.get("outputType").isJsonNull()) && !jsonObj.get("outputType").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `outputType` to be a primitive type in the JSON string but got `%s`", jsonObj.get("outputType").toString()));
      }
  }
