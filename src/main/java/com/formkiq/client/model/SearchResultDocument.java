...
public class SearchResultDocument {
  ...
  public SearchResultDocument siteId(@javax.annotation.Nullable String siteId) {
    this.siteId = siteId;
    return this;
  }
  ...
  public SearchResultDocument path(@javax.annotation.Nullable String path) {
    this.path = path;
    return this;
  }
  ...
  public SearchResultDocument width(@javax.annotation.Nullable String width) {
    this.width = width;
    return this;
  }
  ...
  public SearchResultDocument height(@javax.annotation.Nullable String height) {
    this.height = height;
    return this;
  }
  ...
  public SearchResultDocument deepLinkPath(@javax.annotation.Nullable String deepLinkPath) {
  ...
  public SearchResultDocument insertedDate(@javax.annotation.Nullable String insertedDate) {
  ...
  public SearchResultDocument lastModifiedDate(@javax.annotation.Nullable String lastModifiedDate) {
  ...
  public SearchResultDocument folder(@javax.annotation.Nullable Boolean folder) {
    this.folder = folder;
    return this;
  }
  ...
  public void setFolder(@javax.annotation.Nullable Boolean folder) {
    this.folder = folder;
  }


  public SearchResultDocument indexKey(@javax.annotation.Nullable String indexKey) {
  ...
  public void setIndexKey(@javax.annotation.Nullable String indexKey) {
    this.indexKey = indexKey;
  }


  public SearchResultDocument checksum(@javax.annotation.Nullable String checksum) {
  ...
  public SearchResultDocument checksumType(@javax.annotation.Nullable ChecksumType checksumType) {
  ...
  public SearchResultDocument documentId(@javax.annotation.Nullable String documentId) {
  ...
  public SearchResultDocument userId(@javax.annotation.Nullable String userId) {
    this.userId = userId;
    return this;
  }
  ...
  public SearchResultDocument contentLength(@javax.annotation.Nullable Integer contentLength) {
  ...
  public SearchResultDocument versionId(@javax.annotation.Nullable String versionId) {
  ...
  public SearchResultDocument belongsToDocumentId(@javax.annotation.Nullable String belongsToDocumentId) {
  ...
  public SearchResultDocument matchedAttribute(@javax.annotation.Nullable DocumentSearchMatchAttribute matchedAttribute) {
  ...
  public void setMatchedAttribute(@javax.annotation.Nullable DocumentSearchMatchAttribute matchedAttribute) {
    this.matchedAttribute = matchedAttribute;
  }


  public SearchResultDocument matchedTag(@javax.annotation.Nullable DocumentSearchMatchTag matchedTag) {
  ...
  public void setMatchedTag(@javax.annotation.Nullable DocumentSearchMatchTag matchedTag) {
    this.matchedTag = matchedTag;
  }


  public SearchResultDocument matchedTags(@javax.annotation.Nullable List<DocumentSearchMatchTag> matchedTags) {
  ...
  public void setMatchedTags(@javax.annotation.Nullable List<DocumentSearchMatchTag> matchedTags) {
    this.matchedTags = matchedTags;
  }


  public SearchResultDocument tags(@javax.annotation.Nullable Map<String, Object> tags) {
    this.tags = tags;
    return this;
  }
  ...
  public SearchResultDocument attributes(@javax.annotation.Nullable Map<String, SearchResultDocumentAttribute> attributes) {
    this.attributes = attributes;
    return this;
  }

  public SearchResultDocument putAttributesItem(String key, SearchResultDocumentAttribute attributesItem) {
  ...
  public void setAttributes(@javax.annotation.Nullable Map<String, SearchResultDocumentAttribute> attributes) {
    this.attributes = attributes;
  }


  public SearchResultDocument metadata(@javax.annotation.Nullable List<DocumentMetadata> metadata) {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(siteId, path, width, height, deepLinkPath, insertedDate, lastModifiedDate, folder, indexKey, checksum, checksumType, documentId, contentType, userId, contentLength, versionId, belongsToDocumentId, matchedAttribute, matchedTag, matchedTags, tags, attributes, metadata);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("siteId", "path", "width", "height", "deepLinkPath", "insertedDate", "lastModifiedDate", "folder", "indexKey", "checksum", "checksumType", "documentId", "contentType", "userId", "contentLength", "versionId", "belongsToDocumentId", "matchedAttribute", "matchedTag", "matchedTags", "tags", "attributes", "metadata"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SearchResultDocument.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in SearchResultDocument is not found in the empty JSON string", SearchResultDocument.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SearchResultDocument.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `SearchResultDocument` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      if ((jsonObj.get("siteId") != null && !jsonObj.get("siteId").isJsonNull()) && !jsonObj.get("siteId").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `siteId` to be a primitive type in the JSON string but got `%s`", jsonObj.get("siteId").toString()));
      }
      ...
      if ((jsonObj.get("deepLinkPath") != null && !jsonObj.get("deepLinkPath").isJsonNull()) && !jsonObj.get("deepLinkPath").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `deepLinkPath` to be a primitive type in the JSON string but got `%s`", jsonObj.get("deepLinkPath").toString()));
      }
      ...
      if ((jsonObj.get("indexKey") != null && !jsonObj.get("indexKey").isJsonNull()) && !jsonObj.get("indexKey").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `indexKey` to be a primitive type in the JSON string but got `%s`", jsonObj.get("indexKey").toString()));
      }
      ...
      if ((jsonObj.get("documentId") != null && !jsonObj.get("documentId").isJsonNull()) && !jsonObj.get("documentId").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `documentId` to be a primitive type in the JSON string but got `%s`", jsonObj.get("documentId").toString()));
      }
      ...
      if ((jsonObj.get("belongsToDocumentId") != null && !jsonObj.get("belongsToDocumentId").isJsonNull()) && !jsonObj.get("belongsToDocumentId").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `belongsToDocumentId` to be a primitive type in the JSON string but got `%s`", jsonObj.get("belongsToDocumentId").toString()));
      }
      ...
      if (jsonObj.get("matchedTags") != null && !jsonObj.get("matchedTags").isJsonNull()) {
        ...
        if (jsonArraymatchedTags != null) {
          ...
          if (!jsonObj.get("matchedTags").isJsonArray()) {
            throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `matchedTags` to be an array in the JSON string but got `%s`", jsonObj.get("matchedTags").toString()));
          }
