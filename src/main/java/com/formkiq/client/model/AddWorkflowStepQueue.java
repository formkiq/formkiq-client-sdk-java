...
public class AddWorkflowStepQueue {
  ...
  public AddWorkflowStepQueue queueId(@javax.annotation.Nonnull String queueId) {
  ...
  public AddWorkflowStepQueue approvalGroups(@javax.annotation.Nullable List<String> approvalGroups) {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("queueId", "approvalGroups"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("queueId"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AddWorkflowStepQueue.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in AddWorkflowStepQueue is not found in the empty JSON string", AddWorkflowStepQueue.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AddWorkflowStepQueue.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `AddWorkflowStepQueue` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("approvalGroups") != null && !jsonObj.get("approvalGroups").isJsonNull() && !jsonObj.get("approvalGroups").isJsonArray()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `approvalGroups` to be an array in the JSON string but got `%s`", jsonObj.get("approvalGroups").toString()));
      }
  }
