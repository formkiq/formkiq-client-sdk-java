...
public class GetDocumentActionsResponse {
  ...
  public GetDocumentActionsResponse next(@javax.annotation.Nullable String next) {
    this.next = next;
    return this;
  }
  ...
  public GetDocumentActionsResponse actions(@javax.annotation.Nullable List<DocumentAction> actions) {
  ...
  public void setActions(@javax.annotation.Nullable List<DocumentAction> actions) {
    this.actions = actions;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.next, getDocumentActionsResponse.next) &&
        Objects.equals(this.actions, getDocumentActionsResponse.actions);
  }

  @Override
  public int hashCode() {
    return Objects.hash(next, actions);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("next", "actions"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetDocumentActionsResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetDocumentActionsResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in GetDocumentActionsResponse is not found in the empty JSON string", GetDocumentActionsResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetDocumentActionsResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `GetDocumentActionsResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("actions") != null && !jsonObj.get("actions").isJsonNull()) {
        ...
        if (jsonArrayactions != null) {
          ...
          for (int i = 0; i < jsonArrayactions.size(); i++) {
            DocumentAction.validateJsonElement(jsonArrayactions.get(i));
          };
        }
      }
  }
