...
public class GetDocumentActionsResponse {
  ...
  public GetDocumentActionsResponse actions(
      @javax.annotation.Nullable List<DocumentAction> actions) {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!GetDocumentActionsResponse.openapiRequiredFields.isEmpty()) { // has required fields but
                                                                         // JSON element is null
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT,
            "The required field(s) %s in GetDocumentActionsResponse is not found in the empty JSON string",
            GetDocumentActionsResponse.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!GetDocumentActionsResponse.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT,
            "The field `%s` in the JSON string is not defined in the `GetDocumentActionsResponse` properties. JSON: %s",
