...
public class GetDocumentWorkflowsResponse {
  ...
  public GetDocumentWorkflowsResponse workflows(@javax.annotation.Nullable List<DocumentWorkflow> workflows) {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("workflows", "next"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetDocumentWorkflowsResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in GetDocumentWorkflowsResponse is not found in the empty JSON string", GetDocumentWorkflowsResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetDocumentWorkflowsResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `GetDocumentWorkflowsResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
