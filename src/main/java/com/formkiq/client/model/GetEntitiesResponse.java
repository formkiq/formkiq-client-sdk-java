...
public class GetEntitiesResponse {
  ...
  public GetEntitiesResponse next(@javax.annotation.Nullable String next) {
    this.next = next;
    return this;
  }
  ...
  public GetEntitiesResponse entities(@javax.annotation.Nullable List<Entity> entities) {
    this.entities = entities;
    return this;
  }

  public GetEntitiesResponse addEntitiesItem(Entity entitiesItem) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.next, getEntitiesResponse.next) &&
        Objects.equals(this.entities, getEntitiesResponse.entities);
  }

  @Override
  public int hashCode() {
    return Objects.hash(next, entities);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("next", "entities"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetEntitiesResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in GetEntitiesResponse is not found in the empty JSON string", GetEntitiesResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetEntitiesResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `GetEntitiesResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
