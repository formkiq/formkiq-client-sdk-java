...
public class GetCasesResponse {
  ...
  public GetCasesResponse next(@javax.annotation.Nullable String next) {
    this.next = next;
    return this;
  }
  ...
  public GetCasesResponse cases(@javax.annotation.Nullable List<ModelCase> cases) {
    this.cases = cases;
    return this;
  }
  ...
  public void setCases(@javax.annotation.Nullable List<ModelCase> cases) {
    this.cases = cases;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("next", "cases"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetCasesResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in GetCasesResponse is not found in the empty JSON string", GetCasesResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetCasesResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `GetCasesResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
