...
public class Document {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.siteId, document.siteId) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(siteId, path, width, height, deepLinkPath, insertedDate, lastModifiedDate, checksum, checksumType, documentId, contentType, userId, contentLength, version, versionKey, s3version, belongsToDocumentId, metadata);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("siteId", "path", "width", "height", "deepLinkPath", "insertedDate", "lastModifiedDate", "checksum", "checksumType", "documentId", "contentType", "userId", "contentLength", "version", "versionKey", "s3version", "belongsToDocumentId", "metadata"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if ((jsonObj.get("versionKey") != null && !jsonObj.get("versionKey").isJsonNull()) && !jsonObj.get("versionKey").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `versionKey` to be a primitive type in the JSON string but got `%s`", jsonObj.get("versionKey").toString()));
      }
      if ((jsonObj.get("s3version") != null && !jsonObj.get("s3version").isJsonNull()) && !jsonObj.get("s3version").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `s3version` to be a primitive type in the JSON string but got `%s`", jsonObj.get("s3version").toString()));
      }
