...
public class Document {
  ...
  public Document resourceType(@javax.annotation.Nullable DocumentResourceType resourceType) {
  ...
  public Document deletedDate(@javax.annotation.Nullable String deletedDate) {
  ...
  public Document promotedArtifactId(@javax.annotation.Nullable String promotedArtifactId) {
  ...
  public Document artifactCategory(@javax.annotation.Nullable String artifactCategory) {
  ...
  public Document hasArtifacts(@javax.annotation.Nullable Boolean hasArtifacts) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.siteId, document.siteId) && Objects.equals(this.path, document.path)
        ...
        && Objects.equals(this.promotedArtifactId, document.promotedArtifactId)
        && Objects.equals(this.artifactCategory, document.artifactCategory)
        && Objects.equals(this.hasArtifacts, document.hasArtifacts)
  ...
  public int hashCode() {
    return Objects.hash(siteId, path, width, height, deepLinkPath, resourceType, insertedDate,
        lastModifiedDate, deletedDate, checksum, checksumType, documentId, artifactId,
        promotedArtifactId, artifactCategory, hasArtifacts, contentType, userId, contentLength,
        version, versionKey, s3version, belongsToDocumentId, metadata);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("siteId", "path", "width", "height",
        "deepLinkPath", "resourceType", "insertedDate", "lastModifiedDate", "deletedDate",
        "checksum", "checksumType", "documentId", "artifactId", "promotedArtifactId",
        "artifactCategory", "hasArtifacts", "contentType", "userId", "contentLength", "version",
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    ...
    if ((jsonObj.get("deletedDate") != null && !jsonObj.get("deletedDate").isJsonNull())
        && !jsonObj.get("deletedDate").isJsonPrimitive()) {
      throw new IllegalArgumentException(String.format(java.util.Locale.ROOT,
          "Expected the field `deletedDate` to be a primitive type in the JSON string but got `%s`",
          jsonObj.get("deletedDate").toString()));
    }
