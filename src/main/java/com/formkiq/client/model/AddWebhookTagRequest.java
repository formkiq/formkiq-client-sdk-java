...
public class AddWebhookTagRequest {
  ...
  public AddWebhookTagRequest value(@javax.annotation.Nullable String value) {
    this.value = value;
    return this;
  }
  ...
  public AddWebhookTagRequest values(@javax.annotation.Nullable List<String> values) {
    this.values = values;
    return this;
  }
  ...
  public AddWebhookTagRequest key(@javax.annotation.Nullable String key) {
    this.key = key;
    return this;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("value", "values", "key"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AddWebhookTagRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in AddWebhookTagRequest is not found in the empty JSON string", AddWebhookTagRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AddWebhookTagRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `AddWebhookTagRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
