...
public class MappingAttribute extends AbstractOpenApiSchema {
      ...
      return (TypeAdapter<T>) new TypeAdapter<MappingAttribute>() {
        ...
        public void write(JsonWriter out, MappingAttribute value) throws IOException {
          ...
          throw new IOException(
              "Failed to serialize as the type doesn't match oneOf schemas: MappingAttributeContent, MappingAttributeDataClassification, MappingAttributeMalwareScan, MappingAttributeManual, MappingAttributeMetadata, MappingAttributeMetadataExtractionResult");
        }
            ...
            switch (jsonObject.get("sourceType").getAsString()) {
              ...
              default:
                log.log(Level.WARNING, String.format(java.util.Locale.ROOT,
                    "Failed to lookup discriminator value `%s` for MappingAttribute. Possible values: CONTENT CONTENT_KEY_VALUE DATA_CLASSIFICATION MALWARE_SCAN MANUAL METADATA METADATA_EXTRACTION_RESULT",
   ...
   * against the oneOf child schemas: MappingAttributeContent, MappingAttributeDataClassification,
   * MappingAttributeMalwareScan, MappingAttributeManual, MappingAttributeMetadata,
  ...
  public void setActualInstance(Object instance) {
    ...
    throw new RuntimeException(
        "Invalid instance type. Must be MappingAttributeContent, MappingAttributeDataClassification, MappingAttributeMalwareScan, MappingAttributeManual, MappingAttributeMetadata, MappingAttributeMetadataExtractionResult");
  }

  /**
   * Get the actual instance, which can be the following: MappingAttributeContent,
   ...
   *
   * @return The actual instance (MappingAttributeContent, MappingAttributeDataClassification,
   *         MappingAttributeMalwareScan, MappingAttributeManual, MappingAttributeMetadata,
   *         MappingAttributeMetadataExtractionResult)
   */
  @SuppressWarnings("unchecked")
