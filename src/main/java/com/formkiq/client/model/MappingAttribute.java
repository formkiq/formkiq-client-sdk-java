...
public class MappingAttribute {
  ...
  public MappingAttribute sourceType(@javax.annotation.Nullable MappingAttributeSourceType sourceType) {
  ...
  public MappingAttribute labelMatchingType(@javax.annotation.Nullable MappingAttributeLabelMatchingType labelMatchingType) {
  ...
  public void setLabelMatchingType(@javax.annotation.Nullable MappingAttributeLabelMatchingType labelMatchingType) {
    this.labelMatchingType = labelMatchingType;
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(attributeKey, sourceType, defaultValue, defaultValues, labelTexts, labelMatchingType, metadataField, validationRegex);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("attributeKey", "sourceType", "defaultValue", "defaultValues", "labelTexts", "labelMatchingType", "metadataField", "validationRegex"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MappingAttribute.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in MappingAttribute is not found in the empty JSON string", MappingAttribute.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MappingAttribute.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `MappingAttribute` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      // ensure the optional json data is an array if present
      if (jsonObj.get("labelTexts") != null && !jsonObj.get("labelTexts").isJsonNull() && !jsonObj.get("labelTexts").isJsonArray()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `labelTexts` to be an array in the JSON string but got `%s`", jsonObj.get("labelTexts").toString()));
      }
      // validate the optional field `labelMatchingType`
      if (jsonObj.get("labelMatchingType") != null && !jsonObj.get("labelMatchingType").isJsonNull()) {
      ...
      if ((jsonObj.get("validationRegex") != null && !jsonObj.get("validationRegex").isJsonNull()) && !jsonObj.get("validationRegex").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `validationRegex` to be a primitive type in the JSON string but got `%s`", jsonObj.get("validationRegex").toString()));
      }
  }
