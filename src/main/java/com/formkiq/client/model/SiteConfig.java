...
public class SiteConfig {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("maxContentLengthBytes", "maxDocuments", "maxWebhooks", "ocr"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SiteConfig.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in SiteConfig is not found in the empty JSON string", SiteConfig.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SiteConfig.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `SiteConfig` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
