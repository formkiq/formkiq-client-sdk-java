...
public class GetUserSharesResponse {
  ...
  public GetUserSharesResponse next(@javax.annotation.Nullable String next) {
    this.next = next;
    return this;
  }
  ...
  public GetUserSharesResponse shares(@javax.annotation.Nullable List<UserShare> shares) {
    this.shares = shares;
    return this;
  }
  ...
  public void setShares(@javax.annotation.Nullable List<UserShare> shares) {
    this.shares = shares;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("next", "shares"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetUserSharesResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in GetUserSharesResponse is not found in the empty JSON string", GetUserSharesResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetUserSharesResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `GetUserSharesResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("shares") != null && !jsonObj.get("shares").isJsonNull()) {
        ...
        if (jsonArrayshares != null) {
          ...
          if (!jsonObj.get("shares").isJsonArray()) {
            throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `shares` to be an array in the JSON string but got `%s`", jsonObj.get("shares").toString()));
          }
