...
public class UserActivityChanges {
  ...
  public UserActivityChanges oldValue(@javax.annotation.Nullable Object oldValue) {
  ...
  public UserActivityChanges newValue(@javax.annotation.Nullable Object newValue) {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("oldValue", "newValue"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UserActivityChanges.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in UserActivityChanges is not found in the empty JSON string", UserActivityChanges.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UserActivityChanges.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `UserActivityChanges` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
