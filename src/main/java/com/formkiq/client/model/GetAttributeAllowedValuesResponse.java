...
public class GetAttributeAllowedValuesResponse {
  ...
  public GetAttributeAllowedValuesResponse allowedValues(@javax.annotation.Nullable List<String> allowedValues) {
  ...
  public GetAttributeAllowedValuesResponse localizedAllowedValues(@javax.annotation.Nullable Map<String, String> localizedAllowedValues) {
    this.localizedAllowedValues = localizedAllowedValues;
    return this;
  }

  public GetAttributeAllowedValuesResponse putLocalizedAllowedValuesItem(String key, String localizedAllowedValuesItem) {
  ...
  public boolean equals(Object o) {
    ...
    GetAttributeAllowedValuesResponse getAttributeAllowedValuesResponse = (GetAttributeAllowedValuesResponse) o;
    return Objects.equals(this.allowedValues, getAttributeAllowedValuesResponse.allowedValues) &&
        Objects.equals(this.localizedAllowedValues, getAttributeAllowedValuesResponse.localizedAllowedValues);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("allowedValues", "localizedAllowedValues"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetAttributeAllowedValuesResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetAttributeAllowedValuesResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in GetAttributeAllowedValuesResponse is not found in the empty JSON string", GetAttributeAllowedValuesResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetAttributeAllowedValuesResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `GetAttributeAllowedValuesResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetAttributeAllowedValuesResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetAttributeAllowedValuesResponse' and its subtypes
       }
       ...
       return (TypeAdapter<T>) new TypeAdapter<GetAttributeAllowedValuesResponse>() {
           @Override
           public void write(JsonWriter out, GetAttributeAllowedValuesResponse value) throws IOException {
   ...
   * @throws IOException if the JSON string is invalid with respect to GetAttributeAllowedValuesResponse
   */
