...
public class SetDocumentVersionResponse {
  ...
  public SetDocumentVersionResponse message(@javax.annotation.Nullable String message) {
   ...
   * @throws IOException if the JSON Element is invalid with respect to SetDocumentVersionResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SetDocumentVersionResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in SetDocumentVersionResponse is not found in the empty JSON string", SetDocumentVersionResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SetDocumentVersionResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `SetDocumentVersionResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
