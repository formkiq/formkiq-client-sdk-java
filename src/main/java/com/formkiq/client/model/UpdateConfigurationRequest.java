...
public class UpdateConfigurationRequest {
  ...
  public UpdateConfigurationRequest maxContentLengthBytes(@javax.annotation.Nullable String maxContentLengthBytes) {
  ...
  public UpdateConfigurationRequest notificationEmail(@javax.annotation.Nullable String notificationEmail) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.chatGptApiKey, updateConfigurationRequest.chatGptApiKey) &&
        Objects.equals(this.maxContentLengthBytes, updateConfigurationRequest.maxContentLengthBytes) &&
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateConfigurationRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in UpdateConfigurationRequest is not found in the empty JSON string", UpdateConfigurationRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateConfigurationRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `UpdateConfigurationRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
