...
public class GetRulesetsResponse {
  ...
  public GetRulesetsResponse next(@javax.annotation.Nullable String next) {
    this.next = next;
    return this;
  }
  ...
  public GetRulesetsResponse rulesets(@javax.annotation.Nullable List<Ruleset> rulesets) {
  ...
  public void setRulesets(@javax.annotation.Nullable List<Ruleset> rulesets) {
    this.rulesets = rulesets;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("next", "rulesets"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetRulesetsResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in GetRulesetsResponse is not found in the empty JSON string", GetRulesetsResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetRulesetsResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `GetRulesetsResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("rulesets") != null && !jsonObj.get("rulesets").isJsonNull()) {
        ...
        if (jsonArrayrulesets != null) {
          ...
          if (!jsonObj.get("rulesets").isJsonArray()) {
            throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `rulesets` to be an array in the JSON string but got `%s`", jsonObj.get("rulesets").toString()));
          }
