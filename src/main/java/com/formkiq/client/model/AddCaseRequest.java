...
public class AddCaseRequest {
  ...
  public AddCaseRequest _case(@javax.annotation.Nonnull AddCase _case) {
    this._case = _case;
    return this;
  }
  ...
  public void setCase(@javax.annotation.Nonnull AddCase _case) {
    this._case = _case;
  }
  ...
  static {
    ...
    openapiRequiredFields = new HashSet<String>(Arrays.asList("case"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AddCaseRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in AddCaseRequest is not found in the empty JSON string", AddCaseRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AddCaseRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `AddCaseRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
