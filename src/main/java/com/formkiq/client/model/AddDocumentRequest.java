...
public class AddDocumentRequest {
  ...
  public AddDocumentRequest documentId(@javax.annotation.Nullable String documentId) {
  ...
  public AddDocumentRequest path(@javax.annotation.Nullable String path) {
    this.path = path;
    return this;
  }
  ...
  public AddDocumentRequest checksumType(@javax.annotation.Nullable ChecksumType checksumType) {
  ...
  public AddDocumentRequest checksum(@javax.annotation.Nullable String checksum) {
  ...
  public AddDocumentRequest width(@javax.annotation.Nullable String width) {
    this.width = width;
    return this;
  }
  ...
  public AddDocumentRequest height(@javax.annotation.Nullable String height) {
    this.height = height;
    return this;
  }
  ...
  public AddDocumentRequest deepLinkPath(@javax.annotation.Nullable String deepLinkPath) {
  ...
  public AddDocumentRequest contentType(@javax.annotation.Nullable String contentType) {
  ...
  public AddDocumentRequest isBase64(@javax.annotation.Nullable Boolean isBase64) {
  ...
  public AddDocumentRequest content(@javax.annotation.Nonnull String content) {
  ...
  public AddDocumentRequest tags(@javax.annotation.Nullable List<AddDocumentTag> tags) {
    this.tags = tags;
    return this;
  }
  ...
  public AddDocumentRequest metadata(@javax.annotation.Nullable List<AddDocumentMetadata> metadata) {
  ...
  public AddDocumentRequest actions(@javax.annotation.Nullable List<AddAction> actions) {
  ...
  public AddDocumentRequest attributes(@javax.annotation.Nullable List<AddDocumentAttribute> attributes) {
  ...
  public AddDocumentRequest documents(@javax.annotation.Nullable List<AddChildDocument> documents) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.documentId, addDocumentRequest.documentId) &&
        ...
        Objects.equals(this.width, addDocumentRequest.width) &&
        Objects.equals(this.height, addDocumentRequest.height) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(documentId, path, checksumType, checksum, width, height, deepLinkPath, contentType, isBase64, content, tags, metadata, actions, attributes, documents);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("documentId", "path", "checksumType", "checksum", "width", "height", "deepLinkPath", "contentType", "isBase64", "content", "tags", "metadata", "actions", "attributes", "documents"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AddDocumentRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in AddDocumentRequest is not found in the empty JSON string", AddDocumentRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AddDocumentRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `AddDocumentRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
