...
public class DocumentConfig {
  ...
  public DocumentConfig contentTypes(
      @javax.annotation.Nullable DocumentConfigContentTypes contentTypes) {
   ...
   */
  @javax.annotation.Nullable
  public DocumentConfigContentTypes getContentTypes() {
    return contentTypes;
  }

  public void setContentTypes(@javax.annotation.Nullable DocumentConfigContentTypes contentTypes) {
    this.contentTypes = contentTypes;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!DocumentConfig.openapiRequiredFields.isEmpty()) { // has required fields but JSON element
                                                             // is null
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT,
            "The required field(s) %s in DocumentConfig is not found in the empty JSON string",
            DocumentConfig.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!DocumentConfig.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT,
            "The field `%s` in the JSON string is not defined in the `DocumentConfig` properties. JSON: %s",
