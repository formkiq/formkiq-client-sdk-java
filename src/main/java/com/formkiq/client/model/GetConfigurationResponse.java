...
public class GetConfigurationResponse {
  ...
  public GetConfigurationResponse maxContentLengthBytes(@javax.annotation.Nullable String maxContentLengthBytes) {
  ...
  public GetConfigurationResponse notificationEmail(@javax.annotation.Nullable String notificationEmail) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.chatGptApiKey, getConfigurationResponse.chatGptApiKey) &&
        Objects.equals(this.maxContentLengthBytes, getConfigurationResponse.maxContentLengthBytes) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(chatGptApiKey, maxContentLengthBytes, maxDocuments, maxWebhooks, notificationEmail, ocr, google, docusign);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("chatGptApiKey", "maxContentLengthBytes", "maxDocuments", "maxWebhooks", "notificationEmail", "ocr", "google", "docusign"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetConfigurationResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in GetConfigurationResponse is not found in the empty JSON string", GetConfigurationResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetConfigurationResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `GetConfigurationResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      if ((jsonObj.get("chatGptApiKey") != null && !jsonObj.get("chatGptApiKey").isJsonNull()) && !jsonObj.get("chatGptApiKey").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `chatGptApiKey` to be a primitive type in the JSON string but got `%s`", jsonObj.get("chatGptApiKey").toString()));
      }
      if ((jsonObj.get("maxContentLengthBytes") != null && !jsonObj.get("maxContentLengthBytes").isJsonNull()) && !jsonObj.get("maxContentLengthBytes").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `maxContentLengthBytes` to be a primitive type in the JSON string but got `%s`", jsonObj.get("maxContentLengthBytes").toString()));
      }
      if ((jsonObj.get("maxDocuments") != null && !jsonObj.get("maxDocuments").isJsonNull()) && !jsonObj.get("maxDocuments").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `maxDocuments` to be a primitive type in the JSON string but got `%s`", jsonObj.get("maxDocuments").toString()));
      }
      if ((jsonObj.get("maxWebhooks") != null && !jsonObj.get("maxWebhooks").isJsonNull()) && !jsonObj.get("maxWebhooks").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `maxWebhooks` to be a primitive type in the JSON string but got `%s`", jsonObj.get("maxWebhooks").toString()));
      }
      if ((jsonObj.get("notificationEmail") != null && !jsonObj.get("notificationEmail").isJsonNull()) && !jsonObj.get("notificationEmail").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `notificationEmail` to be a primitive type in the JSON string but got `%s`", jsonObj.get("notificationEmail").toString()));
      }
