...
public class AddCaseResponse {
  ...
  public AddCaseResponse caseId(@javax.annotation.Nullable String caseId) {
    this.caseId = caseId;
    return this;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AddCaseResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in AddCaseResponse is not found in the empty JSON string", AddCaseResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AddCaseResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `AddCaseResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
