...
public class AddDocumentUploadRequest {
  ...
  public AddDocumentUploadRequest attributes(@javax.annotation.Nullable List<AddDocumentAttribute> attributes) {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(documentId, path, contentType, width, height, deepLinkPath, checksumType, checksum, attributes, tags, actions);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("documentId", "path", "contentType", "width", "height", "deepLinkPath", "checksumType", "checksum", "attributes", "tags", "actions"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AddDocumentUploadRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in AddDocumentUploadRequest is not found in the empty JSON string", AddDocumentUploadRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AddDocumentUploadRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `AddDocumentUploadRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
