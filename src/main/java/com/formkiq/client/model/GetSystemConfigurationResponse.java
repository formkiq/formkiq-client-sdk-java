...
public class GetSystemConfigurationResponse {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!GetSystemConfigurationResponse.openapiRequiredFields.isEmpty()) { // has required fields
                                                                             // but JSON element is
                                                                             // null
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT,
            "The required field(s) %s in GetSystemConfigurationResponse is not found in the empty JSON string",
            GetSystemConfigurationResponse.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!GetSystemConfigurationResponse.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT,
            "The field `%s` in the JSON string is not defined in the `GetSystemConfigurationResponse` properties. JSON: %s",
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      if (!GetSystemConfigurationResponse.class.isAssignableFrom(type.getRawType())) {
        return null; // this class only serializes 'GetSystemConfigurationResponse' and its subtypes
      }
      final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
      final TypeAdapter<GetSystemConfigurationResponse> thisAdapter =
          gson.getDelegateAdapter(this, TypeToken.get(GetSystemConfigurationResponse.class));

      return (TypeAdapter<T>) new TypeAdapter<GetSystemConfigurationResponse>() {
        @Override
        public void write(JsonWriter out, GetSystemConfigurationResponse value) throws IOException {
          JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
          elementAdapter.write(out, obj);
        }

        @Override
        public GetSystemConfigurationResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetSystemConfigurationResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetSystemConfigurationResponse
   * @throws IOException if the JSON string is invalid with respect to
   *         GetSystemConfigurationResponse
   */
  public static GetSystemConfigurationResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetSystemConfigurationResponse.class);
  }

  /**
   * Convert an instance of GetSystemConfigurationResponse to an JSON string
   *
   * @return JSON string
   */
