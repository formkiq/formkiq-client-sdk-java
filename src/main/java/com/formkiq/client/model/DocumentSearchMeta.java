...
public class DocumentSearchMeta {
  ...
  public DocumentSearchMeta folder(@javax.annotation.Nullable String folder) {
    this.folder = folder;
    return this;
  }
  ...
  public DocumentSearchMeta path(@javax.annotation.Nullable String path) {
    this.path = path;
    return this;
  }
  ...
  public DocumentSearchMeta eq(@javax.annotation.Nullable String eq) {
    this.eq = eq;
    return this;
  }
  ...
  public DocumentSearchMeta indexType(@javax.annotation.Nullable IndexTypeEnum indexType) {
  ...
  public void setIndexType(@javax.annotation.Nullable IndexTypeEnum indexType) {
    this.indexType = indexType;
  }


  public DocumentSearchMeta indexFilterBeginsWith(@javax.annotation.Nullable String indexFilterBeginsWith) {
  ...
  public void setIndexFilterBeginsWith(@javax.annotation.Nullable String indexFilterBeginsWith) {
    this.indexFilterBeginsWith = indexFilterBeginsWith;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("folder", "path", "eq", "indexType", "indexFilterBeginsWith"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DocumentSearchMeta.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in DocumentSearchMeta is not found in the empty JSON string", DocumentSearchMeta.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DocumentSearchMeta.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `DocumentSearchMeta` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if ((jsonObj.get("indexType") != null && !jsonObj.get("indexType").isJsonNull()) && !jsonObj.get("indexType").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `indexType` to be a primitive type in the JSON string but got `%s`", jsonObj.get("indexType").toString()));
      }
      ...
      if ((jsonObj.get("indexFilterBeginsWith") != null && !jsonObj.get("indexFilterBeginsWith").isJsonNull()) && !jsonObj.get("indexFilterBeginsWith").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `indexFilterBeginsWith` to be a primitive type in the JSON string but got `%s`", jsonObj.get("indexFilterBeginsWith").toString()));
      }
  }
