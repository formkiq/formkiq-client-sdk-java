...
public class DocumentSearchMeta {
  ...
  public DocumentSearchMeta indexFilterBeginsWith(
      @javax.annotation.Nullable String indexFilterBeginsWith) {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(
        Arrays.asList("folder", "path", "eq", "indexType", "indexFilterBeginsWith"));
