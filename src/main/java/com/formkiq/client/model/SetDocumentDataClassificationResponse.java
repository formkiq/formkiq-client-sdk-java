...
public class SetDocumentDataClassificationResponse {
  ...
  public SetDocumentDataClassificationResponse attributes(@javax.annotation.Nullable List<DataClassificationAttribute> attributes) {
    this.attributes = attributes;
    return this;
  }

  public SetDocumentDataClassificationResponse addAttributesItem(DataClassificationAttribute attributesItem) {
  ...
  public boolean equals(Object o) {
    ...
    SetDocumentDataClassificationResponse setDocumentDataClassificationResponse = (SetDocumentDataClassificationResponse) o;
   ...
   * @throws IOException if the JSON Element is invalid with respect to SetDocumentDataClassificationResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SetDocumentDataClassificationResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in SetDocumentDataClassificationResponse is not found in the empty JSON string", SetDocumentDataClassificationResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SetDocumentDataClassificationResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `SetDocumentDataClassificationResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SetDocumentDataClassificationResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SetDocumentDataClassificationResponse' and its subtypes
       }
       ...
       return (TypeAdapter<T>) new TypeAdapter<SetDocumentDataClassificationResponse>() {
           @Override
           public void write(JsonWriter out, SetDocumentDataClassificationResponse value) throws IOException {
   ...
   * @throws IOException if the JSON string is invalid with respect to SetDocumentDataClassificationResponse
   */
  public static SetDocumentDataClassificationResponse fromJson(String jsonString) throws IOException {
