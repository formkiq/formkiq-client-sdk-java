...
public class SetMappingRequest {
  ...
  public SetMappingRequest mapping(@javax.annotation.Nullable AddMapping mapping) {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SetMappingRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in SetMappingRequest is not found in the empty JSON string", SetMappingRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SetMappingRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `SetMappingRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
