...
public class AddDocumentWorkflowDecisionsRequest {
  ...
  public AddDocumentWorkflowDecisionsRequest decision(@javax.annotation.Nonnull DecisionEnum decision) {
  ...
  public boolean equals(Object o) {
    ...
    AddDocumentWorkflowDecisionsRequest addDocumentWorkflowDecisionsRequest = (AddDocumentWorkflowDecisionsRequest) o;
   ...
   * @throws IOException if the JSON Element is invalid with respect to AddDocumentWorkflowDecisionsRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AddDocumentWorkflowDecisionsRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in AddDocumentWorkflowDecisionsRequest is not found in the empty JSON string", AddDocumentWorkflowDecisionsRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AddDocumentWorkflowDecisionsRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `AddDocumentWorkflowDecisionsRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if ((jsonObj.get("stepId") != null && !jsonObj.get("stepId").isJsonNull()) && !jsonObj.get("stepId").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `stepId` to be a primitive type in the JSON string but got `%s`", jsonObj.get("stepId").toString()));
      }
      ...
      if (!jsonObj.get("decision").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `decision` to be a primitive type in the JSON string but got `%s`", jsonObj.get("decision").toString()));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AddDocumentWorkflowDecisionsRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AddDocumentWorkflowDecisionsRequest' and its subtypes
       }
       ...
       return (TypeAdapter<T>) new TypeAdapter<AddDocumentWorkflowDecisionsRequest>() {
           @Override
           public void write(JsonWriter out, AddDocumentWorkflowDecisionsRequest value) throws IOException {
   ...
   * @throws IOException if the JSON string is invalid with respect to AddDocumentWorkflowDecisionsRequest
   */
