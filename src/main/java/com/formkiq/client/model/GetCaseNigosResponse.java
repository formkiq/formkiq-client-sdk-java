...
public class GetCaseNigosResponse {
  ...
  public GetCaseNigosResponse next(@javax.annotation.Nullable String next) {
    this.next = next;
    return this;
  }
  ...
  public GetCaseNigosResponse nigos(@javax.annotation.Nullable List<Nigo> nigos) {
    this.nigos = nigos;
    return this;
  }
  ...
  public void setNigos(@javax.annotation.Nullable List<Nigo> nigos) {
    this.nigos = nigos;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("next", "nigos"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetCaseNigosResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in GetCaseNigosResponse is not found in the empty JSON string", GetCaseNigosResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetCaseNigosResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `GetCaseNigosResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("nigos") != null && !jsonObj.get("nigos").isJsonNull()) {
        ...
        if (jsonArraynigos != null) {
          ...
          if (!jsonObj.get("nigos").isJsonArray()) {
            throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `nigos` to be an array in the JSON string but got `%s`", jsonObj.get("nigos").toString()));
          }
