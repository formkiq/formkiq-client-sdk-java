...
public class GetDocumentTagsResponse {
  ...
  public GetDocumentTagsResponse next(@javax.annotation.Nullable String next) {
    this.next = next;
    return this;
  }
  ...
  public GetDocumentTagsResponse previous(@javax.annotation.Nullable String previous) {
  ...
  public GetDocumentTagsResponse tags(@javax.annotation.Nullable List<DocumentTag> tags) {
    this.tags = tags;
    return this;
  }
  ...
  public void setTags(@javax.annotation.Nullable List<DocumentTag> tags) {
    this.tags = tags;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("next", "previous", "tags"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetDocumentTagsResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in GetDocumentTagsResponse is not found in the empty JSON string", GetDocumentTagsResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetDocumentTagsResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `GetDocumentTagsResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
