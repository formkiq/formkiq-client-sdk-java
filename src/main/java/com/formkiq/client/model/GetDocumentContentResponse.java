...
public class GetDocumentContentResponse {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("content", "contentUrl", "contentType", "isBase64"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetDocumentContentResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in GetDocumentContentResponse is not found in the empty JSON string", GetDocumentContentResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetDocumentContentResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `GetDocumentContentResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
