...
public class ClassificationSummary {
  ...
  public ClassificationSummary classificationId(@javax.annotation.Nonnull String classificationId) {
  ...
  static {
    ...
    openapiFields =
        new HashSet<String>(Arrays.asList("classificationId", "name", "userId", "insertedDate"));
