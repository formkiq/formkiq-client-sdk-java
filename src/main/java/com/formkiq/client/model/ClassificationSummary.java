...
public class ClassificationSummary {
  ...
  public ClassificationSummary classificationId(@javax.annotation.Nullable String classificationId) {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("classificationId", "name", "userId", "insertedDate"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ClassificationSummary.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in ClassificationSummary is not found in the empty JSON string", ClassificationSummary.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ClassificationSummary.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `ClassificationSummary` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
