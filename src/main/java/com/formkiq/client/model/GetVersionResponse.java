...
public class GetVersionResponse {
  ...
  public GetVersionResponse version(@javax.annotation.Nullable String version) {
  ...
  public GetVersionResponse type(@javax.annotation.Nullable String type) {
    this.type = type;
    return this;
  }
  ...
  public GetVersionResponse appEnvironment(@javax.annotation.Nullable String appEnvironment) {
  ...
  public void setAppEnvironment(@javax.annotation.Nullable String appEnvironment) {
    this.appEnvironment = appEnvironment;
  }


  public GetVersionResponse modules(@javax.annotation.Nullable List<String> modules) {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("version", "type", "appEnvironment", "modules"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetVersionResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in GetVersionResponse is not found in the empty JSON string", GetVersionResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetVersionResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `GetVersionResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if ((jsonObj.get("appEnvironment") != null && !jsonObj.get("appEnvironment").isJsonNull()) && !jsonObj.get("appEnvironment").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `appEnvironment` to be a primitive type in the JSON string but got `%s`", jsonObj.get("appEnvironment").toString()));
      }
