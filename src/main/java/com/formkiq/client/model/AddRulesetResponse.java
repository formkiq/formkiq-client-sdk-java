...
public class AddRulesetResponse {
  ...
  public AddRulesetResponse rulesetId(@javax.annotation.Nullable String rulesetId) {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AddRulesetResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in AddRulesetResponse is not found in the empty JSON string", AddRulesetResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AddRulesetResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `AddRulesetResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
