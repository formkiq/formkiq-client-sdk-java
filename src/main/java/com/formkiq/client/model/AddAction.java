...
public class AddAction {
  ...
  public AddAction type(@javax.annotation.Nonnull DocumentActionType type) {
    this.type = type;
    return this;
  }
  ...
  public void setType(@javax.annotation.Nonnull DocumentActionType type) {
    this.type = type;
  }


  public AddAction parameters(@javax.annotation.Nullable AddActionParameters parameters) {
  ...
  public void setParameters(@javax.annotation.Nullable AddActionParameters parameters) {
    this.parameters = parameters;
  }


  public AddAction queueId(@javax.annotation.Nullable String queueId) {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("type", "parameters", "queueId"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AddAction.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in AddAction is not found in the empty JSON string", AddAction.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AddAction.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `AddAction` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
