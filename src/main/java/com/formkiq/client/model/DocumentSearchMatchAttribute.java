...
public class DocumentSearchMatchAttribute {
  ...
  public DocumentSearchMatchAttribute key(@javax.annotation.Nullable String key) {
    this.key = key;
    return this;
  }
  ...
  public DocumentSearchMatchAttribute stringValue(@javax.annotation.Nullable String stringValue) {
  ...
  public DocumentSearchMatchAttribute numberValue(@javax.annotation.Nullable BigDecimal numberValue) {
  ...
  public DocumentSearchMatchAttribute booleanValue(@javax.annotation.Nullable Boolean booleanValue) {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("key", "stringValue", "numberValue", "booleanValue"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DocumentSearchMatchAttribute.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in DocumentSearchMatchAttribute is not found in the empty JSON string", DocumentSearchMatchAttribute.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DocumentSearchMatchAttribute.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `DocumentSearchMatchAttribute` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
