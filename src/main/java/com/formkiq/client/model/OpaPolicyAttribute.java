...
public class OpaPolicyAttribute {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("key", "eq", "gt", "gte", "lt", "lte", "neq", "in", "notIn"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!OpaPolicyAttribute.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in OpaPolicyAttribute is not found in the empty JSON string", OpaPolicyAttribute.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!OpaPolicyAttribute.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `OpaPolicyAttribute` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
