...
public class Classification {
  ...
  public Classification name(@javax.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public Classification userId(@javax.annotation.Nullable String userId) {
    this.userId = userId;
    return this;
  }
  ...
  public Classification insertedDate(@javax.annotation.Nullable String insertedDate) {
  ...
  public Classification attributes(@javax.annotation.Nullable SchemaAttributes attributes) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, classification.name) &&
        ...
        Objects.equals(this.insertedDate, classification.insertedDate) &&
        Objects.equals(this.attributes, classification.attributes);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, userId, insertedDate, attributes);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("name", "userId", "insertedDate", "attributes"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Classification.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in Classification is not found in the empty JSON string", Classification.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Classification.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `Classification` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
