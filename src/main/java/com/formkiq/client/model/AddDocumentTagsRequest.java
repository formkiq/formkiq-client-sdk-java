...
public class AddDocumentTagsRequest {
  ...
  public AddDocumentTagsRequest tags(@javax.annotation.Nullable List<AddDocumentTag> tags) {
    this.tags = tags;
    return this;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AddDocumentTagsRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in AddDocumentTagsRequest is not found in the empty JSON string", AddDocumentTagsRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AddDocumentTagsRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `AddDocumentTagsRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
