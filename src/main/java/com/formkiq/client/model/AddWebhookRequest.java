...
public class AddWebhookRequest {
  ...
  public AddWebhookRequest name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public AddWebhookRequest ttl(@javax.annotation.Nullable String ttl) {
    this.ttl = ttl;
    return this;
  }
  ...
  public AddWebhookRequest enabled(@javax.annotation.Nullable String enabled) {
  ...
  public AddWebhookRequest tags(@javax.annotation.Nullable List<AddDocumentTag> tags) {
    this.tags = tags;
    return this;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("name", "ttl", "enabled", "tags"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AddWebhookRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in AddWebhookRequest is not found in the empty JSON string", AddWebhookRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AddWebhookRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `AddWebhookRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
