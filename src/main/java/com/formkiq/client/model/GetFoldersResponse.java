...
public class GetFoldersResponse {
  ...
  public GetFoldersResponse next(@javax.annotation.Nullable String next) {
    this.next = next;
    return this;
  }
  ...
  public GetFoldersResponse previous(@javax.annotation.Nullable String previous) {
  ...
  public GetFoldersResponse documents(@javax.annotation.Nullable List<SearchResultDocument> documents) {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetFoldersResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in GetFoldersResponse is not found in the empty JSON string", GetFoldersResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetFoldersResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `GetFoldersResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
