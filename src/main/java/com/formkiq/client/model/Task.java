...
public class Task {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(taskId, insertedDate, name, description, plannedStartDate, startDate, endDate, dueDate, userId, status, metadata);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("taskId", "insertedDate", "name", "description", "plannedStartDate", "startDate", "endDate", "dueDate", "userId", "status", "metadata"));
