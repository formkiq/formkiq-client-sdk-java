...
public class DocumentSearchMatchTag {
  ...
  public DocumentSearchMatchTag key(@javax.annotation.Nullable String key) {
    this.key = key;
    return this;
  }
  ...
  public DocumentSearchMatchTag value(@javax.annotation.Nullable String value) {
    this.value = value;
    return this;
  }
  ...
  public DocumentSearchMatchTag type(@javax.annotation.Nullable String type) {
    this.type = type;
    return this;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DocumentSearchMatchTag.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in DocumentSearchMatchTag is not found in the empty JSON string", DocumentSearchMatchTag.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DocumentSearchMatchTag.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `DocumentSearchMatchTag` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
