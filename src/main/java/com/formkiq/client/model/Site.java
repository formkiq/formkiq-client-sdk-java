...
public class Site {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.siteId, site.siteId) &&
        ...
        Objects.equals(this.usage, site.usage);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("siteId", "title", "status", "permission", "permissions", "uploadEmail", "config", "usage"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Site.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in Site is not found in the empty JSON string", Site.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Site.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `Site` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if ((jsonObj.get("uploadEmail") != null && !jsonObj.get("uploadEmail").isJsonNull()) && !jsonObj.get("uploadEmail").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `uploadEmail` to be a primitive type in the JSON string but got `%s`", jsonObj.get("uploadEmail").toString()));
      }
