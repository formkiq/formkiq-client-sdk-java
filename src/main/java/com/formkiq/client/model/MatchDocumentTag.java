...
public class MatchDocumentTag {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("key", "beginsWith", "eq"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MatchDocumentTag.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in MatchDocumentTag is not found in the empty JSON string", MatchDocumentTag.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MatchDocumentTag.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `MatchDocumentTag` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
