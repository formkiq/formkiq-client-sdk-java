...
public class DocusignRecipientView {
  ...
  public DocusignRecipientView frameAncestors(@javax.annotation.Nullable List<String> frameAncestors) {
  ...
  public DocusignRecipientView messageOrigins(@javax.annotation.Nullable List<String> messageOrigins) {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(returnUrl, recipientId, userName, clientUserId, email, frameAncestors, messageOrigins);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("returnUrl", "recipientId", "userName", "clientUserId", "email", "frameAncestors", "messageOrigins"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DocusignRecipientView.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in DocusignRecipientView is not found in the empty JSON string", DocusignRecipientView.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DocusignRecipientView.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `DocusignRecipientView` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if ((jsonObj.get("recipientId") != null && !jsonObj.get("recipientId").isJsonNull()) && !jsonObj.get("recipientId").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `recipientId` to be a primitive type in the JSON string but got `%s`", jsonObj.get("recipientId").toString()));
      }
      ...
      if ((jsonObj.get("clientUserId") != null && !jsonObj.get("clientUserId").isJsonNull()) && !jsonObj.get("clientUserId").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `clientUserId` to be a primitive type in the JSON string but got `%s`", jsonObj.get("clientUserId").toString()));
      }
      ...
      if (jsonObj.get("frameAncestors") != null && !jsonObj.get("frameAncestors").isJsonNull() && !jsonObj.get("frameAncestors").isJsonArray()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `frameAncestors` to be an array in the JSON string but got `%s`", jsonObj.get("frameAncestors").toString()));
      }
      // ensure the optional json data is an array if present
      if (jsonObj.get("messageOrigins") != null && !jsonObj.get("messageOrigins").isJsonNull() && !jsonObj.get("messageOrigins").isJsonArray()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `messageOrigins` to be an array in the JSON string but got `%s`", jsonObj.get("messageOrigins").toString()));
      }
  }
