...
public class SearchResponseFields {
  ...
  public SearchResponseFields attributes(@javax.annotation.Nullable List<String> attributes) {
  ...
  public SearchResponseFields tags(@javax.annotation.Nullable List<String> tags) {
    this.tags = tags;
    return this;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("attributes", "tags"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SearchResponseFields.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in SearchResponseFields is not found in the empty JSON string", SearchResponseFields.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SearchResponseFields.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `SearchResponseFields` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
