...
public class SearchResponseFields {
  ...
  * @throws IOException if the JSON Object is invalid with respect to SearchResponseFields
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!SearchResponseFields.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SearchResponseFields is not found in the empty JSON string", SearchResponseFields.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!SearchResponseFields.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SearchResponseFields` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
