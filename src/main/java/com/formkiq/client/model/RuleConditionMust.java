...
public class RuleConditionMust {
  ...
  public RuleConditionMust attribute(@javax.annotation.Nullable RuleConditionAttribute attribute) {
  ...
  public void setAttribute(@javax.annotation.Nullable RuleConditionAttribute attribute) {
    this.attribute = attribute;
  }


  public RuleConditionMust criterion(@javax.annotation.Nullable RuleConditionCriterion criterion) {
  ...
  public void setCriterion(@javax.annotation.Nullable RuleConditionCriterion criterion) {
    this.criterion = criterion;
  }


  public RuleConditionMust attributeKey(@javax.annotation.Nullable String attributeKey) {
  ...
  public RuleConditionMust fieldName(@javax.annotation.Nullable String fieldName) {
  ...
  public RuleConditionMust value(@javax.annotation.Nullable String value) {
    this.value = value;
    return this;
  }
  ...
  public RuleConditionMust operation(@javax.annotation.Nullable RuleConditionOperation operation) {
  ...
  public void setOperation(@javax.annotation.Nullable RuleConditionOperation operation) {
    this.operation = operation;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.attribute, ruleConditionMust.attribute) &&
        ...
        Objects.equals(this.attributeKey, ruleConditionMust.attributeKey) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(attribute, criterion, attributeKey, fieldName, value, operation);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("attribute", "criterion", "attributeKey", "fieldName", "value", "operation"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RuleConditionMust.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in RuleConditionMust is not found in the empty JSON string", RuleConditionMust.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RuleConditionMust.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `RuleConditionMust` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
