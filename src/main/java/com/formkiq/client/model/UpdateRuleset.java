...
public class UpdateRuleset {
  ...
  public UpdateRuleset description(@javax.annotation.Nullable String description) {
  ...
  public UpdateRuleset priority(@javax.annotation.Nullable BigDecimal priority) {
  ...
  public UpdateRuleset version(@javax.annotation.Nullable BigDecimal version) {
  ...
  public UpdateRuleset status(@javax.annotation.Nullable RulesetStatus status) {
    this.status = status;
    return this;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("description", "priority", "version", "status"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateRuleset.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in UpdateRuleset is not found in the empty JSON string", UpdateRuleset.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateRuleset.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `UpdateRuleset` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
