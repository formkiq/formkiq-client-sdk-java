...
public class AddDocumentWorkflowResponse {
  ...
  public AddDocumentWorkflowResponse message(@javax.annotation.Nullable String message) {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AddDocumentWorkflowResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in AddDocumentWorkflowResponse is not found in the empty JSON string", AddDocumentWorkflowResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AddDocumentWorkflowResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `AddDocumentWorkflowResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
