...
public class GetExaminePdfUrlResponse {
  ...
  public GetExaminePdfUrlResponse id(@javax.annotation.Nullable String id) {
    this.id = id;
    return this;
  }
  ...
  public GetExaminePdfUrlResponse uploadUrl(@javax.annotation.Nullable String uploadUrl) {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetExaminePdfUrlResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in GetExaminePdfUrlResponse is not found in the empty JSON string", GetExaminePdfUrlResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetExaminePdfUrlResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `GetExaminePdfUrlResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
