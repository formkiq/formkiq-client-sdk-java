...
public class GetWebhookTagsResponse {
  ...
  public GetWebhookTagsResponse next(@javax.annotation.Nullable String next) {
    this.next = next;
    return this;
  }
  ...
  public GetWebhookTagsResponse previous(@javax.annotation.Nullable String previous) {
  ...
  public GetWebhookTagsResponse tags(@javax.annotation.Nullable List<WebhookTag> tags) {
    this.tags = tags;
    return this;
  }
  ...
  public void setTags(@javax.annotation.Nullable List<WebhookTag> tags) {
    this.tags = tags;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetWebhookTagsResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in GetWebhookTagsResponse is not found in the empty JSON string", GetWebhookTagsResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetWebhookTagsResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `GetWebhookTagsResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
