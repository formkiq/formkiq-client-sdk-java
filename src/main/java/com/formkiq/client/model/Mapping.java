...
public class Mapping {
  ...
  public Mapping name(@javax.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public Mapping description(@javax.annotation.Nullable String description) {
  ...
  public Mapping attributes(@javax.annotation.Nullable List<MappingAttribute> attributes) {
  ...
  public void setAttributes(@javax.annotation.Nullable List<MappingAttribute> attributes) {
    this.attributes = attributes;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("mappingId", "name", "description", "attributes"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Mapping.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in Mapping is not found in the empty JSON string", Mapping.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Mapping.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `Mapping` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
