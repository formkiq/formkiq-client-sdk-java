...
public class AddUser {
  ...
  public AddUser username(@javax.annotation.Nullable String username) {
  ...
  public AddUser attributes(@javax.annotation.Nullable UserAttributes attributes) {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("username", "attributes"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AddUser.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in AddUser is not found in the empty JSON string", AddUser.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AddUser.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `AddUser` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
