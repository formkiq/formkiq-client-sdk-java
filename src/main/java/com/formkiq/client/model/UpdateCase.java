...
public class UpdateCase {
  ...
  public UpdateCase name(@javax.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public UpdateCase status(@javax.annotation.Nullable CaseStatus status) {
    this.status = status;
    return this;
  }
  ...
  public UpdateCase description(@javax.annotation.Nullable String description) {
  ...
  public UpdateCase metadata(@javax.annotation.Nullable Map<String, Object> metadata) {
  ...
  public UpdateCase plannedStartDate(@javax.annotation.Nullable String plannedStartDate) {
  ...
  public UpdateCase startDate(@javax.annotation.Nullable String startDate) {
  ...
  public UpdateCase endDate(@javax.annotation.Nullable String endDate) {
  ...
  public UpdateCase dueDate(@javax.annotation.Nullable String dueDate) {
  ...
  public UpdateCase documentIds(@javax.annotation.Nullable List<String> documentIds) {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(name, status, description, metadata, plannedStartDate, startDate, endDate, dueDate, documentIds);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("name", "status", "description", "metadata", "plannedStartDate", "startDate", "endDate", "dueDate", "documentIds"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateCase.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in UpdateCase is not found in the empty JSON string", UpdateCase.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateCase.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `UpdateCase` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
