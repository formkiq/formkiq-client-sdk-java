...
public class SetDocumentAttributeRequest {
  ...
  public SetDocumentAttributeRequest attribute(@javax.annotation.Nullable AddDocumentAttributeValue attribute) {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SetDocumentAttributeRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in SetDocumentAttributeRequest is not found in the empty JSON string", SetDocumentAttributeRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SetDocumentAttributeRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `SetDocumentAttributeRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
