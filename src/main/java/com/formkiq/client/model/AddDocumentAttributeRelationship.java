...
public class AddDocumentAttributeRelationship {
  ...
  public AddDocumentAttributeRelationship documentId(@javax.annotation.Nonnull String documentId) {
  ...
  public AddDocumentAttributeRelationship relationship(@javax.annotation.Nonnull DocumentRelationshipType relationship) {
  ...
  public void setRelationship(@javax.annotation.Nonnull DocumentRelationshipType relationship) {
    this.relationship = relationship;
  }


  public AddDocumentAttributeRelationship inverseRelationship(@javax.annotation.Nullable DocumentRelationshipType inverseRelationship) {
  ...
  public void setInverseRelationship(@javax.annotation.Nullable DocumentRelationshipType inverseRelationship) {
    this.inverseRelationship = inverseRelationship;
  }
  ...
  public boolean equals(Object o) {
    ...
    AddDocumentAttributeRelationship addDocumentAttributeRelationship = (AddDocumentAttributeRelationship) o;
    return Objects.equals(this.documentId, addDocumentAttributeRelationship.documentId) &&
        ...
        Objects.equals(this.inverseRelationship, addDocumentAttributeRelationship.inverseRelationship);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("documentId", "relationship", "inverseRelationship"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("documentId", "relationship"));
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to AddDocumentAttributeRelationship
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AddDocumentAttributeRelationship.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in AddDocumentAttributeRelationship is not found in the empty JSON string", AddDocumentAttributeRelationship.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AddDocumentAttributeRelationship.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `AddDocumentAttributeRelationship` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("inverseRelationship") != null && !jsonObj.get("inverseRelationship").isJsonNull()) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AddDocumentAttributeRelationship.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AddDocumentAttributeRelationship' and its subtypes
       }
       ...
       return (TypeAdapter<T>) new TypeAdapter<AddDocumentAttributeRelationship>() {
           @Override
           public void write(JsonWriter out, AddDocumentAttributeRelationship value) throws IOException {
