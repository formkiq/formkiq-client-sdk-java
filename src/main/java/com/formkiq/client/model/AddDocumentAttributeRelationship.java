...
public class AddDocumentAttributeRelationship {
  ...
  public AddDocumentAttributeRelationship relationship(
      @javax.annotation.Nonnull DocumentRelationshipType relationship) {
  ...
  public AddDocumentAttributeRelationship inverseRelationship(
      @javax.annotation.Nullable DocumentRelationshipType inverseRelationship) {
  ...
  public void setInverseRelationship(
      @javax.annotation.Nullable DocumentRelationshipType inverseRelationship) {
    this.inverseRelationship = inverseRelationship;
  }
  ...
  static {
    ...
    openapiFields =
        new HashSet<String>(Arrays.asList("documentId", "relationship", "inverseRelationship"));
