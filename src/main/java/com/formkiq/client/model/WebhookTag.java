...
public class WebhookTag {
  ...
  public WebhookTag insertedDate(@javax.annotation.Nullable String insertedDate) {
  ...
  public WebhookTag webhookId(@javax.annotation.Nullable String webhookId) {
  ...
  public WebhookTag type(@javax.annotation.Nullable String type) {
    this.type = type;
    return this;
  }
  ...
  public WebhookTag userId(@javax.annotation.Nullable String userId) {
    this.userId = userId;
    return this;
  }
  ...
  public WebhookTag value(@javax.annotation.Nonnull String value) {
    this.value = value;
    return this;
  }
  ...
  public WebhookTag key(@javax.annotation.Nonnull String key) {
    this.key = key;
    return this;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("insertedDate", "webhookId", "type", "userId", "value", "key"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("value", "key"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!WebhookTag.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in WebhookTag is not found in the empty JSON string", WebhookTag.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!WebhookTag.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `WebhookTag` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
