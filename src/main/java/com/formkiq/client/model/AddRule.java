...
public class AddRule {
  ...
  public AddRule priority(@javax.annotation.Nullable BigDecimal priority) {
  ...
  public AddRule description(@javax.annotation.Nullable String description) {
  ...
  public AddRule workflowId(@javax.annotation.Nullable String workflowId) {
  ...
  public AddRule status(@javax.annotation.Nullable RulesetStatus status) {
    this.status = status;
    return this;
  }
  ...
  public AddRule conditions(@javax.annotation.Nullable RuleCondition conditions) {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("priority", "description", "workflowId", "status", "conditions"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AddRule.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in AddRule is not found in the empty JSON string", AddRule.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AddRule.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `AddRule` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
