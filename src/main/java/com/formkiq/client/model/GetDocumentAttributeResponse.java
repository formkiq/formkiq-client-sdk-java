...
public class GetDocumentAttributeResponse {
  ...
  public GetDocumentAttributeResponse attribute(@javax.annotation.Nullable DocumentAttribute attribute) {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetDocumentAttributeResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in GetDocumentAttributeResponse is not found in the empty JSON string", GetDocumentAttributeResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetDocumentAttributeResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `GetDocumentAttributeResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
