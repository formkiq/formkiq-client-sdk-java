...
public class GetOpaAccessPoliciesResponse {
  ...
  public GetOpaAccessPoliciesResponse next(@javax.annotation.Nullable String next) {
    this.next = next;
    return this;
  }
  ...
  public GetOpaAccessPoliciesResponse opaPolicies(@javax.annotation.Nullable List<OpaPolicy> opaPolicies) {
  ...
  public void setOpaPolicies(@javax.annotation.Nullable List<OpaPolicy> opaPolicies) {
    this.opaPolicies = opaPolicies;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("next", "opaPolicies"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetOpaAccessPoliciesResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in GetOpaAccessPoliciesResponse is not found in the empty JSON string", GetOpaAccessPoliciesResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetOpaAccessPoliciesResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `GetOpaAccessPoliciesResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("opaPolicies") != null && !jsonObj.get("opaPolicies").isJsonNull()) {
        ...
        if (jsonArrayopaPolicies != null) {
          ...
          if (!jsonObj.get("opaPolicies").isJsonArray()) {
            throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `opaPolicies` to be an array in the JSON string but got `%s`", jsonObj.get("opaPolicies").toString()));
          }
