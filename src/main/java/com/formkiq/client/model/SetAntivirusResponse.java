...
public class SetAntivirusResponse {
  ...
  public SetAntivirusResponse message(String message) {
  ...
  * @throws IOException if the JSON Object is invalid with respect to SetAntivirusResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!SetAntivirusResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SetAntivirusResponse is not found in the empty JSON string", SetAntivirusResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!SetAntivirusResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SetAntivirusResponse` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
