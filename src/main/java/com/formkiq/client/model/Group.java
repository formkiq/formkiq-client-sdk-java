...
public class Group {
  ...
  public Group insertedDate(@javax.annotation.Nullable String insertedDate) {
  ...
  public Group lastModifiedDate(@javax.annotation.Nullable String lastModifiedDate) {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("name", "description", "insertedDate", "lastModifiedDate"));
