...
public class EsignatureDocusignRecipientTab {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    EsignatureDocusignRecipientTab esignatureDocusignRecipientTab = (EsignatureDocusignRecipientTab) o;
  ...
  * @throws IOException if the JSON Object is invalid with respect to EsignatureDocusignRecipientTab
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!EsignatureDocusignRecipientTab.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EsignatureDocusignRecipientTab is not found in the empty JSON string", EsignatureDocusignRecipientTab.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!EsignatureDocusignRecipientTab.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `EsignatureDocusignRecipientTab` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
      ...
      if ((jsonObj.get("positionX") != null && !jsonObj.get("positionX").isJsonNull()) && !jsonObj.get("positionX").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `positionX` to be a primitive type in the JSON string but got `%s`", jsonObj.get("positionX").toString()));
      }
      if ((jsonObj.get("positionY") != null && !jsonObj.get("positionY").isJsonNull()) && !jsonObj.get("positionY").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `positionY` to be a primitive type in the JSON string but got `%s`", jsonObj.get("positionY").toString()));
      }
  }
  ...
  * @throws IOException if the JSON string is invalid with respect to EsignatureDocusignRecipientTab
  */
