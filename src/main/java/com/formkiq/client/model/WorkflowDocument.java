...
public class WorkflowDocument {
  ...
  public WorkflowDocument workflowId(String workflowId) {
  ...
  public WorkflowDocument currentStepId(String currentStepId) {
  ...
  public WorkflowDocument path(String path) {
  ...
  public WorkflowDocument insertedDate(String insertedDate) {
  ...
  public WorkflowDocument lastModifiedDate(String lastModifiedDate) {
  ...
  public WorkflowDocument checksum(String checksum) {
  ...
  public WorkflowDocument documentId(String documentId) {
  ...
  public WorkflowDocument contentType(String contentType) {
  ...
  public WorkflowDocument userId(String userId) {
  ...
  public WorkflowDocument contentLength(Integer contentLength) {
  ...
  public WorkflowDocument version(String version) {
  ...
  public WorkflowDocument versionKey(String versionKey) {
  ...
  public WorkflowDocument s3version(String s3version) {
  ...
  public WorkflowDocument belongsToDocumentId(String belongsToDocumentId) {
  ...
  public WorkflowDocument metadata(List<DocumentMetadata> metadata) {

    this.metadata = metadata;
    return this;
  }

  public WorkflowDocument addMetadataItem(DocumentMetadata metadataItem) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.workflowId, workflowDocument.workflowId)
        && Objects.equals(this.currentStepId, workflowDocument.currentStepId)
        && Objects.equals(this.path, workflowDocument.path)
        && Objects.equals(this.insertedDate, workflowDocument.insertedDate)
        && Objects.equals(this.lastModifiedDate, workflowDocument.lastModifiedDate)
        && Objects.equals(this.checksum, workflowDocument.checksum)
        && Objects.equals(this.documentId, workflowDocument.documentId)
        && Objects.equals(this.contentType, workflowDocument.contentType)
        && Objects.equals(this.userId, workflowDocument.userId)
        && Objects.equals(this.contentLength, workflowDocument.contentLength)
        && Objects.equals(this.version, workflowDocument.version)
        && Objects.equals(this.versionKey, workflowDocument.versionKey)
        && Objects.equals(this.s3version, workflowDocument.s3version)
        && Objects.equals(this.belongsToDocumentId, workflowDocument.belongsToDocumentId)
        && Objects.equals(this.metadata, workflowDocument.metadata);
  }

  @Override
  public int hashCode() {
    return Objects.hash(workflowId, currentStepId, path, insertedDate, lastModifiedDate, checksum,
