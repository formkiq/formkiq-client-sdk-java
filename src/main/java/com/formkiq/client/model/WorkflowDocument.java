...
public class WorkflowDocument {
  ...
  public WorkflowDocument workflow(@javax.annotation.Nullable WorkflowSummary workflow) {
  ...
  public void setWorkflow(@javax.annotation.Nullable WorkflowSummary workflow) {
    this.workflow = workflow;
  }


  public WorkflowDocument document(@javax.annotation.Nullable Document document) {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("workflow", "document"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!WorkflowDocument.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in WorkflowDocument is not found in the empty JSON string", WorkflowDocument.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!WorkflowDocument.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `WorkflowDocument` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
