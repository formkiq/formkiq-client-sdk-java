...
public class OcrConfig {
  ...
  public OcrConfig maxPagesPerTransaction(@javax.annotation.Nullable BigDecimal maxPagesPerTransaction) {
  ...
  public void setMaxPagesPerTransaction(@javax.annotation.Nullable BigDecimal maxPagesPerTransaction) {
    this.maxPagesPerTransaction = maxPagesPerTransaction;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!OcrConfig.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in OcrConfig is not found in the empty JSON string", OcrConfig.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!OcrConfig.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `OcrConfig` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
