...
public class UpdateMatchingDocumentTagsRequestUpdate {
  ...
  * @throws IOException if the JSON Object is invalid with respect to UpdateMatchingDocumentTagsRequestUpdate
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!UpdateMatchingDocumentTagsRequestUpdate.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateMatchingDocumentTagsRequestUpdate is not found in the empty JSON string", UpdateMatchingDocumentTagsRequestUpdate.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!UpdateMatchingDocumentTagsRequestUpdate.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateMatchingDocumentTagsRequestUpdate` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
