...
public class AddMappingResponse {
  ...
  public AddMappingResponse mappingId(@javax.annotation.Nullable String mappingId) {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AddMappingResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in AddMappingResponse is not found in the empty JSON string", AddMappingResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AddMappingResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `AddMappingResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
