...
public class SetDocumentOcrRequest {
  ...
  public SetDocumentOcrRequest contentType(@javax.annotation.Nullable String contentType) {
  ...
  public SetDocumentOcrRequest isBase64(@javax.annotation.Nullable Boolean isBase64) {
  ...
  public SetDocumentOcrRequest content(@javax.annotation.Nonnull String content) {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("contentType", "isBase64", "content"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SetDocumentOcrRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in SetDocumentOcrRequest is not found in the empty JSON string", SetDocumentOcrRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SetDocumentOcrRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `SetDocumentOcrRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
