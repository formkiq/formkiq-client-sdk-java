...
public class ErrorsResponse {
  ...
  public ErrorsResponse errors(@javax.annotation.Nullable List<Error> errors) {
    this.errors = errors;
    return this;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ErrorsResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in ErrorsResponse is not found in the empty JSON string", ErrorsResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ErrorsResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `ErrorsResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
