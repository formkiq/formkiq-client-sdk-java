...
public class UpdateDocumentRequest {
  ...
  public UpdateDocumentRequest metadata(@javax.annotation.Nullable List<AddDocumentMetadata> metadata) {
  ...
  public UpdateDocumentRequest attributes(@javax.annotation.Nullable List<AddDocumentAttribute> attributes) {
  ...
  public UpdateDocumentRequest documents(@javax.annotation.Nullable List<AddChildDocument> documents) {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(path, width, height, deepLinkPath, contentType, isBase64, content, checksum, checksumType, tags, metadata, attributes, actions, documents);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("path", "width", "height", "deepLinkPath", "contentType", "isBase64", "content", "checksum", "checksumType", "tags", "metadata", "attributes", "actions", "documents"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateDocumentRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in UpdateDocumentRequest is not found in the empty JSON string", UpdateDocumentRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateDocumentRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `UpdateDocumentRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
