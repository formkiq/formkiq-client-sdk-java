...
public class GetMappingsResponse {
  ...
  public GetMappingsResponse mappings(@javax.annotation.Nullable List<Mapping> mappings) {
  ...
  public void setMappings(@javax.annotation.Nullable List<Mapping> mappings) {
    this.mappings = mappings;
  }


  public GetMappingsResponse next(@javax.annotation.Nullable String next) {
    this.next = next;
    return this;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("mappings", "next"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetMappingsResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in GetMappingsResponse is not found in the empty JSON string", GetMappingsResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetMappingsResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `GetMappingsResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
