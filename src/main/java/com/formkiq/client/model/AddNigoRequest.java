...
public class AddNigoRequest {
  ...
  public AddNigoRequest nigo(@javax.annotation.Nonnull AddNigo nigo) {
    this.nigo = nigo;
    return this;
  }
  ...
  public void setNigo(@javax.annotation.Nonnull AddNigo nigo) {
    this.nigo = nigo;
  }
  ...
  static {
    ...
    openapiRequiredFields = new HashSet<String>(Arrays.asList("nigo"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AddNigoRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in AddNigoRequest is not found in the empty JSON string", AddNigoRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AddNigoRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `AddNigoRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
