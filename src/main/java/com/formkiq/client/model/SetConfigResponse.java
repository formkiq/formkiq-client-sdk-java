...
public class SetConfigResponse {
  ...
  * @throws IOException if the JSON Object is invalid with respect to SetConfigResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!SetConfigResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SetConfigResponse is not found in the empty JSON string", SetConfigResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!SetConfigResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SetConfigResponse` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
