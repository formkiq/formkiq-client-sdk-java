...
public class OcrTable {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("headers", "data"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!OcrTable.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in OcrTable is not found in the empty JSON string", OcrTable.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!OcrTable.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `OcrTable` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
