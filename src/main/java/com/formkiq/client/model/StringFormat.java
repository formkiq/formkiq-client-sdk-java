...
public class StringFormat {
  ...
  public StringFormat type(@javax.annotation.Nullable StringGeneratorType type) {
    this.type = type;
    return this;
  }
  ...
  public void setType(@javax.annotation.Nullable StringGeneratorType type) {
    this.type = type;
  }


  public StringFormat staticValue(@javax.annotation.Nullable String staticValue) {
  ...
  public StringFormat padding(@javax.annotation.Nullable Integer padding) {
  ...
  public void setPadding(@javax.annotation.Nullable Integer padding) {
    this.padding = padding;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("type", "staticValue", "padding"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StringFormat.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in StringFormat is not found in the empty JSON string", StringFormat.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StringFormat.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `StringFormat` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if ((jsonObj.get("staticValue") != null && !jsonObj.get("staticValue").isJsonNull()) && !jsonObj.get("staticValue").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `staticValue` to be a primitive type in the JSON string but got `%s`", jsonObj.get("staticValue").toString()));
      }
  }
