...
public class Activity {
  ...
  public int hashCode() {
    return Objects.hash(resource, type, source, sourceIpAddress, message, status, insertedDate,
        userId, documentId, artifactId, attributeKey, entityTypeId, entityId, apiKey, rulesetId,
        schema, mappingId, classificationId, ruleId, workflowId, queueId, webhookId, locale,
        controlPolicy, changes);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(
        Arrays.asList("resource", "type", "source", "sourceIpAddress", "message", "status",
            "insertedDate", "userId", "documentId", "artifactId", "attributeKey", "entityTypeId",
            "entityId", "apiKey", "rulesetId", "schema", "mappingId", "classificationId", "ruleId",
            "workflowId", "queueId", "webhookId", "locale", "controlPolicy", "changes"));
