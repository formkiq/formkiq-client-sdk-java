...
public class EsignatureDocusignCarbonCopy {
  ...
  * @throws IOException if the JSON Object is invalid with respect to EsignatureDocusignCarbonCopy
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!EsignatureDocusignCarbonCopy.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EsignatureDocusignCarbonCopy is not found in the empty JSON string", EsignatureDocusignCarbonCopy.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!EsignatureDocusignCarbonCopy.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `EsignatureDocusignCarbonCopy` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
