...
public class AddDocumentOcrRequest {
  ...
  public AddDocumentOcrRequest textractQueries(@javax.annotation.Nullable List<TextractQuery> textractQueries) {
  ...
  public AddDocumentOcrRequest addPdfDetectedCharactersAsText(@javax.annotation.Nullable Boolean addPdfDetectedCharactersAsText) {
  ...
  public AddDocumentOcrRequest ocrNumberOfPages(@javax.annotation.Nullable String ocrNumberOfPages) {
  ...
  public AddDocumentOcrRequest ocrOutputType(@javax.annotation.Nullable OcrOutputType ocrOutputType) {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(textractQueries, parseTypes, addPdfDetectedCharactersAsText, ocrEngine, ocrNumberOfPages, ocrOutputType);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("textractQueries", "parseTypes", "addPdfDetectedCharactersAsText", "ocrEngine", "ocrNumberOfPages", "ocrOutputType"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AddDocumentOcrRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in AddDocumentOcrRequest is not found in the empty JSON string", AddDocumentOcrRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AddDocumentOcrRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `AddDocumentOcrRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("textractQueries") != null && !jsonObj.get("textractQueries").isJsonNull()) {
        ...
        if (jsonArraytextractQueries != null) {
          ...
          if (!jsonObj.get("textractQueries").isJsonArray()) {
            throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `textractQueries` to be an array in the JSON string but got `%s`", jsonObj.get("textractQueries").toString()));
          }
      ...
      if (jsonObj.get("parseTypes") != null && !jsonObj.get("parseTypes").isJsonNull() && !jsonObj.get("parseTypes").isJsonArray()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `parseTypes` to be an array in the JSON string but got `%s`", jsonObj.get("parseTypes").toString()));
      }
