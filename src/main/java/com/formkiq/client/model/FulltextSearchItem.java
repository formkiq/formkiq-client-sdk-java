...
public class FulltextSearchItem {
  ...
  public FulltextSearchItem attributes(@javax.annotation.Nullable Map<String, FulltextAttribute> attributes) {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(siteId, path, contentType, width, height, deepLinkPath, insertedDate, lastModifiedDate, checksum, checksumType, documentId, contentLength, createdBy, tags, metadata, attributes);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("siteId", "path", "contentType", "width", "height", "deepLinkPath", "insertedDate", "lastModifiedDate", "checksum", "checksumType", "documentId", "contentLength", "createdBy", "tags", "metadata", "attributes"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!FulltextSearchItem.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in FulltextSearchItem is not found in the empty JSON string", FulltextSearchItem.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!FulltextSearchItem.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `FulltextSearchItem` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
