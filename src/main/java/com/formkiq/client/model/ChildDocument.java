...
public class ChildDocument {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(path, width, height, deepLinkPath, insertedDate, lastModifiedDate, checksum, documentId, contentType, userId, contentLength, versionId, belongsToDocumentId);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("path", "width", "height", "deepLinkPath", "insertedDate", "lastModifiedDate", "checksum", "documentId", "contentType", "userId", "contentLength", "versionId", "belongsToDocumentId"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ChildDocument.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in ChildDocument is not found in the empty JSON string", ChildDocument.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ChildDocument.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `ChildDocument` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
