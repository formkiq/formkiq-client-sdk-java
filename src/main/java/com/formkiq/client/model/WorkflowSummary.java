...
public class WorkflowSummary {
  ...
  public WorkflowSummary workflowId(@javax.annotation.Nonnull String workflowId) {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("name", "workflowId", "description",
        "insertedDate", "userId", "inUse", "status"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    ...
    for (String requiredField : WorkflowSummary.openapiRequiredFields) {
