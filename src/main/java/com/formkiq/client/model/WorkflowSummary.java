...
public class WorkflowSummary {
  ...
  public WorkflowSummary name(@javax.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public WorkflowSummary workflowId(@javax.annotation.Nullable String workflowId) {
  ...
  public WorkflowSummary description(@javax.annotation.Nullable String description) {
  ...
  public WorkflowSummary insertedDate(@javax.annotation.Nullable String insertedDate) {
  ...
  public WorkflowSummary userId(@javax.annotation.Nullable String userId) {
    this.userId = userId;
    return this;
  }
  ...
  public WorkflowSummary inUse(@javax.annotation.Nullable Boolean inUse) {
    this.inUse = inUse;
    return this;
  }
  ...
  public WorkflowSummary status(@javax.annotation.Nullable WorkflowStatus status) {
    this.status = status;
    return this;
  }
  ...
  public void setStatus(@javax.annotation.Nullable WorkflowStatus status) {
    this.status = status;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("name", "workflowId", "description", "insertedDate", "userId", "inUse", "status"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!WorkflowSummary.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in WorkflowSummary is not found in the empty JSON string", WorkflowSummary.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!WorkflowSummary.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `WorkflowSummary` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
