...
import com.formkiq.client.model.AddApiKeyPermission;
...
public class AddApiKeyRequest {
  ...
  @javax.annotation.Nullable
  private List<AddApiKeyPermission> permissions = new ArrayList<>();

  public AddApiKeyRequest() {
  }

  public AddApiKeyRequest name(@javax.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public AddApiKeyRequest groups(@javax.annotation.Nullable List<String> groups) {
    this.groups = groups;
    return this;
  }

  public AddApiKeyRequest addGroupsItem(String groupsItem) {
    if (this.groups == null) {
  ...
  /**
   * Optional list of groups to add as custom claims to API Key
   * @return groups
   */
  @javax.annotation.Nullable
  ...
  public AddApiKeyRequest permissions(@javax.annotation.Nullable List<AddApiKeyPermission> permissions) {
    this.permissions = permissions;
    return this;
  }

  public AddApiKeyRequest addPermissionsItem(AddApiKeyPermission permissionsItem) {
   ...
   */
  @javax.annotation.Nullable
  public List<AddApiKeyPermission> getPermissions() {
    return permissions;
  }

  public void setPermissions(@javax.annotation.Nullable List<AddApiKeyPermission> permissions) {
    this.permissions = permissions;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, addApiKeyRequest.name) &&
        Objects.equals(this.groups, addApiKeyRequest.groups) &&
        Objects.equals(this.permissions, addApiKeyRequest.permissions);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, groups, permissions);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("name", "groups", "permissions"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AddApiKeyRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in AddApiKeyRequest is not found in the empty JSON string", AddApiKeyRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AddApiKeyRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `AddApiKeyRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
