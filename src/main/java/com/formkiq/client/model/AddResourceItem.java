...
public class AddResourceItem extends AbstractOpenApiSchema {
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            ...
            final TypeAdapter<AddLocaleResourceInterfaceItem> adapterAddLocaleResourceInterfaceItem = gson.getDelegateAdapter(this, TypeToken.get(AddLocaleResourceInterfaceItem.class));
            final TypeAdapter<AddLocaleResourceSchemaItem> adapterAddLocaleResourceSchemaItem = gson.getDelegateAdapter(this, TypeToken.get(AddLocaleResourceSchemaItem.class));
            final TypeAdapter<AddLocaleResourceClassificationItem> adapterAddLocaleResourceClassificationItem = gson.getDelegateAdapter(this, TypeToken.get(AddLocaleResourceClassificationItem.class));
            ...
            return (TypeAdapter<T>) new TypeAdapter<AddResourceItem>() {
                ...
                public void write(JsonWriter out, AddResourceItem value) throws IOException {
                    ...
                    if (value.getActualInstance() instanceof AddLocaleResourceInterfaceItem) {
                        JsonElement element = adapterAddLocaleResourceInterfaceItem.toJsonTree((AddLocaleResourceInterfaceItem)value.getActualInstance());
                    ...
                    if (value.getActualInstance() instanceof AddLocaleResourceSchemaItem) {
                        JsonElement element = adapterAddLocaleResourceSchemaItem.toJsonTree((AddLocaleResourceSchemaItem)value.getActualInstance());
                        elementAdapter.write(out, element);
                        return;
                    }
                    ...
                    if (value.getActualInstance() instanceof AddLocaleResourceClassificationItem) {
                        JsonElement element = adapterAddLocaleResourceClassificationItem.toJsonTree((AddLocaleResourceClassificationItem)value.getActualInstance());
                        elementAdapter.write(out, element);
                        return;
                    }
                ...
                public AddResourceItem read(JsonReader in) throws IOException {
                    ...
                    try {
                        ...
                        errorMessages.add(String.format(Locale.ROOT, "Deserialization for AddLocaleResourceInterfaceItem failed with `%s`.", e.getMessage()));
                        log.log(Level.FINER, "Input data does not match schema 'AddLocaleResourceInterfaceItem'", e);
                    }
                    ...
                    try {
                        ...
                        // deserialization failed, continue
                        errorMessages.add(String.format(Locale.ROOT, "Deserialization for AddLocaleResourceSchemaItem failed with `%s`.", e.getMessage()));
                        log.log(Level.FINER, "Input data does not match schema 'AddLocaleResourceSchemaItem'", e);
                    }
                    ...
                    try {
                        ...
                        // deserialization failed, continue
                        errorMessages.add(String.format(Locale.ROOT, "Deserialization for AddLocaleResourceClassificationItem failed with `%s`.", e.getMessage()));
                        log.log(Level.FINER, "Input data does not match schema 'AddLocaleResourceClassificationItem'", e);
                    }
                    ...
                    throw new IOException(String.format(Locale.ROOT, "Failed deserialization for AddResourceItem: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
     ...
     * AddLocaleResourceClassificationItem, AddLocaleResourceInterfaceItem, AddLocaleResourceSchemaItem
     *
     ...
     * AddLocaleResourceClassificationItem, AddLocaleResourceInterfaceItem, AddLocaleResourceSchemaItem
     *
     * @return The actual instance (AddLocaleResourceClassificationItem, AddLocaleResourceInterfaceItem, AddLocaleResourceSchemaItem)
     */
    @SuppressWarnings("unchecked")
    @Override
    ...
    /**
     * Get the actual instance of `AddLocaleResourceInterfaceItem`. If the actual instance is not `AddLocaleResourceInterfaceItem`,
    ...
    /**
     * Get the actual instance of `AddLocaleResourceSchemaItem`. If the actual instance is not `AddLocaleResourceSchemaItem`,
     * the ClassCastException will be thrown.
     *
    ...
    /**
     * Get the actual instance of `AddLocaleResourceClassificationItem`. If the actual instance is not `AddLocaleResourceClassificationItem`,
     * the ClassCastException will be thrown.
     *
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        if (validCount != 1) {
            throw new IOException(String.format(Locale.ROOT, "The JSON string is invalid for AddResourceItem with oneOf schemas: AddLocaleResourceClassificationItem, AddLocaleResourceInterfaceItem, AddLocaleResourceSchemaItem. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonElement.toString()));
        }
    }
