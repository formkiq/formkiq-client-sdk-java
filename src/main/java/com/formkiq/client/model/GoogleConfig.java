...
public class GoogleConfig {
  ...
  public GoogleConfig workloadIdentityAudience(@javax.annotation.Nullable String workloadIdentityAudience) {
  ...
  public void setWorkloadIdentityServiceAccount(@javax.annotation.Nullable String workloadIdentityServiceAccount) {
    this.workloadIdentityServiceAccount = workloadIdentityServiceAccount;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.workloadIdentityAudience, googleConfig.workloadIdentityAudience) &&
        Objects.equals(this.workloadIdentityServiceAccount, googleConfig.workloadIdentityServiceAccount);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("workloadIdentityAudience", "workloadIdentityServiceAccount"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GoogleConfig.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in GoogleConfig is not found in the empty JSON string", GoogleConfig.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GoogleConfig.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `GoogleConfig` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      if ((jsonObj.get("workloadIdentityAudience") != null && !jsonObj.get("workloadIdentityAudience").isJsonNull()) && !jsonObj.get("workloadIdentityAudience").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `workloadIdentityAudience` to be a primitive type in the JSON string but got `%s`", jsonObj.get("workloadIdentityAudience").toString()));
      }
      if ((jsonObj.get("workloadIdentityServiceAccount") != null && !jsonObj.get("workloadIdentityServiceAccount").isJsonNull()) && !jsonObj.get("workloadIdentityServiceAccount").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `workloadIdentityServiceAccount` to be a primitive type in the JSON string but got `%s`", jsonObj.get("workloadIdentityServiceAccount").toString()));
      }
  }
