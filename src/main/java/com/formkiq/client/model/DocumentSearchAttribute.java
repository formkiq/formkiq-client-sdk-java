...
public class DocumentSearchAttribute {
  ...
  public DocumentSearchAttribute eq(@javax.annotation.Nullable String eq) {
    this.eq = eq;
    return this;
  }
  ...
  public DocumentSearchAttribute eqOr(@javax.annotation.Nullable List<String> eqOr) {
    this.eqOr = eqOr;
    return this;
  }
  ...
  public DocumentSearchAttribute beginsWith(@javax.annotation.Nullable String beginsWith) {
  ...
  public DocumentSearchAttribute range(@javax.annotation.Nullable DocumentSearchRange range) {
    this.range = range;
    return this;
  }
  ...
  public DocumentSearchAttribute key(@javax.annotation.Nonnull String key) {
    this.key = key;
    return this;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("eq", "eqOr", "beginsWith", "range", "key"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DocumentSearchAttribute.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in DocumentSearchAttribute is not found in the empty JSON string", DocumentSearchAttribute.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DocumentSearchAttribute.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `DocumentSearchAttribute` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
