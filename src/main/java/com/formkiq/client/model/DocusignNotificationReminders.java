...
public class DocusignNotificationReminders {
  ...
  public DocusignNotificationReminders reminderDelay(@javax.annotation.Nullable String reminderDelay) {
  ...
  public DocusignNotificationReminders reminderEnabled(@javax.annotation.Nullable String reminderEnabled) {
  ...
  public DocusignNotificationReminders reminderFrequency(@javax.annotation.Nullable String reminderFrequency) {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("reminderDelay", "reminderEnabled", "reminderFrequency"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to DocusignNotificationReminders
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DocusignNotificationReminders.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in DocusignNotificationReminders is not found in the empty JSON string", DocusignNotificationReminders.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DocusignNotificationReminders.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `DocusignNotificationReminders` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      if ((jsonObj.get("reminderDelay") != null && !jsonObj.get("reminderDelay").isJsonNull()) && !jsonObj.get("reminderDelay").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `reminderDelay` to be a primitive type in the JSON string but got `%s`", jsonObj.get("reminderDelay").toString()));
      }
      if ((jsonObj.get("reminderEnabled") != null && !jsonObj.get("reminderEnabled").isJsonNull()) && !jsonObj.get("reminderEnabled").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `reminderEnabled` to be a primitive type in the JSON string but got `%s`", jsonObj.get("reminderEnabled").toString()));
      }
      if ((jsonObj.get("reminderFrequency") != null && !jsonObj.get("reminderFrequency").isJsonNull()) && !jsonObj.get("reminderFrequency").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `reminderFrequency` to be a primitive type in the JSON string but got `%s`", jsonObj.get("reminderFrequency").toString()));
      }
  }
