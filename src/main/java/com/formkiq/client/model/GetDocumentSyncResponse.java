...
public class GetDocumentSyncResponse {
  ...
  @javax.annotation.Nullable
  private List<DocumentSync> syncs = new ArrayList<>();

  public GetDocumentSyncResponse() {
  }

  public GetDocumentSyncResponse next(@javax.annotation.Nullable String next) {
    this.next = next;
    return this;
  }
  ...
  public GetDocumentSyncResponse syncs(@javax.annotation.Nullable List<DocumentSync> syncs) {
    this.syncs = syncs;
    return this;
  }

  public GetDocumentSyncResponse addSyncsItem(DocumentSync syncsItem) {
    if (this.syncs == null) {
   ...
   */
  @javax.annotation.Nullable
  public List<DocumentSync> getSyncs() {
    return syncs;
  }

  public void setSyncs(@javax.annotation.Nullable List<DocumentSync> syncs) {
    this.syncs = syncs;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("next", "syncs"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetDocumentSyncResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in GetDocumentSyncResponse is not found in the empty JSON string", GetDocumentSyncResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetDocumentSyncResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `GetDocumentSyncResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("syncs") != null && !jsonObj.get("syncs").isJsonNull()) {
        ...
        if (jsonArraysyncs != null) {
          ...
          if (!jsonObj.get("syncs").isJsonArray()) {
            throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `syncs` to be an array in the JSON string but got `%s`", jsonObj.get("syncs").toString()));
          }

          // validate the optional field `syncs` (array)
          for (int i = 0; i < jsonArraysyncs.size(); i++) {
            DocumentSync.validateJsonElement(jsonArraysyncs.get(i));
          };
        }
      }
  }
