...
public class GetDocumentSyncResponse {
  ...
  public GetDocumentSyncResponse syncs(@javax.annotation.Nullable List<GetDocumentSync> syncs) {
    this.syncs = syncs;
    return this;
  }
  ...
  public void setSyncs(@javax.annotation.Nullable List<GetDocumentSync> syncs) {
    this.syncs = syncs;
  }
