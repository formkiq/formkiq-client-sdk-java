...
public class UserActivity {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("type", "insertedDate", "userId", "document", "changes"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UserActivity.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in UserActivity is not found in the empty JSON string", UserActivity.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UserActivity.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `UserActivity` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
