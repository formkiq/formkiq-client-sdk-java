...
public class PdfDocument {
  ...
  public PdfDocument fields(@javax.annotation.Nullable List<PdfDocumentField> fields) {
    this.fields = fields;
    return this;
  }
  ...
  public void setFields(@javax.annotation.Nullable List<PdfDocumentField> fields) {
    this.fields = fields;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PdfDocument.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in PdfDocument is not found in the empty JSON string", PdfDocument.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PdfDocument.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `PdfDocument` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
