...
public class DeleteCaseDocumentResponse {
  ...
  public DeleteCaseDocumentResponse message(@javax.annotation.Nullable String message) {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeleteCaseDocumentResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in DeleteCaseDocumentResponse is not found in the empty JSON string", DeleteCaseDocumentResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DeleteCaseDocumentResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `DeleteCaseDocumentResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
