...
public class TagSchemaPostResponse {
  ...
  * @throws IOException if the JSON Object is invalid with respect to TagSchemaPostResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!TagSchemaPostResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TagSchemaPostResponse is not found in the empty JSON string", TagSchemaPostResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!TagSchemaPostResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TagSchemaPostResponse` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
