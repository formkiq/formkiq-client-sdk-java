...
public class AddSiteRequest {
  ...
  public AddSiteRequest site(@javax.annotation.Nullable AddSite site) {
    this.site = site;
    return this;
  }
  ...
  public void setSite(@javax.annotation.Nullable AddSite site) {
    this.site = site;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("site"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AddSiteRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in AddSiteRequest is not found in the empty JSON string", AddSiteRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AddSiteRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `AddSiteRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
