...
public class UpdateRuleRequest {
  ...
  public UpdateRuleRequest rule(@javax.annotation.Nullable UpdateRule rule) {
    this.rule = rule;
    return this;
  }
  ...
  public void setRule(@javax.annotation.Nullable UpdateRule rule) {
    this.rule = rule;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateRuleRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in UpdateRuleRequest is not found in the empty JSON string", UpdateRuleRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateRuleRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `UpdateRuleRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
