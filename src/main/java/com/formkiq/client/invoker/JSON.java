...
public class JSON {
  ...
  static {
    ...
    gsonBuilder.registerTypeAdapterFactory(
        new com.formkiq.client.model.DeleteAttributeResponse.CustomTypeAdapterFactory());
    gsonBuilder.registerTypeAdapterFactory(
    ...
    gsonBuilder.registerTypeAdapterFactory(
        new com.formkiq.client.model.SearchResponseAttributeField.CustomTypeAdapterFactory());
    gsonBuilder.registerTypeAdapterFactory(
