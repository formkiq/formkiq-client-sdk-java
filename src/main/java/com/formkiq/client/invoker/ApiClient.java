...
public class ApiClient {
  ...
  protected List<ServerConfiguration> servers =
      new ArrayList<ServerConfiguration>(Arrays.asList(new ServerConfiguration("http://localhost",
          "Local development server", new HashMap<String, ServerVariable>())));
  ...
  protected void init() {
    ...
    setUserAgent("OpenAPI-Generator/1.19.1/java");
   ...
   * @throws com.formkiq.client.invoker.ApiException If fail to deserialize response body, i.e.
   ...
   * @throws com.formkiq.client.invoker.ApiException If fail to serialize the given object
   */
   ...
   * @throws com.formkiq.client.invoker.ApiException If fail to read file content from response and
   *         write to disk
   ...
   * @throws com.formkiq.client.invoker.ApiException If fail to execute the call
   */
   ...
   * @param returnType Return type
   * @return Type
   * @throws com.formkiq.client.invoker.ApiException If the response has an unsuccessful status code
   ...
   * @throws com.formkiq.client.invoker.ApiException If fail to serialize the request body object
   */
   ...
   * @param uri URI
   * @throws com.formkiq.client.invoker.ApiException If fails to update the parameters
   */
