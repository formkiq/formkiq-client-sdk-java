...
public class UserActivitiesApi {
   ...
   * @param ruleId RuleId Identifier (optional)
   * @param workflowId Workflow Identifier (optional)
   * @param queueId Queue Identifier (optional)
   * @param webhookId Webhook Identifier (optional)
   * @param locale Site Locale (ISO 639 / ISO 3166) (optional)
   * @param attributeKey Attribute Key (optional)
   * @param schema Schema Type (optional)
   * @param classificationId Classification Id (optional)
   * @param mappingId Mapping Id (optional)
   * @param apiKey Api Key (optional)
   * @param controlPolicy Control Policy (optional)
  ...
  public okhttp3.Call getResourceActivitiesCall(@javax.annotation.Nullable String siteId,
      ...
      @javax.annotation.Nullable String queueId, @javax.annotation.Nullable String webhookId,
      @javax.annotation.Nullable String locale, @javax.annotation.Nullable String attributeKey,
    ...
    if (classificationId != null) {
      localVarQueryParams
          .addAll(localVarApiClient.parameterToPair("classificationId", classificationId));
    }
    ...
    if (controlPolicy != null) {
      localVarQueryParams.addAll(localVarApiClient.parameterToPair("controlPolicy", controlPolicy));
    }
  ...
  private okhttp3.Call getResourceActivitiesValidateBeforeCall(
      ...
      @javax.annotation.Nullable String workflowId, @javax.annotation.Nullable String queueId,
      @javax.annotation.Nullable String webhookId, @javax.annotation.Nullable String locale,
    ...
    return getResourceActivitiesCall(siteId, documentId, artifactId, entityTypeId, namespace,
        entityId, rulesetId, ruleId, workflowId, queueId, webhookId, locale, attributeKey, schema,
  ...
  public GetActivitesResponse getResourceActivities(@javax.annotation.Nullable String siteId,
    ...
    ApiResponse<GetActivitesResponse> localVarResp = getResourceActivitiesWithHttpInfo(siteId,
        documentId, artifactId, entityTypeId, namespace, entityId, rulesetId, ruleId, workflowId,
        queueId, webhookId, locale, attributeKey, schema, classificationId, mappingId, apiKey,
        controlPolicy, start, end, sort, next, limit, userId);
    return localVarResp.getData();
  }
  ...
  public ApiResponse<GetActivitesResponse> getResourceActivitiesWithHttpInfo(
    ...
    okhttp3.Call localVarCall = getResourceActivitiesValidateBeforeCall(siteId, documentId,
        artifactId, entityTypeId, namespace, entityId, rulesetId, ruleId, workflowId, queueId,
        webhookId, locale, attributeKey, schema, classificationId, mappingId, apiKey, controlPolicy,
        start, end, sort, next, limit, userId, null);
  ...
  public okhttp3.Call getResourceActivitiesAsync(@javax.annotation.Nullable String siteId,
    ...
    okhttp3.Call localVarCall = getResourceActivitiesValidateBeforeCall(siteId, documentId,
        artifactId, entityTypeId, namespace, entityId, rulesetId, ruleId, workflowId, queueId,
        webhookId, locale, attributeKey, schema, classificationId, mappingId, apiKey, controlPolicy,
        start, end, sort, next, limit, userId, _callback);
    Type localVarReturnType = new TypeToken<GetActivitesResponse>() {}.getType();
    localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    return localVarCall;
  }
