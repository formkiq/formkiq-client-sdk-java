...
public class DocumentOcrApi {
   ...
   * forms options available as an Add-On Module
   * 
   * @param documentId Document Identifier (required)
   * @param siteId Site Identifier (optional)
   * @param addDocumentOcrRequest (optional)
   ...
   * engine and tables and forms options available as an Add-On Module
   * 
   * @param documentId Document Identifier (required)
   * @param siteId Site Identifier (optional)
   * @param addDocumentOcrRequest (optional)
   ...
   * and forms options available as an Add-On Module
   * 
   * @param documentId Document Identifier (required)
   * @param siteId Site Identifier (optional)
   * @param _callback The callback to be executed when the API call finishes
   ...
   * options available as an Add-On Module
   * 
   * @param documentId Document Identifier (required)
   * @param siteId Site Identifier (optional)
   * @param setDocumentOcrRequest (optional)
   ...
   * tables and forms options available as an Add-On Module
   * 
   * @param documentId Document Identifier (required)
   * @param siteId Site Identifier (optional)
   * @param setDocumentOcrRequest (optional)
