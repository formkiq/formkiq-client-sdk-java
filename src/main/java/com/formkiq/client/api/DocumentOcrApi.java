...
public class DocumentOcrApi {
  ...
  /**
   * (asynchronously) Document optical character recognition (OCR) request; extract text and data
   * from a document; ONLY available with FormKiQ Pro and Enterprise
   * 
   * @param documentId Document Identifier (required)
   * @param siteId Site Identifier (optional)
   * @param addDocumentOcrRequest (optional)
  ...
  /**
   * (asynchronously) Delete a document&#39;s optical character recognition (OCR) result, if exists;
   * ONLY available with FormKiQ Pro and Enterprise
   * 
   * @param documentId Document Identifier (required)
   * @param siteId Site Identifier (optional)
  ...
  /**
   * (asynchronously) Get a document&#39;s optical character recognition (OCR) result, if exists;
   * ONLY available with FormKiQ Pro and Enterprise
   * 
   * @param documentId Document Identifier (required)
   * @param siteId Site Identifier (optional)
  ...
  /**
   * (asynchronously) Set a document&#39;s optical character recognition (OCR) result for a
