...
public class SystemManagementApi {
  ...
  /**
   * (asynchronously) Adds a new API Key
   * 
   * @param addApiKeyRequest (required)
   * @param siteId Site Identifier (optional)
  ...
  /**
   * (asynchronously) Returns the list of ApiKeys
   * 
   * @param siteId Site Identifier (optional)
   * @param _callback The callback to be executed when the API call finishes
   * @return The request call
  ...
  /**
   * (asynchronously) Returns the list of sites that the user has access to
   * 
   * @param siteId Site Identifier (optional)
   * @param _callback The callback to be executed when the API call finishes
   * @return The request call
   ...
   *                        </table>
   */
  public okhttp3.Call getSitesAsync(final ApiCallback<GetSitesRequest> _callback)
      throws ApiException {
  ...
  /**
   * (asynchronously) Return the version of FormKiQ
   * 
   * @param _callback The callback to be executed when the API call finishes
   * @return The request call
   * @throws ApiException If fail to process the API call, e.g. serializing the request body object
  ...
  /**
   * (asynchronously) Update the System Management configuration
   * 
   * @param setConfigRequest (required)
   * @param siteId Site Identifier (optional)
   * @param _callback The callback to be executed when the API call finishes
