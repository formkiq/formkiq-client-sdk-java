...
public class DocumentWorkflowsApi {
  ...
  /**
   * Add document workflow Creates a document workflow; ONLY available with FormKiQ Pro and
   * Enterprise
   * 
   * @param documentId Document Identifier (required)
   * @param addDocumentWorkflowRequest (required)
  ...
  /**
   * Add document workflow (asynchronously) Creates a document workflow; ONLY available with FormKiQ
   * Pro and Enterprise
   * 
   * @param documentId Document Identifier (required)
   * @param addDocumentWorkflowRequest (required)
  ...
  /**
   * Set workflow Set a Workflow details; ONLY available with FormKiQ Pro and Enterprise
   * 
   * @param workflowId Workflow Identifier (required)
   * @param setWorkflowRequest (required)
   * @param siteId Site Identifier (optional)
  ...
  /**
   * Set workflow (asynchronously) Set a Workflow details; ONLY available with FormKiQ Pro and
   * Enterprise
   * 
   * @param workflowId Workflow Identifier (required)
   * @param setWorkflowRequest (required)
  ...
  /**
   * Update workflow Update a Workflow details; ONLY available with FormKiQ Pro and Enterprise
   * 
   * @param workflowId Workflow Identifier (required)
   * @param updateWorkflowRequest (required)
   * @param siteId Site Identifier (optional)
  ...
  /**
   * Update workflow (asynchronously) Update a Workflow details; ONLY available with FormKiQ Pro and
   * Enterprise
   * 
   * @param workflowId Workflow Identifier (required)
   * @param updateWorkflowRequest (required)
