...
public class OnlyofficeApi {
  ...
  /**
   * (asynchronously) Provide ONLYOFFICE integration for editing documents; ONLY available with
   * FormKiQ Enterprise
   * 
   * @param documentId Document Identifier (required)
   * @param body (required)
  ...
  /**
   * (asynchronously) Provide ONLYOFFICE integration for the creation of new documents; ONLY
  ...
  /**
   * (asynchronously) Save an updated document for ONLYOFFICE integration. ONLY available with
   * FormKiQ Enterprise
   * 
   * @param documentId Document Identifier (required)
   * @param siteId Site Identifier (optional)
