...
public class OnlyofficeApi {
  ...
  /**
   * Edit onlyoffice document Provide ONLYOFFICE integration for editing documents; available as an
   * Add-On Module
   * 
   * @param documentId Document Identifier (required)
   * @param body (required)
   ...
   * new documents; available as an Add-On Module
   * 
   * @param onlyOfficeDocumentNewRequest (required)
   * @param siteId Site Identifier (optional)
   * @param _callback The callback to be executed when the API call finishes
  ...
  /**
   * Save onlyoffice document Save an updated document for ONLYOFFICE integration. available as an
   * Add-On Module
   * 
   * @param documentId Document Identifier (required)
   * @param siteId Site Identifier (optional)
