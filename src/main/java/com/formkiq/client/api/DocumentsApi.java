...
public class DocumentsApi {
  ...
  /**
   * (asynchronously) Creates a new document; body may include document content if less than 5 MB
   * 
   * @param addDocumentRequest (required)
   * @param siteId Site Identifier (optional)
   * @param shareKey Share Identifier (optional)
  ...
  /**
   * (asynchronously) Returns a URL that can be used to upload document content and create a new
  ...
  /**
   * (asynchronously) Compress documents into an .ZIP archive file, and returns a S3 presigned url
   * for the location of the archive file. The operation is async and processing time depends on the
   * number and size of documents included; a 404 status code is returned until the file is ready.
   * 
   * @param documentsCompressRequest (required)
   * @param siteId Site Identifier (optional)
   * @param _callback The callback to be executed when the API call finishes
  ...
  /**
   * (asynchronously) Retrieves a document&#39;s details, i.e., metadata
   * 
   * @param documentId Document Identifier (required)
   * @param siteId Site Identifier (optional)
   * @param shareKey Share Identifier (optional)
  ...
  /**
   * (asynchronously) Get a document&#39;s contents. Certain content types, text/_*,
  ...
  /**
   * (asynchronously) Returns a URL that can be used to upload documents for a specific documentId;
   * this endpoint is required in order to add content that is larger than 5 MB. If versions are
   * enabled, this will create a new version of the document.
   * 
   * @param documentId Document Identifier (required)
   * @param siteId Site Identifier (optional)
   * @param contentLength Indicates the size of the entity-body (optional)
  ...
  /**
   * (asynchronously) Retrieve the document syncs with external services status
   * 
   * @param documentId Document Identifier (required)
   * @param siteId Site Identifier (optional)
   * @param limit Limit Results (optional, default to 10)
  ...
  /**
   * (asynchronously) Returns a URL that can be used to upload document content and create a new
   * document; this endpoint (whether GET or POST) is required in order to add content that is
   * larger than 5 MB
   * 
   * @param path The upload file&#39;s path (optional)
   * @param siteId Site Identifier (optional)
  ...
  /**
   * (asynchronously) Returns a URL for the document&#39;s contents; this URL will expire (the
   * default is 48 hours)
   * 
   * @param documentId Document Identifier (required)
   * @param siteId Site Identifier (optional)
  ...
  /**
   * (asynchronously) Returns a list of the most recent documents added, ordered by inserted,
   * descending
   * 
   * @param date Fetch documents inserted on a certain date (yyyy-MM-dd) (optional)
   * @param tz UTC offset to apply to date parameter (IE: -0600) (optional)
  ...
  /**
   * (asynchronously) Update a document&#39;s details, i.e., metadata
   * 
   * @param documentId Document Identifier (required)
   * @param addDocumentRequest (required)
   * @param siteId Site Identifier (optional)
