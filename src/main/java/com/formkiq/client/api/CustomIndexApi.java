...
public class CustomIndexApi {
   ...
   *                        </table>
   */
  public okhttp3.Call deleteIndexCall(@javax.annotation.Nonnull String indexKey,
      @javax.annotation.Nonnull String indexType, @javax.annotation.Nullable String siteId,
  ...
  private okhttp3.Call deleteIndexValidateBeforeCall(@javax.annotation.Nonnull String indexKey,
      @javax.annotation.Nonnull String indexType, @javax.annotation.Nullable String siteId,
      final ApiCallback _callback) throws ApiException {
  ...
  /**
   * 
   * Perform a delete on the Folder Index. When deleting a file from the \&quot;folder\&quot; index,
   * you can set the indexKey to a URLEncoded path variable.
   * 
   * @param indexKey Index Key Identifier (required)
   * @param indexType Index Type (required)
   * @param siteId Site Identifier (optional)
   ...
   *                        </table>
   */
  public DeleteIndicesResponse deleteIndex(@javax.annotation.Nonnull String indexKey,
      @javax.annotation.Nonnull String indexType, @javax.annotation.Nullable String siteId)
      throws ApiException {
   ...
   *                        </table>
   */
  public ApiResponse<DeleteIndicesResponse> deleteIndexWithHttpInfo(
      @javax.annotation.Nonnull String indexKey, @javax.annotation.Nonnull String indexType,
  ...
  /**
   * (asynchronously) Perform a delete on the Folder Index. When deleting a file from the
   * \&quot;folder\&quot; index, you can set the indexKey to a URLEncoded path variable.
   * 
   * @param indexKey Index Key Identifier (required)
   * @param indexType Index Type (required)
   * @param siteId Site Identifier (optional)
   ...
   *                        </table>
   */
  public okhttp3.Call deleteIndexAsync(@javax.annotation.Nonnull String indexKey,
      @javax.annotation.Nonnull String indexType, @javax.annotation.Nullable String siteId,
   ...
   *                        </table>
   */
  public okhttp3.Call indexFolderMoveCall(@javax.annotation.Nonnull String indexType,
      @javax.annotation.Nonnull IndexFolderMoveRequest indexFolderMoveRequest,
  ...
  @SuppressWarnings("rawtypes")
  private okhttp3.Call indexFolderMoveValidateBeforeCall(@javax.annotation.Nonnull String indexType,
      @javax.annotation.Nonnull IndexFolderMoveRequest indexFolderMoveRequest,
      @javax.annotation.Nullable String siteId, final ApiCallback _callback) throws ApiException {
    // verify the required parameter 'indexType' is set
    if (indexType == null) {
   ...
   *                        </table>
   */
  public IndexFolderMoveResponse indexFolderMove(@javax.annotation.Nonnull String indexType,
      @javax.annotation.Nonnull IndexFolderMoveRequest indexFolderMoveRequest,
      @javax.annotation.Nullable String siteId) throws ApiException {
   ...
   *                        </table>
   */
  public ApiResponse<IndexFolderMoveResponse> indexFolderMoveWithHttpInfo(
      @javax.annotation.Nonnull String indexType,
      @javax.annotation.Nonnull IndexFolderMoveRequest indexFolderMoveRequest,
      @javax.annotation.Nullable String siteId) throws ApiException {
    okhttp3.Call localVarCall =
   ...
   *                        </table>
   */
  public okhttp3.Call indexFolderMoveAsync(@javax.annotation.Nonnull String indexType,
      @javax.annotation.Nonnull IndexFolderMoveRequest indexFolderMoveRequest,
