...
public class CustomIndexApi {
     ...
     */
    public okhttp3.Call deleteIndexCall(String indexKey, String indexType, String siteId, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call deleteIndexValidateBeforeCall(String indexKey, String indexType, String siteId, final ApiCallback _callback) throws ApiException {
     ...
     */
    public okhttp3.Call indexFolderMoveCall(String indexType, IndexFolderMoveRequest indexFolderMoveRequest, String siteId, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call indexFolderMoveValidateBeforeCall(String indexType, IndexFolderMoveRequest indexFolderMoveRequest, String siteId, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'indexType' is set
        if (indexType == null) {
     ...
     */
    public okhttp3.Call indexFolderMoveAsync(String indexType, IndexFolderMoveRequest indexFolderMoveRequest, String siteId, final ApiCallback<IndexFolderMoveResponse> _callback) throws ApiException {
     ...
     */
    public okhttp3.Call indexSearchCall(IndexSearchRequest indexSearchRequest, String siteId, String limit, String next, String previous, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call indexSearchValidateBeforeCall(IndexSearchRequest indexSearchRequest, String siteId, String limit, String next, String previous, final ApiCallback _callback) throws ApiException {
     ...
     */
    public okhttp3.Call indexSearchAsync(IndexSearchRequest indexSearchRequest, String siteId, String limit, String next, String previous, final ApiCallback<IndexSearchResponse> _callback) throws ApiException {
