...
public class DocumentGenerationApi {
  ...
  /**
   * Build call for addDocumentCertification
   * 
  ...
  public okhttp3.Call addDocumentCertificationCall(@javax.annotation.Nonnull String documentId,
    ...
    Object localVarPostBody = addDocumentCertificationRequest;

    // create path and map variables
    String localVarPath = "/documents/{documentId}/certifications".replace("{" + "documentId" + "}",
  ...
  private okhttp3.Call addDocumentCertificationValidateBeforeCall(
    ...
    if (documentId == null) {
      throw new ApiException(
          "Missing the required parameter 'documentId' when calling addDocumentCertification(Async)");
    }

    // verify the required parameter 'addDocumentCertificationRequest' is set
    if (addDocumentCertificationRequest == null) {
      throw new ApiException(
          "Missing the required parameter 'addDocumentCertificationRequest' when calling addDocumentCertification(Async)");
    }
  ...
  /**
   * Add Document Certification Applies one or more certifications (digital signatures) to a
   * document using one or more certificates. Target determines whether a presigned download is
   * returned, a new version is created, or a new document is created. ; available as an Add-On
   * Module
   * 
   * @param documentId Document Identifier (required)
   * @param addDocumentCertificationRequest (required)
  ...
  /**
   * Add Document Certification (asynchronously) Applies one or more certifications (digital
   * signatures) to a document using one or more certificates. Target determines whether a presigned
   * download is returned, a new version is created, or a new document is created. ; available as an
   * Add-On Module
   * 
   * @param documentId Document Identifier (required)
   * @param addDocumentCertificationRequest (required)
