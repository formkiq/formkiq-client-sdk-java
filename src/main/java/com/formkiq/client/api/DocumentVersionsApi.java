...
public class DocumentVersionsApi {
  ...
  /**
   * Delete document version Delete a specific previous document version; available as an Add-On
   * Module
   * 
   * @param documentId Document Identifier (required)
   * @param versionKey Version Key (version key required URL encoding) (required)
  ...
  /**
   * Get document&#39;s versions Get a listing of document content and metadata versions; available
   * as an Add-On Module
   * 
   * @param documentId Document Identifier (required)
   * @param siteId Site Identifier (optional)
   ...
   * versions; available as an Add-On Module
   * 
   * @param documentId Document Identifier (required)
   * @param siteId Site Identifier (optional)
   * @param limit Limit Results (optional, default to 10)
  ...
  /**
   * Set version of document Set document to a previous document version; available as an Add-On
   * Module
   * 
   * @param documentId Document Identifier (required)
   * @param setDocumentVersionRequest (required)
  ...
  /**
   * Set version of document (asynchronously) Set document to a previous document version; available
   * as an Add-On Module
   * 
   * @param documentId Document Identifier (required)
   * @param setDocumentVersionRequest (required)
