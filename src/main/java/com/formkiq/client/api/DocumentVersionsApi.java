...
public class DocumentVersionsApi {
  ...
  /**
   * (asynchronously) Delete a specific previous document version; ONLY available with FormKiQ Pro
   * and Enterprise
   * 
   * @param documentId Document Identifier (required)
   * @param versionKey Version Key (required)
  ...
  /**
   * (asynchronously) Get a listing of document content and metadata versions; ONLY available with
  ...
  /**
   * (asynchronously) Set document to a previous document version; ONLY available with FormKiQ Pro
   * and Enterprise
   * 
   * @param documentId Document Identifier (required)
   * @param setDocumentVersionRequest (required)
