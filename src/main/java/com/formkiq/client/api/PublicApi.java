...
public class PublicApi {
  ...
  /**
   * (asynchronously) Allow unauthenticated creation of new documents; must be enabled during
  ...
  /**
   * (asynchronously) Receive an incoming public post to a specified webhook and creates a document
   * based on the data sent; must be enabled during installation (disabled by default)
   * 
   * @param webhooksPlus Web Hook Param (required)
   * @param body (required)
   * @param siteId Site Identifier (optional)
