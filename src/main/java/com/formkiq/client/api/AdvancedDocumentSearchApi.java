...
public class AdvancedDocumentSearchApi {
  ...
  public okhttp3.Call queryFulltextCall(@javax.annotation.Nonnull Object body,
      @javax.annotation.Nullable String siteId, @javax.annotation.Nullable String indexName,
      final ApiCallback _callback) throws ApiException {
    String basePath = null;
    // Operation Servers
    String[] localBasePaths = new String[] {};
  ...
  public QueryFulltextResponse queryFulltext(@javax.annotation.Nonnull Object body,
      @javax.annotation.Nullable String siteId, @javax.annotation.Nullable String indexName)
      throws ApiException {
    ApiResponse<QueryFulltextResponse> localVarResp =
        queryFulltextWithHttpInfo(body, siteId, indexName);
    return localVarResp.getData();
  }
  ...
  public ApiResponse<QueryFulltextResponse> queryFulltextWithHttpInfo(
      ...
      @javax.annotation.Nullable String indexName) throws ApiException {
  ...
  public DocumentFulltextResponse searchFulltext(
    ...
    ApiResponse<DocumentFulltextResponse> localVarResp =
        searchFulltextWithHttpInfo(documentFulltextRequest, siteId, indexName, limit);
    return localVarResp.getData();
  }
  ...
  public ApiResponse<DocumentFulltextResponse> searchFulltextWithHttpInfo(
      ...
      @javax.annotation.Nullable String limit) throws ApiException {
    okhttp3.Call localVarCall =
        searchFulltextValidateBeforeCall(documentFulltextRequest, siteId, indexName, limit, null);
  ...
  public okhttp3.Call searchFulltextAsync(
    ...
    okhttp3.Call localVarCall = searchFulltextValidateBeforeCall(documentFulltextRequest, siteId,
        indexName, limit, _callback);
    Type localVarReturnType = new TypeToken<DocumentFulltextResponse>() {}.getType();
    localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    return localVarCall;
  }
