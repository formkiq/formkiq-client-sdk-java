...
public class AdvancedDocumentSearchApi {
  ...
  /**
   * (asynchronously) Remove full text search for a document from OpenSearch; ONLY available with
   * FormKiQ Enterprise
   * 
   * @param documentId Document Identifier (required)
   * @param siteId Site Identifier (optional)
  ...
  /**
   * (asynchronously) Remove document tags from OpenSearch; ONLY available with FormKiQ Enterprise
   * 
   * @param documentId Document Identifier (required)
   * @param tagKey Tag Key (required)
   * @param siteId Site Identifier (optional)
  ...
  /**
   * (asynchronously) Remove document tag/value from OpenSearch; ONLY available with FormKiQ
   * Enterprise
   * 
   * @param documentId Document Identifier (required)
   * @param tagKey Tag Key (required)
  ...
  /**
   * (asynchronously) Document full-text search (and more robust multi-tag search queries, powered
   * by OpenSearch); ONLY available with FormKiQ Enterprise
   * 
   * @param documentFulltextRequest (required)
   * @param siteId Site Identifier (optional)
   * @param limit Limit Results (optional, default to 10)
  ...
  /**
   * (asynchronously) Retrieve an OpenSearch document&#39;s details, i.e., metadata
   * 
   * @param documentId Document Identifier (required)
   * @param siteId Site Identifier (optional)
   * @param shareKey Share Identifier (optional)
  ...
  /**
   * (asynchronously) Endpoint for allowing custom, complex queries using the OpenSearch search API
   * (https://opensearch.org/docs/latest/opensearch/rest-api/search/); ONLY available with FormKiQ
   * Enterprise
   * 
   * @param body (required)
  ...
  /**
   * (asynchronously) Set all text/tags found within a document to OpenSearch; ONLY available with
   * FormKiQ Enterprise
   * 
   * @param documentId Document Identifier (required)
   * @param siteId Site Identifier (optional)
  ...
  /**
   * (asynchronously) Update a document in OpenSearch; ONLY available with FormKiQ Enterprise
   * 
   * @param documentId Document Identifier (required)
   * @param siteId Site Identifier (optional)
   * @param updateDocumentFulltextRequest (optional)
