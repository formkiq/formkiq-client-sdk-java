...
public class AdvancedDocumentSearchApi {
   ...
   *                        </table>
   */
  public okhttp3.Call addDocumentFulltextCall(String documentId, String siteId,
      AddDocumentFulltextRequest addDocumentFulltextRequest, final ApiCallback _callback)
      throws ApiException {
  ...
  private okhttp3.Call addDocumentFulltextValidateBeforeCall(String documentId, String siteId,
      AddDocumentFulltextRequest addDocumentFulltextRequest, final ApiCallback _callback)
      throws ApiException {
  ...
  /**
   * Add document&#39;s full-text Adde a document to OpenSearch; ONLY available with FormKiQ
   * Enterprise
   * 
   * @param documentId Document Identifier (required)
   * @param siteId Site Identifier (optional)
   ...
   *                        </table>
   */
  public AddDocumentFulltextResponse addDocumentFulltext(String documentId, String siteId,
      AddDocumentFulltextRequest addDocumentFulltextRequest) throws ApiException {
   ...
   *                        </table>
   */
  public ApiResponse<AddDocumentFulltextResponse> addDocumentFulltextWithHttpInfo(String documentId,
      String siteId, AddDocumentFulltextRequest addDocumentFulltextRequest) throws ApiException {
  ...
  /**
   * Add document&#39;s full-text (asynchronously) Adde a document to OpenSearch; ONLY available
   ...
   *                        </table>
   */
  public okhttp3.Call addDocumentFulltextAsync(String documentId, String siteId,
   ...
   * with FormKiQ Enterprise Example Request Body: { \&quot;query\&quot;: { \&quot;match_all\&quot;:
   * {} }}
   * 
   * @param body (required)
   * @param siteId Site Identifier (optional)
   ...
   *                        </table>
   */
  public UpdateDocumentFulltextResponse updateDocumentFulltext(String documentId, String siteId,
