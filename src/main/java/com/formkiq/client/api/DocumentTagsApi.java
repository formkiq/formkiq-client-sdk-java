...
public class DocumentTagsApi {
  ...
  /**
   * (asynchronously) Add multiple tags to a document; this endpoint also accepts a different body
   * parameter for adding a single tag
   * 
   * @param documentId Document Identifier (required)
   * @param addDocumentTagsRequest (required)
   * @param siteId Site Identifier (optional)
   ...
   *                        </table>
   */
  public void deleteDocumentTag(String documentId, String tagKey, String siteId)
      throws ApiException {
   ...
   *                        </table>
   */
  public ApiResponse<Void> deleteDocumentTagWithHttpInfo(String documentId, String tagKey,
      String siteId) throws ApiException {
    okhttp3.Call localVarCall =
  ...
  /**
   * (asynchronously) Delete a document tag by using its key
   * 
   * @param documentId Document Identifier (required)
   * @param tagKey Tag Key (required)
   * @param siteId Site Identifier (optional)
   ...
   *                        </table>
   */
  public void deleteDocumentTagAndValue(String documentId, String tagKey, String tagValue,
   ...
   *                        </table>
   */
  public ApiResponse<Void> deleteDocumentTagAndValueWithHttpInfo(String documentId, String tagKey,
      String tagValue, String siteId, String shareKey) throws ApiException {
  ...
  /**
   * (asynchronously) Delete a specific document tag&#39;s key/value combination; the request will
   * be ignored if there is no valid key/value combination found
   * 
   * @param documentId Document Identifier (required)
   * @param tagKey Tag Key (required)
   * @param tagValue Tag Key Value (required)
  ...
  /**
   * (asynchronously) Get a document tag by using its key
   * 
   * @param documentId Document Identifier (required)
   * @param tagKey Tag Key (required)
   * @param siteId Site Identifier (optional)
  ...
  /**
   * (asynchronously) Get a listing of a document&#39;s tags
   * 
   * @param documentId Document Identifier (required)
   * @param siteId Site Identifier (optional)
   * @param limit Limit Results (optional, default to 10)
  ...
  /**
   * (asynchronously) Update any and all values of a document tag, by using its key; you can supply
   * one tag value or a list of tag values in the request body
   * 
   * @param documentId Document Identifier (required)
   * @param tagKey Tag Key (required)
   * @param setDocumentTagKeyRequest (required)
  ...
  /**
   * (asynchronously) Set multiple tags to a document; this endpoint also accepts a different body
   * parameter for setting a single tag
   * 
   * @param documentId Document Identifier (required)
   * @param addDocumentTagsRequest (required)
   * @param siteId Site Identifier (optional)
  ...
  /**
   * (asynchronously) Updates multiple tags to a document; this endpoint also accepts a different
   * body parameter for updating a single tag
   * 
   * @param documentId Document Identifier (required)
   * @param addDocumentTagsRequest (required)
   * @param siteId Site Identifier (optional)
  ...
  /**
   * (asynchronously) This API request allows the adding/updating of multiple document tag(s) based
   * on document(s) that have the matching tag.
   * 
   * @param updateMatchingDocumentTagsRequest (required)
   * @param siteId Site Identifier (optional)
   * @param _callback The callback to be executed when the API call finishes
