...
public class GoogleIntegrationApi {
  ...
  /**
   * Add Google Document Export Exports a Google Document; ONLY available with FormKiQ Enterprise
   * 
   * @param documentId Document Identifier (required)
   * @param addGoogleDocumentExportRequest (required)
   * @param siteId Site Identifier (optional)
  ...
  /**
   * Add Google Document Export (asynchronously) Exports a Google Document; ONLY available with
   * FormKiQ Enterprise
   * 
   * @param documentId Document Identifier (required)
   * @param addGoogleDocumentExportRequest (required)
