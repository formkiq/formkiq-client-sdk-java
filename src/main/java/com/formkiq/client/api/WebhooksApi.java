...
public class WebhooksApi {
  ...
  /**
   * (asynchronously) Create a new webhook; once created, a webhook&#39;s id can be provided to an
  ...
  /**
   * (asynchronously) Receive an incoming private webhook and creates a document based on the
  ...
  /**
   * (asynchronously) Add a tag to a webhook
   * 
   * @param webhookId Web Hook Param (required)
   * @param getDocumentTagResponse (required)
   * @param siteId Site Identifier (optional)
  ...
  /**
   * (asynchronously) Delete a webhook; this will disable sending, receiving, or processing of data
  ...
  /**
   * (asynchronously) Return a webhook&#39;s details, i.e., its metadata
   * 
   * @param webhookId Web Hook Param (required)
   * @param siteId Site Identifier (optional)
   * @param _callback The callback to be executed when the API call finishes
  ...
  /**
   * (asynchronously) Get a webhook&#39;s tags
   * 
   * @param webhookId Web Hook Param (required)
   * @param siteId Site Identifier (optional)
   * @param _callback The callback to be executed when the API call finishes
  ...
  /**
   * (asynchronously) Return a list of webhooks; each webhook&#39;s id can be provided to an
   * external service, allowing data to be sent, received, and processed via that webhook
   * 
   * @param siteId Site Identifier (optional)
   * @param _callback The callback to be executed when the API call finishes
  ...
  /**
   * (asynchronously) Updates a webhook&#39;s details, i.e., its metadata
   * 
   * @param webhookId Web Hook Param (required)
   * @param addWebhookRequest (required)
   * @param siteId Site Identifier (optional)
