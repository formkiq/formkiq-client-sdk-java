...
public class TagSchemaApi {
   ...
   *                        </table>
   */
  public okhttp3.Call addTagSchemaCall(AddTagSchemaRequest addTagSchemaRequest, String siteId,
  ...
  private okhttp3.Call addTagSchemaValidateBeforeCall(AddTagSchemaRequest addTagSchemaRequest,
    ...
    if (addTagSchemaRequest == null) {
      throw new ApiException(
          "Missing the required parameter 'addTagSchemaRequest' when calling addTagSchema(Async)");
    }
  ...
  /**
   * Add tag schemas Creates a new TagSchema; ONLY available with FormKiQ Pro and Enterprise
   * 
   * @param addTagSchemaRequest (required)
   * @param siteId Site Identifier (optional)
  ...
  /**
   * Add tag schemas (asynchronously) Creates a new TagSchema; ONLY available with FormKiQ Pro and
   * Enterprise
   * 
   * @param addTagSchemaRequest (required)
   * @param siteId Site Identifier (optional)
   ...
   *                        </table>
   */
  public okhttp3.Call deleteTagSchemaCall(String tagSchemaId, String siteId,
      final ApiCallback _callback) throws ApiException {
    String basePath = null;
    // Operation Servers
    String[] localBasePaths = new String[] {};
    ...
    // create path and map variables
    String localVarPath = "/tagSchemas/{tagSchemaId}".replace("{" + "tagSchemaId" + "}",
        localVarApiClient.escapeString(tagSchemaId.toString()));
  ...
  @SuppressWarnings("rawtypes")
  private okhttp3.Call deleteTagSchemaValidateBeforeCall(String tagSchemaId, String siteId,
      final ApiCallback _callback) throws ApiException {
    // verify the required parameter 'tagSchemaId' is set
    if (tagSchemaId == null) {
      throw new ApiException(
          "Missing the required parameter 'tagSchemaId' when calling deleteTagSchema(Async)");
    }
  ...
  /**
   * Delete tag schema Delete a TagSchema; ONLY available with FormKiQ Pro and Enterprise
   * 
   * @param tagSchemaId Tag Schema Identifier (required)
   * @param siteId Site Identifier (optional)
   * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the
  ...
  /**
   * Delete tag schema (asynchronously) Delete a TagSchema; ONLY available with FormKiQ Pro and
   * Enterprise
   * 
   * @param tagSchemaId Tag Schema Identifier (required)
   * @param siteId Site Identifier (optional)
   ...
   *                        </table>
   */
  public okhttp3.Call getTagSchemaCall(String tagSchemaId, String siteId,
      final ApiCallback _callback) throws ApiException {
    String basePath = null;
    // Operation Servers
    String[] localBasePaths = new String[] {};
  ...
  @SuppressWarnings("rawtypes")
  private okhttp3.Call getTagSchemaValidateBeforeCall(String tagSchemaId, String siteId,
      final ApiCallback _callback) throws ApiException {
    // verify the required parameter 'tagSchemaId' is set
    if (tagSchemaId == null) {
      throw new ApiException(
          "Missing the required parameter 'tagSchemaId' when calling getTagSchema(Async)");
    }
  ...
  /**
   * Get tag schema Retrieves a TagSchema&#39;s details, i.e., metadata; ONLY available with FormKiQ
   * Pro and Enterprise
   * 
   * @param tagSchemaId Tag Schema Identifier (required)
   * @param siteId Site Identifier (optional)
  ...
  /**
   * Get tag schema (asynchronously) Retrieves a TagSchema&#39;s details, i.e., metadata; ONLY
   ...
   *                        </table>
   */
  public okhttp3.Call getTagSchemasCall(String siteId, String limit, String next, String previous,
      final ApiCallback _callback) throws ApiException {
    String basePath = null;
    // Operation Servers
    String[] localBasePaths = new String[] {};
  ...
  @SuppressWarnings("rawtypes")
  private okhttp3.Call getTagSchemasValidateBeforeCall(String siteId, String limit, String next,
      String previous, final ApiCallback _callback) throws ApiException {
    return getTagSchemasCall(siteId, limit, next, previous, _callback);

  }

  /**
   * Get tag schemas Returns the list of tagSchemas; ONLY available with FormKiQ Pro and Enterprise
   * 
   * @param siteId Site Identifier (optional)
   * @param limit Limit Results (optional, default to 10)
   * @param next Next page of results token (optional)
  ...
  /**
   * Get tag schemas (asynchronously) Returns the list of tagSchemas; ONLY available with FormKiQ
   * Pro and Enterprise
   * 
   * @param siteId Site Identifier (optional)
   * @param limit Limit Results (optional, default to 10)
