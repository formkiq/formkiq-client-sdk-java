...
public class TagSchemaApi {
  ...
  /**
   * (asynchronously) Creates a new TagSchema; ONLY available with FormKiQ Pro and Enterprise
   * 
   * @param addTagSchemaRequest (required)
   * @param siteId Site Identifier (optional)
  ...
  /**
   * (asynchronously) Delete a TagSchema; ONLY available with FormKiQ Pro and Enterprise
   * 
   * @param tagSchemaId Tag Schema Identifier (required)
   * @param siteId Site Identifier (optional)
   * @param _callback The callback to be executed when the API call finishes
  ...
  /**
   * (asynchronously) Retrieves a TagSchema&#39;s details, i.e., metadata; ONLY available with
  ...
  /**
   * (asynchronously) Returns the list of tagSchemas; ONLY available with FormKiQ Pro and Enterprise
   * 
   * @param siteId Site Identifier (optional)
   * @param limit Limit Results (optional, default to 10)
   * @param next Next page of results token (optional)
