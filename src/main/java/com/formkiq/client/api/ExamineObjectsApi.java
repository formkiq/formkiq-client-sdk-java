...
public class ExamineObjectsApi {
     ...
     * @http.response.details
     <table border="1">
       <caption>Response Details</caption>
        ...
        <tr><td> 201 </td><td> 201 OK </td><td>  * Access-Control-Allow-Origin -  <br>  * Access-Control-Allow-Methods -  <br>  * Access-Control-Allow-Headers -  <br>  </td></tr>
     </table>
     */
    public okhttp3.Call getExaminePdfCall(@javax.annotation.Nonnull String id, @javax.annotation.Nullable String siteId, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/objects/examine/{id}/pdf"
    ...
    private okhttp3.Call getExaminePdfValidateBeforeCall(@javax.annotation.Nonnull String id, @javax.annotation.Nullable String siteId, final ApiCallback _callback) throws ApiException {
     ...
     */
    public GetExaminePdfResponse getExaminePdf(@javax.annotation.Nonnull String id, @javax.annotation.Nullable String siteId) throws ApiException {
     ...
     */
    public ApiResponse<GetExaminePdfResponse> getExaminePdfWithHttpInfo(@javax.annotation.Nonnull String id, @javax.annotation.Nullable String siteId) throws ApiException {
    ...
    /**
     * Add Examine Pdf (asynchronously)
     * Get PDF details  File must have been uploaded previously using the GET /objects/examine/pdf API.
     * @param id Identifier (required)
     * @param siteId Site Identifier (optional)
     ...
     */
    public okhttp3.Call getExaminePdfAsync(@javax.annotation.Nonnull String id, @javax.annotation.Nullable String siteId, final ApiCallback<GetExaminePdfResponse> _callback) throws ApiException {
     ...
     */
    public okhttp3.Call getExaminePdfUrlCall(@javax.annotation.Nullable String siteId, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getExaminePdfUrlValidateBeforeCall(@javax.annotation.Nullable String siteId, final ApiCallback _callback) throws ApiException {
     ...
     */
    public GetExaminePdfUrlResponse getExaminePdfUrl(@javax.annotation.Nullable String siteId) throws ApiException {
     ...
     */
    public ApiResponse<GetExaminePdfUrlResponse> getExaminePdfUrlWithHttpInfo(@javax.annotation.Nullable String siteId) throws ApiException {
     ...
     */
    public okhttp3.Call getExaminePdfUrlAsync(@javax.annotation.Nullable String siteId, final ApiCallback<GetExaminePdfUrlResponse> _callback) throws ApiException {
