...
public class DocumentSearchApi {
   ...
   * @param projection Controls the search response projection. &#x60;DOCUMENTS&#x60; returns
   *        matching documents and pagination tokens. &#x60;COUNT&#x60; returns &#x60;count&#x60;
   *        and &#x60;truncated&#x60;, and omits &#x60;documents&#x60;, &#x60;next&#x60;, and
   *        &#x60;previous&#x60;. (optional, default to DOCUMENTS)
   ...
   *                        </table>
   */
  public okhttp3.Call documentSearchCall(
      @javax.annotation.Nonnull DocumentSearchRequest documentSearchRequest,
      ...
      @javax.annotation.Nullable String projection, final ApiCallback _callback)
      throws ApiException {
  ...
  private okhttp3.Call documentSearchValidateBeforeCall(
    ...
    return documentSearchCall(documentSearchRequest, siteId, limit, next, previous, projection,
        _callback);
   ...
   * set of documents. Use the &#x60;projection&#x60; parameter to return matching documents or a
   * count of matching documents. Count responses are capped at 10,000 and indicate when the count
   * was truncated. See requestBody examples below for commmon examples.
   * 
   * @param documentSearchRequest (required)
   * @param siteId Site Identifier (optional)
   * @param limit Limit Results (optional, default to 10)
   ...
   *                        </table>
   */
  public DocumentSearchResponse documentSearch(
      @javax.annotation.Nonnull DocumentSearchRequest documentSearchRequest,
      @javax.annotation.Nullable String siteId, @javax.annotation.Nullable String limit,
      @javax.annotation.Nullable String next, @javax.annotation.Nullable String previous,
      @javax.annotation.Nullable String projection) throws ApiException {
    ApiResponse<DocumentSearchResponse> localVarResp = documentSearchWithHttpInfo(
        documentSearchRequest, siteId, limit, next, previous, projection);
  ...
  public ApiResponse<DocumentSearchResponse> documentSearchWithHttpInfo(
    ...
    okhttp3.Call localVarCall = documentSearchValidateBeforeCall(documentSearchRequest, siteId,
        limit, next, previous, projection, null);
   ...
   * to filter your results to a specific set of documents. Use the &#x60;projection&#x60; parameter
   * to return matching documents or a count of matching documents. Count responses are capped at
   * 10,000 and indicate when the count was truncated. See requestBody examples below for commmon
   * examples.
   * 
   * @param documentSearchRequest (required)
   * @param siteId Site Identifier (optional)
   ...
   *                        </table>
   */
  public okhttp3.Call documentSearchAsync(
      @javax.annotation.Nonnull DocumentSearchRequest documentSearchRequest,
      @javax.annotation.Nullable String siteId, @javax.annotation.Nullable String limit,
      @javax.annotation.Nullable String next, @javax.annotation.Nullable String previous,
      @javax.annotation.Nullable String projection,
      final ApiCallback<DocumentSearchResponse> _callback) throws ApiException {

    okhttp3.Call localVarCall = documentSearchValidateBeforeCall(documentSearchRequest, siteId,
        limit, next, previous, projection, _callback);
    Type localVarReturnType = new TypeToken<DocumentSearchResponse>() {}.getType();
