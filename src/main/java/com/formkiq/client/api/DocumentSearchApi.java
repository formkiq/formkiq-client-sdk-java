...
public class DocumentSearchApi {
  ...
  /**
   * Document search Document search query request; documents are searched primarily using a
  ...
  /**
   * Document search (asynchronously) Document search query request; documents are searched
   * primarily using a document tag key and optional tag value, or if Typesense is enabled, searches
   * on the document path and versioned metadata is also available. An optional documentIds
   * parameter is also available in the DocumentSearchBody to filter, with up to 100 documentIds
   * accepted.
   * 
   * @param documentSearchRequest (required)
   * @param siteId Site Identifier (optional)
