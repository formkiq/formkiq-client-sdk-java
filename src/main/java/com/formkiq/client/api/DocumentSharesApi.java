...
public class DocumentSharesApi {
    ...
    private okhttp3.Call addFolderShareValidateBeforeCall(String indexKey, AddFolderShareRequest addFolderShareRequest, String siteId, final ApiCallback _callback) throws ApiException {
     ...
     */
    public okhttp3.Call deleteShareCall(String shareKey, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call deleteShareValidateBeforeCall(String shareKey, final ApiCallback _callback) throws ApiException {
     ...
     */
    public ApiResponse<DeleteShareResponse> deleteShareWithHttpInfo(String shareKey) throws ApiException {
     ...
     */
    public okhttp3.Call deleteShareAsync(String shareKey, final ApiCallback<DeleteShareResponse> _callback) throws ApiException {
