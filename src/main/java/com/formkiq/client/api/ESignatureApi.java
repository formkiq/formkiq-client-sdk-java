...
public class ESignatureApi {
  ...
  /**
   * (asynchronously) DocuSign callback URL handler; ONLY available with FormKiQ Enterprise
   * 
  ...
  /**
   * (asynchronously) Create a DocuSign E-Signature request; ONLY available with FormKiQ Enterprise
   * 
   * @param documentId Document Identifier (required)
   * @param esignatureDocusignRequest (required)
   * @param siteId Site Identifier (optional)
  ...
  /**
   * (asynchronously) Get DocuSign configuration info; ONLY available with FormKiQ Enterprise
   * 
   * @param siteId Site Identifier (optional)
   * @param _callback The callback to be executed when the API call finishes
   * @return The request call
  ...
  /**
   * (asynchronously) Set DocuSign configuration, required for integration; ONLY available with
   * FormKiQ Enterprise
   * 
   * @param esignatureSetDocusignConfigRequest (required)
   * @param siteId Site Identifier (optional)
