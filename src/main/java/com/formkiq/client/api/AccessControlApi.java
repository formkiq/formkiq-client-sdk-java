...
public class AccessControlApi {
     ...
     */
    public okhttp3.Call deleteOpaAccessPolicyItemsCall(@javax.annotation.Nonnull String siteId, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call deleteOpaAccessPolicyItemsValidateBeforeCall(@javax.annotation.Nonnull String siteId, final ApiCallback _callback) throws ApiException {
     ...
     */
    public DeleteResponse deleteOpaAccessPolicyItems(@javax.annotation.Nonnull String siteId) throws ApiException {
     ...
     */
    public ApiResponse<DeleteResponse> deleteOpaAccessPolicyItemsWithHttpInfo(@javax.annotation.Nonnull String siteId) throws ApiException {
    ...
    /**
     * Delete OPA Access Policy Items (asynchronously)
     * Delete OPA Access Policy Items
     * @param siteId Site Identifier (required)
     ...
     */
    public okhttp3.Call deleteOpaAccessPolicyItemsAsync(@javax.annotation.Nonnull String siteId, final ApiCallback<DeleteResponse> _callback) throws ApiException {
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getOpaAccessPoliciesValidateBeforeCall(final ApiCallback _callback) throws ApiException {
    ...
    /**
     * Get OPAs Access Policies (asynchronously)
     * Returns a list of OPA Access Policies, can only be requested with ADMIN privileges
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     ...
     */
    public okhttp3.Call getOpaAccessPoliciesAsync(final ApiCallback<GetOpaAccessPoliciesResponse> _callback) throws ApiException {
     ...
     */
    public okhttp3.Call getOpaAccessPolicyCall(@javax.annotation.Nonnull String siteId, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/sites/{siteId}/opa/accessPolicy"
            .replace("{" + "siteId" + "}", localVarApiClient.escapeString(siteId.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getOpaAccessPolicyValidateBeforeCall(@javax.annotation.Nonnull String siteId, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'siteId' is set
        if (siteId == null) {
     ...
     */
    public GetOpaAccessPolicyResponse getOpaAccessPolicy(@javax.annotation.Nonnull String siteId) throws ApiException {
     ...
     */
    public ApiResponse<GetOpaAccessPolicyResponse> getOpaAccessPolicyWithHttpInfo(@javax.annotation.Nonnull String siteId) throws ApiException {
    ...
    /**
     * Get OPA Access Policy (asynchronously)
     * Returns OPA Access Policy, can only be requested with ADMIN privileges
     * @param siteId Site Identifier (required)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
     ...
     */
    public okhttp3.Call getOpaAccessPolicyAsync(@javax.annotation.Nonnull String siteId, final ApiCallback<GetOpaAccessPolicyResponse> _callback) throws ApiException {
     ...
     */
    public okhttp3.Call getOpaAccessPolicyItemsCall(@javax.annotation.Nonnull String siteId, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getOpaAccessPolicyItemsValidateBeforeCall(@javax.annotation.Nonnull String siteId, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'siteId' is set
        if (siteId == null) {
     ...
     */
    public GetOpaAccessPolicyItemsResponse getOpaAccessPolicyItems(@javax.annotation.Nonnull String siteId) throws ApiException {
        ApiResponse<GetOpaAccessPolicyItemsResponse> localVarResp = getOpaAccessPolicyItemsWithHttpInfo(siteId);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<GetOpaAccessPolicyItemsResponse> getOpaAccessPolicyItemsWithHttpInfo(@javax.annotation.Nonnull String siteId) throws ApiException {
    ...
    /**
     * Get OPA Access Policy Items (asynchronously)
     * Returns OPA Access Policy Items, can only be requested with ADMIN privileges
     * @param siteId Site Identifier (required)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
     ...
     */
    public okhttp3.Call getOpaAccessPolicyItemsAsync(@javax.annotation.Nonnull String siteId, final ApiCallback<GetOpaAccessPolicyItemsResponse> _callback) throws ApiException {
     ...
     */
    public okhttp3.Call setOpaAccessPolicyItemsCall(@javax.annotation.Nonnull String siteId, @javax.annotation.Nonnull SetOpaAccessPolicyItemsRequest setOpaAccessPolicyItemsRequest, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call setOpaAccessPolicyItemsValidateBeforeCall(@javax.annotation.Nonnull String siteId, @javax.annotation.Nonnull SetOpaAccessPolicyItemsRequest setOpaAccessPolicyItemsRequest, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'siteId' is set
        if (siteId == null) {
     ...
     */
    public SetResponse setOpaAccessPolicyItems(@javax.annotation.Nonnull String siteId, @javax.annotation.Nonnull SetOpaAccessPolicyItemsRequest setOpaAccessPolicyItemsRequest) throws ApiException {
        ApiResponse<SetResponse> localVarResp = setOpaAccessPolicyItemsWithHttpInfo(siteId, setOpaAccessPolicyItemsRequest);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<SetResponse> setOpaAccessPolicyItemsWithHttpInfo(@javax.annotation.Nonnull String siteId, @javax.annotation.Nonnull SetOpaAccessPolicyItemsRequest setOpaAccessPolicyItemsRequest) throws ApiException {
        okhttp3.Call localVarCall = setOpaAccessPolicyItemsValidateBeforeCall(siteId, setOpaAccessPolicyItemsRequest, null);
        Type localVarReturnType = new TypeToken<SetResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Set opa access policy items, can only be requested with ADMIN privileges (asynchronously)
     * Sets opa access policy items
     * @param siteId Site Identifier (required)
     * @param setOpaAccessPolicyItemsRequest  (required)
     * @param _callback The callback to be executed when the API call finishes
     ...
     */
    public okhttp3.Call setOpaAccessPolicyItemsAsync(@javax.annotation.Nonnull String siteId, @javax.annotation.Nonnull SetOpaAccessPolicyItemsRequest setOpaAccessPolicyItemsRequest, final ApiCallback<SetResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = setOpaAccessPolicyItemsValidateBeforeCall(siteId, setOpaAccessPolicyItemsRequest, _callback);
        Type localVarReturnType = new TypeToken<SetResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
