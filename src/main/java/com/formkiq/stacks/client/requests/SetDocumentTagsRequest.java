...
/**
 * Creates PUT /documents/{documentId}/tags Request.
 *
 */
public class SetDocumentTagsRequest implements ApiRequest {
   ...
   * @return {@link SetDocumentTagsRequest}
   */
  public SetDocumentTagsRequest documentId(final String documentId) {
   ...
   * @return {@link SetDocumentTagsRequest}
   */
  public SetDocumentTagsRequest siteId(final String siteId) {
   ...
   * @return {@link SetDocumentTagsRequest}
   */
  public SetDocumentTagsRequest tags(final List<AddDocumentTag> list) {
    this.tags = list;
    return this;
  }
   ...
   * @return {@link SetDocumentTagsRequest}
   */
  public SetDocumentTagsRequest webnotify(final boolean webnotify) {
