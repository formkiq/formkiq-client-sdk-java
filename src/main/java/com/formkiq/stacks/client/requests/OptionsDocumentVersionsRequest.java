...
/**
 * OPTIONS /documents/{documentId}/versions Request.
 *
 */
public class OptionsDocumentVersionsRequest implements ApiRequest {
   ...
   * @return {@link OptionsDocumentVersionsRequest}
   */
