...
/**
 * Creates POST /documents/{documentId}/ocr Request.
 *
 */
public class AddDocumentOcrRequest implements ApiRequest {
   ...
   */
  public AddDocumentOcrRequest documentId(final String documentId) {
   ...
   * @return {@link AddDocumentOcrRequest}
   */
  public AddDocumentOcrRequest siteId(final String siteId) {
