...
public class AddLargeDocumentRequest implements ApiRequest {
   ...
   */
  public AddLargeDocument document() {
   ...
   * Set {@link AddLargeDocument}.
   * 
   * @param addDocument {@link AddLargeDocument}
   * @return {@link AddLargeDocumentRequest}
   */
  public AddLargeDocumentRequest document(final AddLargeDocument addDocument) {
   ...
   * @return {@link AddLargeDocumentRequest}
   */
  public AddLargeDocumentRequest siteId(final String siteId) {
