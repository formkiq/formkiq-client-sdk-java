...
public class UserActivitiesApiTest {
    ...
    public void getDocumentUserActivitiesTest() throws ApiException {
        ...
        String next = null;
        String limit = null;
        GetUserActivitesResponse response = api.getDocumentUserActivities(documentId, siteId, next, limit);
    ...
    public void getResourceActivitiesTest() throws ApiException {
        ...
        String limit = null;
        String userId = null;
        GetActivitesResponse response = api.getResourceActivities(siteId, documentId, entityTypeId, namespace, entityId, start, end, sort, next, limit, userId);
        // TODO: test validations
    }
