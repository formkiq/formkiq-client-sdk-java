...
public class DocumentActionsApiTest {
   ...
   * | OCR | ocrEngine | Ocr Engine to use | tesseract or textract | | OCR | ocrNumberOfPages |
   * Number of pages to OCR (from start) | -1 | | OCR | addPdfDetectedCharactersAsText | PDF
   * Documents convert images to text | true or false | | FULLTEXT | characterMax | Maximum number
