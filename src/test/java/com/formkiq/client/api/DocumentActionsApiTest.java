...
public class DocumentActionsApiTest {
   ...
   * | OCR | ocrEngine | Ocr Engine to use | tesseract or textract | | OCR | ocrExportToCsv |
   * Convert OCR result to CSV (textract table only) | true | | OCR | ocrNumberOfPages | Number of
   * pages to OCR (from start) | -1 | | OCR | addPdfDetectedCharactersAsText | PDF Documents convert
   * images to text | true or false | | FULLTEXT | characterMax | Maximum number of characters to
   * add to Fulltext destination | -1 | | DOCUMENTTAGGING | engine | Tagging Engine to use | chatgpt
