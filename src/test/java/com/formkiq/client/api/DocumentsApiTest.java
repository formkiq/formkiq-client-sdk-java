...
public class DocumentsApiTest {
   ...
   * **documentId** used in subsequent operations. **Content Type Detection** If the document
   ...
   * and related metadata are available. See POST /documents/{documentId}/tags for adding tags to
   ...
   * endpoint is required for uploading content larger than 5 MB and allows document metadata to be
   ...
   */
  @Test
  public void promoteDocumentArtifactTest() throws ApiException {
    String documentId = null;
    PromoteDocumentArtifactRequest promoteDocumentArtifactRequest = null;
    String siteId = null;
    SetResponse response =
        api.promoteDocumentArtifact(documentId, promoteDocumentArtifactRequest, siteId);
    // TODO: test validations
  }
