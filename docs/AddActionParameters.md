...
|------------ | ------------- | ------------- | -------------|
|**ocrTextractQueries** | [**List&lt;TextractQuery&gt;**](TextractQuery.md) |  |  [optional] |
...
|**llmPromptEntityName** | **String** | LLMPROMPT, DATA_CLASSIFICATION, METADATA_EXTRACTION: Set the LLM Prompt Entity Name |  [optional] |
|**modelId** | **String** | LLMPROMPT: Override the LLM Prompt Entity model id |  [optional] |
