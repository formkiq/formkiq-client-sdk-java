...
> GetDocumentAiPromptResultsResponse getDocumentAiPromptResults(documentId, llmPromptEntityName, siteId, artifactId, limit, next)
...
public class Example {
  public static void main(String[] args) {
    ...
    String next = "next_example"; // String | Next page of results token
    try {
      GetDocumentAiPromptResultsResponse result = apiInstance.getDocumentAiPromptResults(documentId, llmPromptEntityName, siteId, artifactId, limit, next);
      System.out.println(result);
    } catch (ApiException e) {
