...
|------------- | ------------- | -------------|
| [**addDocumentAiPrompt**](IntelligentDocumentProcessingApi.md#addDocumentAiPrompt) | **POST** /documents/{documentId}/ai/prompts/{llmPromptEntityName} | Add document AI result from LLM prompt |
...
| [**getDocumentAiPromptResults**](IntelligentDocumentProcessingApi.md#getDocumentAiPromptResults) | **GET** /documents/{documentId}/ai/prompts/{llmPromptEntityName} | Get document AI results from LLM prompt |
| [**getDocumentAiPromptsResults**](IntelligentDocumentProcessingApi.md#getDocumentAiPromptsResults) | **GET** /documents/{documentId}/ai/prompts | Get document AI results from LLM prompts |
...
<a id="addDocumentAiPrompt"></a>
# **addDocumentAiPrompt**
> AddDocumentAiResponse addDocumentAiPrompt(documentId, llmPromptEntityName, siteId, artifactId, addDocumentAiPromptRequest)
...
public class Example {
  public static void main(String[] args) {
    ...
    AddDocumentAiPromptRequest addDocumentAiPromptRequest = new AddDocumentAiPromptRequest(); // AddDocumentAiPromptRequest | 
    try {
      AddDocumentAiResponse result = apiInstance.addDocumentAiPrompt(documentId, llmPromptEntityName, siteId, artifactId, addDocumentAiPromptRequest);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling IntelligentDocumentProcessingApi#addDocumentAiPrompt");
...
| **addDocumentAiPromptRequest** | [**AddDocumentAiPromptRequest**](AddDocumentAiPromptRequest.md)|  | [optional] |
...
<a id="getDocumentAiPromptResults"></a>
# **getDocumentAiPromptResults**
> GetDocumentAiPromptResultsResponse getDocumentAiPromptResults(documentId, llmPromptEntityName, siteId, artifactId, analysisCategory, limit, next)
...
public class Example {
  public static void main(String[] args) {
    ...
    String siteId = "siteId_example"; // String | Site Identifier
    String artifactId = "artifactId_example"; // String | Artifact Document Identifier
    String analysisCategory = "analysisCategory_example"; // String | Analysis Category
    String limit = "10"; // String | Limit Results
    String next = "next_example"; // String | Next page of results token
    try {
      GetDocumentAiPromptResultsResponse result = apiInstance.getDocumentAiPromptResults(documentId, llmPromptEntityName, siteId, artifactId, analysisCategory, limit, next);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling IntelligentDocumentProcessingApi#getDocumentAiPromptResults");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
| **siteId** | **String**| Site Identifier | [optional] |
| **artifactId** | **String**| Artifact Document Identifier | [optional] |
| **analysisCategory** | **String**| Analysis Category | [optional] |
| **limit** | **String**| Limit Results | [optional] [default to 10] |
| **next** | **String**| Next page of results token | [optional] |
...
<a id="getDocumentAiPromptsResults"></a>
# **getDocumentAiPromptsResults**
> GetDocumentAiPromptsResultsResponse getDocumentAiPromptsResults(documentId, siteId, artifactId, analysisCategory, limit, next)
...
public class Example {
  public static void main(String[] args) {
    ...
    String next = "next_example"; // String | Next page of results token
    try {
      GetDocumentAiPromptsResultsResponse result = apiInstance.getDocumentAiPromptsResults(documentId, siteId, artifactId, analysisCategory, limit, next);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling IntelligentDocumentProcessingApi#getDocumentAiPromptsResults");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
