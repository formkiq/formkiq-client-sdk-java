...
| [**promoteDocumentArtifact**](DocumentsApi.md#promoteDocumentArtifact) | **PUT** /documents/{documentId}/artifacts/promoteArtifact | Promote document artifact |
...
| **siteId** | **String**| Site Identifier | [optional] |
| **artifactId** | **String**| Artifact Document Identifier | [optional] |
| **checksumType** | **String**| Checksum Type | [optional] [enum: SHA1, SHA256, SHA512] |
...
<a id="promoteDocumentArtifact"></a>
# **promoteDocumentArtifact**
> SetResponse promoteDocumentArtifact(documentId, promoteDocumentArtifactRequest, siteId)
...
public class Example {
  public static void main(String[] args) {
    ...
    DocumentsApi apiInstance = new DocumentsApi(defaultClient);
    String documentId = "documentId_example"; // String | Document Identifier
    PromoteDocumentArtifactRequest promoteDocumentArtifactRequest = new PromoteDocumentArtifactRequest(); // PromoteDocumentArtifactRequest | 
    String siteId = "siteId_example"; // String | Site Identifier
    try {
      SetResponse result = apiInstance.promoteDocumentArtifact(documentId, promoteDocumentArtifactRequest, siteId);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling DocumentsApi#promoteDocumentArtifact");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
|------------- | ------------- | ------------- | -------------|
| **documentId** | **String**| Document Identifier | |
| **promoteDocumentArtifactRequest** | [**PromoteDocumentArtifactRequest**](PromoteDocumentArtifactRequest.md)|  | |
| **siteId** | **String**| Site Identifier | [optional] |
